...
Public Class DbCobradora
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM tCOBRADORA (NOLOCK) ORDER BY COCodProduto, COCod"
    ...
    Public Function CarregarRegistro(ByVal COCodProduto As Int32, _
        ...
        Dim sql As String = "SELECT * FROM tCOBRADORA (NOLOCK) WHERE COCodProduto=@COCodProduto AND COCod=@COCod"
