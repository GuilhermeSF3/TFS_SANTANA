...
Public Class DbPesoIp
    ...
    Public Sub AtualizarRegistro(ByVal DATA_REF As DateTime, _
                              ByVal RATING As String, _
                              ByVal FAIXA As String, _
                              ByVal PESO As Double)

        Dim sql As String = "UPDATE IP_peso SET PESO=@PESO " & _
                            "Where DATA_REF=@DATA_REF " & _
                            "AND RATING=@RATING " & _
                            "AND FAIXA=@FAIXA"
    ...
    Public Sub ApagarRegistro(ByVal DATA_REF As DateTime, _
                              ByVal RATING As String, _
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM IP_peso (NOLOCK) ORDER BY DATA_REF desc, RATING, FAIXA "
    ...
    Public Function CarregarRegistro(ByVal DATA_REF As DateTime, _
        ...
        Dim sql As String = "SELECT * FROM IP_peso (NOLOCK) WHERE DATA_REF=@DATA_REF AND RATING=@RATING AND FAIXA=@FAIXA"
