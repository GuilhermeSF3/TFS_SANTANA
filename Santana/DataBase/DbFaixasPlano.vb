...
Public Class DbFaixasPlano
    ...
    Public Sub InserirRegistro(ByVal DT_DE As DateTime, _
        ...
        Dim sql As String = "INSERT INTO FX_PLANO(DT_DE, DESCR, DE, ATE,ORDEM) " & _
    ...
    Public Sub AtualizarRegistro(ByVal DT_DE As DateTime, _
        ...
        Dim sql As String = "UPDATE FX_PLANO SET DESCR=@DESCR, ATE=@ATE, ORDEM=@ORDEM " & _
    ...
    Public Sub ApagarRegistro(ByVal DT_DE As DateTime, ByVal DE As Integer)
        ...
        Dim sql As String = "DELETE FROM FX_PLANO WHERE DT_DE=@DT_DE AND DE=@DE"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM FX_PLANO (NOLOCK) ORDER BY dt_de desc, ORDEM "
    ...
    Public Function CarregarRegistro(ByVal DT_DE As DateTime, ByVal DE As Integer) As DataTable
        ...
        Dim sql As String = "SELECT * FROM FX_PLANO (NOLOCK) WHERE DT_DE=@DT_DE AND DE=@DE order by DT_DE desc"
