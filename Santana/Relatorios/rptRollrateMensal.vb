...
Public Class rptRollrateMensal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Santana.rptRollrateMensal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRollrateMensal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRollrateMensal = New rptRollrateMensal()
        rpt.Site = Me.Site
        Return rpt
    End Function
