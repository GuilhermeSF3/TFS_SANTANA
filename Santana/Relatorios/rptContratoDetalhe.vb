...
Public Class rptContratoDetalhe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Santana.rptContratoDetalhe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContratoDetalhe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContratoDetalhe = New rptContratoDetalhe()
        rpt.Site = Me.Site
        Return rpt
    End Function
