<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="IndicePerformance.aspx.vb" Inherits="Santana.IndicePerformance" Title="Indice de Performance" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Indice de Performance</title>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RANK" SortExpression="ORDEM" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="5%" HorizontalAlign="Left" BackColor="#EFEFEF" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="COBRADORA" SortExpression="COBRADORA" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="20%" HorizontalAlign="Left" BackColor="#EFEFEF" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField HeaderText="AA PERC" SortExpression="AA_PERC">
                        ...
                        <asp:TemplateField HeaderText="15 A 30" SortExpression="B_PERC">
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="31 A 60" SortExpression="C_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="61 A 90" SortExpression="D_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
<%--                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="91 A 120" SortExpression="E_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
<%--                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="121 A 150" SortExpression="F_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="150 A 180" SortExpression="G_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="181 A 360" SortExpression="H_PERC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="IP" SortExpression="TTL_QTDE">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DIF IP" SortExpression="TTL_SALDO">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
