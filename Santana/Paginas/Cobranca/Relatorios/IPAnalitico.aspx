...
<%--
                                            <p class="navbar-text" style="float: none; margin: auto">
                                            Recebido                                            
                                        </p>
                    <div style="margin-top: 12px; margin-left: 2px">                    
                            <asp:CheckBox ID="cbRecebido" runat="server" Visible="true" Enabled="true" AutoPostBack="true" OnCheckedChanged="Recebido_Check_Clicked" />
                        </div>
--%>
