...
Namespace Paginas.Credito
    ...
    Public Class IPAnalitico
        ...
        '        Protected Sub Recebido_Check_Clicked(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("PARCELA")) OrElse drow("PARCELA") = 0 Then
                            e.Row.Cells(1).Text = ""
                        Else
                        ...
                        If IsDBNull(drow("RECEBIDO")) OrElse drow("RECEBIDO") = 0 Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = CNumero.FormataNumero(drow("RECEBIDO"), 0)
                        End If

                        If IsDBNull(drow("VALORREC")) OrElse drow("VALORREC") = 0 Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = CNumero.FormataNumero(drow("VALORREC"), 2)
                        End If

                        If IsDBNull(drow("CODCOBRADORA")) OrElse drow("CODCOBRADORA") = 0 Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = CNumero.FormataNumero(drow("CODCOBRADORA"), 0)
                        End If
                        ...
                        If IsDBNull(drow("CARTEIRA")) OrElse drow("CARTEIRA") = 0 Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = CNumero.FormataNumero(drow("CARTEIRA"), 0)
                        End If

                        If IsDBNull(drow("MODALIDADE")) OrElse drow("MODALIDADE") = 0 Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = CNumero.FormataNumero(drow("MODALIDADE"), 0)
                        End If
                        ...
                        If IsDBNull(drow("PLANO")) OrElse drow("PLANO") = 0 Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = CNumero.FormataNumero(drow("PLANO"), 0)
                        End If

                        If IsDBNull(drow("ATRASO")) OrElse drow("ATRASO") = 0 Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = CNumero.FormataNumero(drow("ATRASO"), 0)
                        End If
                        ...
                        If IsDBNull(drow("VALOR_FINANCIADO")) OrElse drow("VALOR_FINANCIADO") = 0 Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = CNumero.FormataNumero(drow("VALOR_FINANCIADO"), 2)
                        End If

                        If IsDBNull(drow("TAC")) OrElse drow("TAC") = 0 Then
                            e.Row.Cells(17).Text = ""
                        Else
                            e.Row.Cells(17).Text = CNumero.FormataNumero(drow("TAC"), 2)
                        End If

                        If IsDBNull(drow("IOC")) OrElse drow("IOC") = 0 Then
                            e.Row.Cells(18).Text = ""
                        Else
                        ...
                        If IsDBNull(drow("CEP")) OrElse drow("CEP") = 0 Then
                            e.Row.Cells(24).Text = ""
                        Else
                        ...
                        If IsDBNull(drow("VALORBEM")) OrElse drow("VALORBEM") = 0 Then
                            e.Row.Cells(30).Text = ""
                        Else
                        ...
                        If IsDBNull(drow("QTDPAGAR")) OrElse drow("QTDPAGAR") = 0 Then
                            e.Row.Cells(40).Text = ""
                        Else
        ...
        Private Function GetData() As DataTable
            ...
            'Dim Recebido As Integer

            'If cbRecebido.Checked = True Then
            'Recebido = 1
            'Else
            'Recebido = 0
            'End If

            table = Util.ClassBD.GetExibirGrid("[SCR_IP_ANALITICO] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & _
