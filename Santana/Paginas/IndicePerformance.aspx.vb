        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    'e.Row.Cells(22).Text = CNumero.FormataNumero(Convert.ToInt32(drow("TTL_PRC")), 2)
                    'e.Row.Cells(22).ForeColor = Cor

                    'e.Row.Cells(23).Text = CNumero.FormataNumero(Convert.ToInt32(drow("IP_PRC")), 2)
