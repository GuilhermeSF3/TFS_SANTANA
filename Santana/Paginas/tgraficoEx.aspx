<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="tgraficoEx.aspx.vb" Inherits="tgraficoEx" title="Untitled Page" %>
        ...
        <asp:TableRow Height="20px" CssClass="tr-7">
            <asp:TableCell ColumnSpan="4" HorizontalAlign="Center">
                <asp:Label ID="Label1" runat="server" Text="Cadastro SIV Empregadores" CssClass="font-default-6"
                    Font-Bold="true" />
            </asp:TableCell></asp:TableRow></asp:Table><asp:UpdatePanel ID="UpdateManager" runat="server">
...
--%>
    ...
    <%--    <html xmlns="http://www.w3.org/1999/xhtml"><head><title>Visifire Charts</title><script type="text/javascript" src="Visifire.js"></script><script type="text/javascript">
    ...
    </script></head><body><div id="VisifireChart1">
...
<asp:Chart ID="chtNBAChampionships" runat="server" BackHatchStyle="DarkHorizontal" BackImageWrapMode="TileFlipY" BorderlineDashStyle="Solid" BorderlineWidth="10" Width="629px"> 
   <Series> 
      <asp:Series Name="Championships" YValueType="Int32" ChartType="Line" ChartArea="MainChartArea" IsValueShownAsLabel="True"> 
         <Points> 
...
<%--
    ...
    <asp:Chart ID="Chart1" runat="server"><series>
        <asp:Series Name="Series1" XValueMember="x1,x2" YValueMembers="4.0,5.0">
