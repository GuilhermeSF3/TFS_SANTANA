...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Ao teclar a tecla enter, chama a função OK_Click
        OK.Focus()
        'Ao teclar a tecla enter, chama a função OK_Click
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If Not e.Row.DataItem Is Nothing Then
            ...
            'e.Row.Cells(10).Text = Util.CNumero.FormataNumero(drow("OPQTDDPARC"), 0)
            'e.Row.Cells(11).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(11).Text = Util.CNumero.FormataNumero(drow("OPVLRFIN"), 2)
            'e.Row.Cells(12).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(12).Text = Util.CNumero.FormataNumero(drow("PAGAS"), 0)
            'e.Row.Cells(13).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(13).Text = Util.CNumero.FormataNumero(drow("MENOR_PARC"), 0)
            'e.Row.Cells(14).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(14).Text = Util.CNumero.FormataNumero(drow("MAIOR_PARC"), 0)
            'e.Row.Cells(15).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(15).Text = Util.CNumero.FormataNumero(drow("QTD_ATRASO"), 0)
            'e.Row.Cells(16).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(16).Text = Util.CNumero.FormataNumero(drow("VLR_ATRASO"), 2)
            'e.Row.Cells(17).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(17).Text = Util.CNumero.FormataNumero(drow("PMT"), 2)
            'e.Row.Cells(18).HorizontalAlign = HorizontalAlign.Right
            'e.Row.Cells(18).Text = Util.CNumero.FormataNumero(drow("PMT2"), 2)
            ...
            'e.Row.Cells(21).Text = Util.CNumero.FormataNumero(drow("DIF_DIAS2"), 0)
            'e.Row.Cells(22).HorizontalAlign = HorizontalAlign.Center
            'e.Row.Cells(22).Text = Util.CNumero.FormataNumero(drow("DIF_DIAS"), 0)
            ...
            'e.Row.Cells(32).Text = Util.CNumero.FormataNumero(drow("SALDO"), 2)
    ...
    Protected Sub OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        Try
            ...
            'SP_ATRASO_ESTRUTURA 31,'20090901', '20090902',  'Total',-1,-1,-1,-1,-1
            ...
            'GridView1.DataSource = Util.ClassBD.GetExibirGrid("scr_RR_mensal_DETALHE'" & codProd & "','" & dtini & "','" & dtfim & "'," & RTrim(codReg) & ",'" & codFil & "','" & codGer & "','" & codOper & "','" & codLoj & "','" & codCob & "','" & txtParcelas.Text & "','" & sDAtraso & "','" & codEmp & "' ", "Estrutura", strConn)
            'GridView1.DataSource = Util.ClassBD.GetExibirGrid("SP_ATRASO_CONTRATO '" & dtini & "','" & dtfim & "','" & txtParcelas.Text & "','" & codProd & "','','@ORDEM','" & sDAtraso & "','" & codEmp & "' ", "Dias_atraso", strConn)

            'Session.Remove("GridDados")
            'Session.Add("GridDados2", GridView1.DataSource())
    ...
    Private Sub DataTableTodos()
        ...
        If Tabela Is Nothing Then
            OK_Click(Nothing, Nothing)
            Tabela = Session.Item("FilTodos")
            'Session.Item("FilTodos") = Session.Item("GridDados")
        End If

        'Dim FilteredResults2 As New DataTable
        FilteredResults = Tabela.Clone()
    ...
    'Public Sub Distribuir_Cabecalho()
    '    Label08.Text = GridView1.Columns.Item(1).HeaderText
    '    Label09.Text = GridView1.Columns.Item(2).HeaderText
    '    Label10.Text = GridView1.Columns.Item(3).HeaderText
    '    Label11.Text = GridView1.Columns.Item(4).HeaderText
    '    Label12.Text = GridView1.Columns.Item(5).HeaderText
    '    Label13.Text = GridView1.Columns.Item(6).HeaderText
    '    'HyperLinkImprime.NavigateUrl = "javascript:ImprimeP1('" & Trim(Label08.Text) & "','" & Trim(Label09.Text) & "','" & Trim(Label10.Text) & "','" & Trim(Label11.Text) & "','" & Trim(Label12.Text) & "','" & Trim(Label13.Text) & "')"
    'End Sub
...
#Region "Excel"
    ...
    Protected Sub ExportarBROffice(ByVal sender As Object, ByVal e As System.EventArgs) Handles ExpBrOffice.Click
        ...
        'Response.Write("&nbsp;Atraso Acima de: &nbsp;&nbsp;" & dtRef & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Parcelas:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & txtParcelas.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Vencimentos de: &nbsp;&nbsp;" & txtInicio.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Até &nbsp;&nbsp;" & txtFim.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        ...
        'For iCol = 0 To Tabela.Columns.Count - 1
        '    Response.Write(Tabela.Columns(iCol).ToString & vbTab)
        'Next
        'pular linha
        Response.Write(vbCrLf)
        'Output Data
...
#Region "Ordenação"
    ...
    Protected Sub GridView1_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles GridView1.Sorting
        ...
        'If Not Session.Item("GridDados") Is Nothing Then
        '    Tabela = Session.Item("GridDados")
        'End If
...
#Region "Funções Carregar"
    Private Sub Carrega_lojas()
        ...
        Try
            ...
            ddlLojas.DataBind()
            'ddlLojas.Items.Insert(0, "Todos")
            ddlLojas.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlLojas.Items.Insert(0, New ListItem("TOTAL", "-1"))
            ddlLojas.SelectedIndex = 0
            'ddlLojas.Items.Add(New ListItem("TOTAL", -1))
            'ddlLojas.Items.Add(New ListItem("TODOS", 0))
            'ddlLojas.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlLojas.SelectedIndex = -1
            ddlValues.Close()
    ...
    Private Sub Carrega_Operador()
        ...
        Try
            ...
            ddlOper.DataBind()
            'ddlOper.Items.Insert(0, "Todos")
            ddlOper.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlOper.Items.Insert(0, New ListItem("TOTAL", "-1"))
            ddlOper.SelectedIndex = 0
            'ddlOper.Items.Add(New ListItem("TOTAL", -1))
            'ddlOper.Items.Add(New ListItem("TODOS", 0))
            'ddlOper.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlOper.SelectedIndex = -1
            ddlValues.Close()
    ...
    Private Sub Carrega_Gerente()
        ...
        Try
            ...
            ddlGer.DataBind()
            'ddlGer.Items.Insert(0, "Todos")
            ddlGer.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlGer.Items.Insert(0, New ListItem("TOTAL", "-1"))
            ddlGer.SelectedIndex = 0
            'ddlGer.Items.Add(New ListItem("TOTAL", -1))
            'ddlGer.Items.Add(New ListItem("TODOS", 0))
            'ddlGer.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlGer.SelectedIndex = -1
            ddlValues.Close()
    ...
    Private Sub Carrega_Regiao()
        ...
        Try
            ...
            'ddlRegiao.Items.Insert(0, "TOTAL")
            'ddlRegiao.Items.Add(New ListItem("TOTAL", "TOTAL"))
            'ddlRegiao.Items.Add(New ListItem("TODOS", "TODOS"))
            'ddlRegiao.Items.Insert(New ListItem("TOTAL", -1))
            'ddlRegiao.Items.Insert(0, New ListItem("TODOS", 0))
    ...
    Private Sub Carrega_Filial()
        ...
        Try
            ...
            ddlFil.DataBind()
            'ddlFil.Items.Insert(-1, "TOTAL")
            'ddlFil.Items.Add(New ListItem(" TOTAL", -1))
            'ddlFil.Items.Add(New ListItem(" TODOS", 0))

            ddlFil.Items.Insert(0, New ListItem("TODOS", "0"))
            'ddlFil.Items.Insert(0, New ListItem("TOTAL", "-1"))
    ...
    Private Sub Carrega_Cobradoras()
        ...
        Try
            ...
            'ddlCob.Items.Insert(0, New ListItem("TOTAL", "-1"))
