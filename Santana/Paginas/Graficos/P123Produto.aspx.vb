    ...
    Public Class P123Produto
        ...
        Private Sub Carrega_Produto()
            ...
            Try
                ...
                ddlProduto.Items.Insert(0, New ListItem("Leves", "1"))
                ddlProduto.Items.Insert(1, New ListItem("Utilitário/Caminhões", "2"))
                ddlProduto.Items.Insert(2, New ListItem("Motos", "3"))
                ddlProduto.Items.Insert(3, New ListItem("Refinanciamento", "4"))
                ddlProduto.Items.Insert(4, New ListItem("Renegociação", "5"))
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = ClassBD.GetExibirGrid("scr_vlr_AnaliseP123 '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "', '" & ddlProduto.SelectedValue & "', 2", "GraficoMensal", strConn)
        ...
        Protected Sub BindGraphData()
            ...
            Dim objData As DataTable = ClassBD.GetExibirGrid("scr_grafico_P123Produto '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "', '" & ddlProduto.SelectedValue & "'", "GraficoMensal", strConn)


            For Each oDataRow As DataRow In objData.Rows

                _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries LegendText=""" & oDataRow("Descricao") & """ RenderAs=""Line"" MarkerType=""Circle"" SelectionEnabled=""True"" LineThickness=""3"">"
                ...
                If Not IsDBNull(oDataRow("M1")) Then
                    ...
                    oData.Data = oData.Data.AddMonths(-13)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M1") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-13)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                End If
                ...
                If Not IsDBNull(oDataRow("M2")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M2") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-12)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M3")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M3") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-11)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M4")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M4") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-10)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M5")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M5") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-9)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M6")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M6") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-8)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M7")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M7") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-7)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M8")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M8") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-6)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M9")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M9") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-5)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M10")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M10") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-4)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M11")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M11") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-3)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M12")) Then
                    ...
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M12") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-2)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M13")) Then
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-1)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M13") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    oData.Data = oData.Data.AddMonths(-1)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                ...
                If Not IsDBNull(oDataRow("M14")) Then
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & Replace((oDataRow("M14") / 1.0), ",", ".") & """/> "
                Else
                    oData.Data = Convert.ToDateTime(txtData.Text)
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint LabelEnabled=""True"" AxisXLabel=""" & oData.NomeMesSigla & "/" & oData.Data.ToString("yy") & """ YValue=""" & """/> "
                End If
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            If GridView1.Rows.Count.ToString + 1 < 65536 Then
                ...
                'Response.Write("Data de Referencia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & txtData.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & ddlProduto.SelectedItem.Text & " - % Valor")
        ...
        Public Function GetXaml1() As [String]
            ...
            myXaml = myXaml & "<vc:Title Text=""" & ddlProduto.SelectedItem.Text & "  P " & ddlFaixa.SelectedValue & " - % Valor" & """/> "
        ...
        Private Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
            ...
            If _hfDataSerie1 <> "" Then
                Dim s As String = "vChart.setDataXml('" & xaml & "');" & "vChart.render(""VisifireChart"");"
