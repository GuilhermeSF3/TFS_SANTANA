...
Namespace Paginas.Graficos
    ...
    Public Class P123Analise
            ...
            Try
                ...
                ElseIf e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        End If
                        ' ORDEM_LINHA DE 11 A 14  M11 HACHURADO
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = ClassBD.GetExibirGrid("scr_vlr_AnaliseP123 '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "', null, 1", "GraficoMensal", strConn)
        ...
        Protected Sub BindGraphData()
            ...
            Dim objData As DataTable = ClassBD.GetExibirGrid("scr_grafico_P123Analise '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "'", "GraficoMensal", strConn)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            If GridView1.Rows.Count.ToString + 1 < 65536 Then
                ...
                Dim filename As String = String.Format("P123Analise{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
        ...
        Public Function GetXaml1() As [String]
            ...
            myXaml = myXaml & "<vc:Title Text=""" & "Análise Parcela " & ddlFaixa.SelectedValue & " - Veiculos % Valor" & """/> "
