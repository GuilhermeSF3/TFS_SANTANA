...
Public Class MapaPDVVeicLoja
    ...
    Private Function GetData() As DataTable
        ...
        Dim Table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_MAPA_PDV_VEIC_LOJA] '" & Convert.ToDateTime(txtData.Text).ToString("yyyyMMdd") & "'", "IndicePerformance", strConn)
        ...
        'ValorRisco1 = Table.Compute("sum(GRAU)", "")

        'PERDA = Table.Compute("sum(QTD_LJ_SAI)/sum(LJ_ATIVA)*100.0", "")
