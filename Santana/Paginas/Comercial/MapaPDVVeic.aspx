<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MapaPDVVeic.aspx.vb" Inherits="Santana.MapaPDVVeic" Title="Mapa PDV Veiculos" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 420px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"  AllowSorting="TRUE"  DataKeyNames="LOJA"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="LOJA - cod" SortExpression="LOJA" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                            <FooterTemplate>TOTAL</FooterTemplate>
                        </asp:TemplateField>

<%--                        <asp:TemplateField HeaderText="Cod LOJA" SortExpression="CodLOJA" ItemStyle-BackColor="#EFEFEF">
                        ...
                        <asp:TemplateField HeaderText="Operador - cod" SortExpression="Operador" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>


                        <asp:TemplateField HeaderText="QTDE" SortExpression="QTDM3">
                        ...
                        <asp:TemplateField HeaderText="Valor" SortExpression="VLRM3" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="T%" SortExpression="TM3">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="QTDE" SortExpression="QTDM2" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Valor" SortExpression="VLRM2" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="T%" SortExpression="TM2">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="QTDE" SortExpression="QTDM1" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Valor" SortExpression="VLRM1" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                                <span style="display:block; padding:0; text-align: right"><%=ValorRisco1.ToString("#,##0##")%></span>
                            </FooterTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="T%" SortExpression="TM1">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
