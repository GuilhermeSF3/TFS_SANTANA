<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RrMensalCUBO.aspx.vb" Inherits="Santana.RrMensalCUBO" Title="Carteira / PDD" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Carteira / PDD</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_RowCommand" DataKeyNames="ORDEM,M0_DESCR1"
                    font-size="9pt" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="REFERENCIA" SortExpression="M0_DESCR1" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="18%" HorizontalAlign="Left" BackColor="#EFEFEF" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CARTEIRA (mês anterior)" SortExpression="M0_CARTEIRA" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="8%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PDD" SortExpression="M0_PDD" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="9%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="M0_PDD_PRC">
                            <ItemStyle Width="3%" HorizontalAlign="Right"  BackColor="#EFEFEF"  />
                        </asp:TemplateField>



<%--                        <asp:TemplateField HeaderText="AA PERC" SortExpression="AA_PERC">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonAA" runat="server" CommandName="AA" CommandArgument='<%# Eval("ORDEM_LINHA")%>'>
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="A PERC" SortExpression="A_PERC">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="PREJUIZO" SortExpression="M1_PREJUIZO">
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="DESPESA" SortExpression="M1_DESPESA">
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="REFERENCIA" SortExpression="M1_DESCR1">
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="CARTEIRA (mês Ref)" SortExpression="M1_CARTEIRA">
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="PDD" SortExpression="M1_PDD">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="%" SortExpression="M1_PDD_PRC">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
...
<%--                        <asp:TemplateField HeaderText="TTL PRC" SortExpression="TTL_PRC">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="IP PRC" SortExpression="IP_PRC">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>--%>
