<%@ Page Language="vb" MasterPageFile="~/SantanaWeb.Master" AutoEventWireup="true" CodeBehind="DetalheContratos.aspx.vb" Inherits="Santana.DetalheContratos" Title="Contrato Detalhe"  EnableEventValidation="false" %>
                                ...
                                <table style="margin-top:10px">
                                    <tr>
                                        ...
                                        <td style="width:350px">
                                                <asp:Label ID="lblDataReferencia" runat="server" Text="" CssClass="navbar-text" style="margin:4px "></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblAgente" runat="server" Text="" CssClass="navbar-text" style="margin:4px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblCobradora" runat="server" Text="" CssClass="navbar-text" style="margin:4px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="lblClasse" runat="server" Text="" CssClass="navbar-text" style="margin:4px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>                                 
                            ...
                            <li>
                                <table>
                                    <tr>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <asp:Button ID="btnVoltar" runat="server" CssClass="btn btn-default navbar-btn" OnClick="btnVoltar_Click"></asp:Button>
                                            </div>
                                        </td>
                                        <td>
                                        </td> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <asp:Button ID="btnLocalizar" runat="server" Text="Localizar" CssClass="btn btn-primary navbar-btn" OnClick="btnLocalizar_Click" ></asp:Button>
