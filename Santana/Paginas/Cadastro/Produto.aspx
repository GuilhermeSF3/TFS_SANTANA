<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Produto.aspx.vb" Inherits="Santana.Paginas.Cadastro.Produto" Title="Cadastro de Produto" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cod_prod"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Cód Produto">
                            <HeaderTemplate>
                                <asp:Label ID="lblCOCodProduto" runat="server" Text="Cód Produto"></asp:Label>
                                <asp:TextBox ID="txtNewcod_prod" runat="server" Width="100px" MaxLength ="4"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblcod_prod" runat="server" Text='<%# Eval("cod_prod")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblcod_prod" runat="server" Text='<%# Eval("cod_prod")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Descrição">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewdescr_prod" runat="server" Width="350px" MaxLength ="100"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("descr_prod")%>' ID="txtdescr_prod" Width="350px" MaxLength ="100"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("descr_prod").ToString().Substring(0, Math.Min(Eval("descr_prod").ToString().Length, 60))%>' ID="Label3" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
