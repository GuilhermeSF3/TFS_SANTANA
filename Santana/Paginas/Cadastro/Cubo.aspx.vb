...
Namespace Paginas.Cadastro
    ...
    Public Class Cubo
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbCubo().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewCubo As TextBox
                txtNewCubo = CType(GridView1.HeaderRow.FindControl("txtNewCubo"), TextBox)

                Dim txtNewDescr As TextBox
                txtNewDescr = CType(GridView1.HeaderRow.FindControl("txtNewDescr"), TextBox)


                If txtNewCubo.Text.Trim() = "" Or
                ...
                Else
                    ...
                    objData = New DbCubo
                    Dim tdData As DataTable = objData.CarregarRegistro(txtNewCubo.Text.Trim())
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(Convert.ToInt32(txtNewCubo.Text.Trim()), _
            ...
            ElseIf e.CommandName.Equals("Delete") Then
                ...
                objData.ApagarRegistro(Convert.ToInt32(GridView1.DataKeys(index).Values(0).ToString()))
                FillDataInGrid()
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewCubo"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewCubo"), TextBox).Visible = False
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(Convert.ToInt32(GridView1.DataKeys(e.RowIndex).Values(0).ToString()), txtDescr.Text)
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Cubo_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
