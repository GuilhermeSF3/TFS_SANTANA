<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="SalarioMinimo.aspx.vb" Inherits="Santana.Paginas.Cadastro.SalarioMinimo" Title="Cadastro de Salário Mínimo" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de Salário Mínimo</title>
</asp:Content>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Data">
                            <HeaderTemplate>
                                <asp:Label ID="lblDT_DE" runat="server" Text="Data"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Valor SM">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Valor SM"></asp:Label>
                                <asp:TextBox ID="txtNewVLR_SM" runat="server" Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox ID="txtVLR_SM" runat="server" Text='<%# Eval("VLR_SM")%>'  Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("VLR_SM")%>' ID="Label3" Width="100px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
