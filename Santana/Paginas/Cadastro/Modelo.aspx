<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Modelo.aspx.vb" Inherits="Santana.Paginas.Cadastro.Modelo" Title="Modelos" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="nroper"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Contrato">
                            <HeaderTemplate>
                                <asp:Label ID="lnlNroOperador" runat="server" Text="Contrato"></asp:Label>
                                <asp:TextBox ID="txtNewnroper" runat="server" Width="100px" MaxLength="15"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblnroper" runat="server" Text='<%# Eval("nroper")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblnroper" runat="server" Text='<%# Eval("nroper")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Modelo função">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Modelo função"></asp:Label>
                                <asp:TextBox ID="txtNewveic_mod" runat="server" Width="350px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("veic_mod")%>' ID="txtveic_mod" Width="350px" MaxLength="100"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("veic_mod").ToString().Substring(0, Math.Min(Eval("veic_mod").ToString().Length, 60))%>' ID="Label3" Width="350px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Modelo Padrão">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Modelo Padrão"></asp:Label>
                                <asp:TextBox ID="txtNewveic_mod2" runat="server" Width="350px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("veic_mod2")%>' ID="txtveic_mod2" Width="350px" MaxLength="100"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("veic_mod2").ToString().Substring(0, Math.Min(Eval("veic_mod2").ToString().Length, 60))%>' ID="Label4" Width="350px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
