...
Namespace Paginas.Cadastro
    ...
    Public Class TaxaComissãoXMeta
        Inherits SantanaPage

        Dim objData As DbTaxaOperacaoXMeta
        ...
        Private Function GetData() As DataTable
            Return New DbTaxaOperacaoXMeta().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewVlrProd As TextBox
                txtNewVlrProd = CType(GridView1.HeaderRow.FindControl("txtNewVlrProd"), TextBox)

                Dim txtNewVLR_Meta_De As TextBox
                txtNewVLR_Meta_De = CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_De"), TextBox)

                Dim txtNewVLR_Meta_Ate As TextBox
                txtNewVLR_Meta_Ate = CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_Ate"), TextBox)

                Dim txtNewPerc_com As TextBox
                txtNewPerc_com = CType(GridView1.HeaderRow.FindControl("txtNewPerc_com"), TextBox)
                ...
                If txtNewDATA_De.Text.Trim() = "" Or
                    txtNewDesc.Text = "" Or
                    txtNewVlrProd.Text = "" Or
                    txtNewVLR_Meta_De.Text = "" Or
                    txtNewVLR_Meta_Ate.Text = "" Or
                    txtNewPerc_com.Text = "" Or
                ...
                Else
                    ...
                    objData = New DbTaxaOperacaoXMeta
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewDATA_De.Text, _
                                                     txtNewDesc.Text, _
                                                     Convert.ToDouble(txtNewVlrProd.Text), _
                                                     Convert.ToDouble(txtNewVLR_Meta_De.Text), _
                                                     Convert.ToDouble(txtNewVLR_Meta_Ate.Text), _
                                                     Convert.ToDouble(txtNewPerc_com.Text), _
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewVlrProd"), TextBox).Visible = True

            CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_De"), TextBox).Visible = True

            CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_Ate"), TextBox).Visible = True

            CType(GridView1.HeaderRow.FindControl("txtNewPerc_com"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewVlrProd"), TextBox).Visible = False

            CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_De"), TextBox).Visible = False

            CType(GridView1.HeaderRow.FindControl("txtNewVLR_Meta_Ate"), TextBox).Visible = False

            CType(GridView1.HeaderRow.FindControl("txtNewPerc_com"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtVlrProd As TextBox
                txtVlrProd = CType(GridView1.Rows(e.RowIndex).FindControl("txtVlrProd"), TextBox)

                Dim txtVLR_Meta_De As TextBox
                txtVLR_Meta_De = CType(GridView1.Rows(e.RowIndex).FindControl("txtVLR_Meta_De"), TextBox)

                Dim txtVLR_Meta_Ate As TextBox
                txtVLR_Meta_Ate = CType(GridView1.Rows(e.RowIndex).FindControl("txtVLR_Meta_Ate"), TextBox)

                Dim txtPerc_com As TextBox
                txtPerc_com = CType(GridView1.Rows(e.RowIndex).FindControl("txtPerc_com"), TextBox)

                Dim txtOrder As TextBox
                txtOrder = CType(GridView1.Rows(e.RowIndex).FindControl("txtOrder"), TextBox)

                If txtVlrProd.Text = "" Or
                  txtVLR_Meta_De.Text = "" Or
                  txtVLR_Meta_Ate.Text = "" Or
                  txtPerc_com.Text = "" Or
                  txtOrder.Text = "" Then
                    strMensagem = "Por favor, preencher todos os campos."
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(lblDATA_De.Text, _
                                                     lblDesc.Text, _
                                                     Convert.ToDouble(txtVlrProd.Text),
                                                     Convert.ToDouble(txtVLR_Meta_De.Text),
                                                     Convert.ToDouble(txtVLR_Meta_Ate.Text),
                                                     Convert.ToDouble(txtVlrProd.Text),
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Taxa_Comissao_X_Meta_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
