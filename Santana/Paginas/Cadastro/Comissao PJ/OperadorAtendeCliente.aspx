<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="OperadorAtendeCliente.aspx.vb" Inherits="Santana.Paginas.Cadastro.OperadorAtendeCliente" Title="Operador Atende Cliente" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Operador Atende Cliente</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD,DT_DE,COD_OPERADOR"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="A partir de">
                            <HeaderTemplate>
                                <asp:Label ID="lblDATA_DeDesc" runat="server" Text="A partir de"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Até">
                            <HeaderTemplate>
                                <asp:Label ID="lblDT_ATEDesc" runat="server" Text="Até"></asp:Label>
                                <asp:TextBox ID="txtNewDT_ATE" runat="server" Width="100px" CssClass="clDate" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                 <asp:TextBox ID="txtDT_ATE" runat="server" Text='<%# Eval("DT_ATE", "{0:dd/MM/yyyy}")%>'  Width="100px" CssClass="clDate" MaxLength="10"></asp:TextBox>                                
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("DT_ATE", "{0:dd/MM/yyyy}")%>' ID="lblDT_ATE" Width="100px"></asp:Label>

                            </ItemTemplate>
                        </asp:TemplateField>


                        <asp:TemplateField HeaderText="Código do Operador">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Operador"></asp:Label>
                                <asp:DropDownList ID="ddlNewCOD_OPERADOR" runat="server" Width="250px"></asp:DropDownList>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList ID="ddlCOD_OPERADOR" runat="server" Width="250px"></asp:DropDownList>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("COD_OPERADOR")%>' ID="lblCOD_OPERADOR" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$("#ContentPlaceHolder1_GridView1_txtNewCOD").keyup(function () {


            //    $.ajax({
            //        type: "GET",
            //        contentType: "application/json; charset=utf-8",
            //        url: "OperadorAtendeCliente.aspx/GetName",
            //        dataType: "json",
            //        async: true
