...
Namespace Paginas.Cadastro
    ...
    Public Class TcOperacaoXMeta
        Inherits SantanaPage

        Dim objData As DbTcOperacaoXMeta
        ...
        Private Function GetData() As DataTable
            Return New DbTcOperacaoXMeta().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Else
                    ...
                    objData = New DbTcOperacaoXMeta
                    Dim tdUser As DataTable = objData.CarregarRegistro(txtNewDATA_De.Text.Trim, txtNewDesc.Text)
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewDATA_De.Text, _
                                                     ...
                                                     Convert.ToDouble(txtNewVLR_TC.Text), _
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Tc_Operacao_X_Meta_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
