<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Fixo.aspx.vb" Inherits="Santana.Paginas.Cadastro.Comissao_PJ.Fixo" Title="Fixo - Ajuda de Custo" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Fixo - Ajuda de Custo</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<%--DataKeyNames="DATA_REF,RATING,FAIXA"--%>
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="DT_DE,DESCR"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Prazo De" >
							<HeaderTemplate>
								<asp:Label runat="server" Text="Prazo De" Width="150px" ></asp:Label>
								<asp:TextBox ID="txtNewPRAZO_DE" runat="server" Width="150px" CssClass="allownumericwithoutdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("PRAZO_DE")%>' ID="txtPRAZO_DE" CssClass="allownumericwithoutdecimal" Width="150px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("PRAZO_DE")%>' ID="txtPRAZO_DE" Width="150px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>

							<asp:TemplateField HeaderText="Prazo Ate" >
							<HeaderTemplate>
								<asp:Label runat="server" Text="Prazo Até" Width="150px" ></asp:Label>
								<asp:TextBox ID="txtNewPRAZO_ATE" runat="server" Width="150px" CssClass="allownumericwithoutdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("PRAZO_ATE")%>' ID="txtPRAZO_ATE" CssClass="allownumericwithoutdecimal" Width="150px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("PRAZO_ATE")%>' ID="txtPRAZO_ATE" Width="150px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>


						<asp:TemplateField HeaderText="VALOR_DE">
							<HeaderTemplate>
								<asp:Label runat="server" Text="Valor De"></asp:Label>
								<asp:TextBox ID="txtNewVALOR_DE" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("VALOR_DE")%>' ID="txtVALOR_DE" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("VALOR_DE")%>' ID="lblVALOR_DE" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>

						<asp:TemplateField HeaderText="VALOR_ATE">
							<HeaderTemplate>
								<asp:Label runat="server" Text="Valor Até"></asp:Label>
								<asp:TextBox ID="txtNewVALOR_ATE" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("VALOR_ATE")%>' ID="txtVALOR_ATE" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("VALOR_ATE")%>' ID="lblVALOR_ATE" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>

						<asp:TemplateField HeaderText="VLR_AJUDA">
							<HeaderTemplate>
								<asp:Label runat="server" Text="Fixo"></asp:Label>
								<asp:TextBox ID="txtNewVLR_AJUDA" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("VLR_AJUDA")%>' ID="txtVLR_AJUDA" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("VLR_AJUDA")%>' ID="txtVLR_AJUDA" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
						...
						<asp:TemplateField HeaderText="Ordem">
							<HeaderTemplate>
								...
								<asp:TextBox ID="txtNewOrder" runat="server" Width="100px" CssClass="allownumericwithoutdecimal" MaxLength="4"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
