<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="TxReduz.aspx.vb" Inherits="Santana.Paginas.Cadastro.TxReduz" Title="Taxa Reduzida" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Taxa reduzida</title>
</asp:Content>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Taxa De(%)">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewVLR_TX_DE" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("TX_DE")%>' ID="txtVLR_TX_DE" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("TX_DE")%>' ID="lblVLR_TX_DE" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Taxa Até(%)">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewVLR_TX_ATE" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("TX_ATE")%>' ID="txtVLR_TX_ATE" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("TX_ATE")%>' ID="lblVLR_TX_ATE" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="% Comissão">
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PRC_COMISSAO")%>' ID="txtPRC_COMISSAO" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
