...
Namespace Paginas.Cadastro
    ...
    Public Class MetaOperadores
        Inherits SantanaPage

        Dim objData As DbMetaOperadores
        ...
        Private Function GetData() As DataTable
            Return New DbMetaOperadores().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim cmbOperador As DropDownList
                cmbOperador = CType(GridView1.HeaderRow.FindControl("cmbOperador"), DropDownList)
                ...
                If txtNewDATA_De.Text.Trim() = "" Or
                    cmbOperador.SelectedValue = "0" Or
                ...
                Else
                    ...
                    objData = New DbMetaOperadores
                    Dim tdUser As DataTable = objData.CarregarRegistro(txtNewDATA_De.Text.Trim, cmbOperador.SelectedValue)
        ...
        Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.Header Then
                    ...
                    Dim cmbOperador As DropDownList
                    cmbOperador = CType(e.Row.FindControl("cmbOperador"), DropDownList)

                    If Not cmbOperador Is Nothing Then
                        objData = New DbMetaOperadores()
                        objData.CarregarOperador(cmbOperador)
                    End If
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("cmbOperador"), DropDownList).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("cmbOperador"), DropDownList).Visible = False
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        Dim lblOPERADOR As String
                        lblOPERADOR = CType(GridView1.Rows(e.RowIndex).FindControl("lblOPERADOR"), Label).Text.ToString

                        objData.AtualizarRegistro(lblDATA_De, _
                                                   lblOPERADOR, _
 ...
 Protected Sub btnMenu_Click(sender As Object, e As EventArgs)
        ...
        Private Sub Carrega_Operadores()
            ...
            Try
                ...
                '                   "select oper_cod cod, OPER_ABV_NOM from finsgrdbs..TB_OPER (NOLOCK) order by 2", connection)
                ...
                cmbOperador.DataSource = ddlValues
                cmbOperador.DataValueField = "OPER_ABV_NOM"
                cmbOperador.DataTextField = "OPER_ABV_NOM"
                cmbOperador.DataBind()

                cmbOperador.Items.Insert(0, New ListItem("", "0"))
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Meta_operadores_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
