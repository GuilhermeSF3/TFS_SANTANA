<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="TcOperacaoXMeta.aspx.vb" Inherits="Santana.Paginas.Cadastro.TcOperacaoXMeta" Title="TC Por OPERAÇÃO x Meta" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>TC Por OPERAÇÃO x Meta</title>
</asp:Content>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_DE,DESCR"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Valor TC">
							<HeaderTemplate>
								<asp:Label runat="server" Text="Valor TC"></asp:Label>
