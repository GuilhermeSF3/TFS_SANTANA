<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaOperadores.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaOperadores" Title="Meta dos operadores" EnableEventValidation="false" %>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_DE,OPERADOR"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Operador">
							...
							<EditItemTemplate>
								<asp:Label ID="lblOPERADOR" runat="server" Text='<%# Eval("OPERADOR")%>' Width="250px"></asp:Label>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("OPERADOR")%>' ID="lblOPERADOR" Width="250px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
						...
						<asp:TemplateField HeaderText="Meta">
							...
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("VLR_TC")%>' ID="txtVLR_TC" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("VLR_TC")%>' ID="lblVLR_TC" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
