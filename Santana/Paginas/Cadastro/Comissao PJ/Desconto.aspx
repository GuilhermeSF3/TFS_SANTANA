<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Desconto.aspx.vb" Inherits="Santana.Paginas.Cadastro.Desconto" Title="Desconto" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="DT_DESCONTO,GRUPO_OPERADOR"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Em">
                            <HeaderTemplate>         
                                <asp:Label ID="lblDT_DESCONTO" runat="server" Text="Em"></asp:Label>
                                <asp:TextBox ID="txtNewDT_DESCONTO" runat="server" Width="100px" CssClass="clDate" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblDT_DESCONTO" runat="server" Text='<%# Eval("DT_DESCONTO", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblDT_DESCONTO" runat="server" Text='<%# Eval("DT_DESCONTO", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Operador">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Operador(grupo)"></asp:Label>
                                <asp:DropDownList ID="cmbGRUPO_OPERADOR" runat="server" Width="250px">
                                </asp:DropDownList>    
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblGRUPO_OPERADOR" runat="server" Text='<%# Eval("GRUPO_OPERADOR")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("GRUPO_OPERADOR")%>' ID="lblGRUPO_OPERADOR" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VLR_DESCONTO">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Desconto"></asp:Label>
                                <asp:TextBox ID="txtNewVLR_DESCONTO" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("VLR_DESCONTO")%>' ID="txtVLR_DESCONTO" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("VLR_DESCONTO")%>' ID="lblVLR_DESCONTO" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
