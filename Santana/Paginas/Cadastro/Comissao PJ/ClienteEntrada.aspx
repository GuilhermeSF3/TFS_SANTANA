<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ClienteEntrada.aspx.vb" Inherits="Santana.Paginas.Cadastro.ClienteEntrada" Title="Cliente Entrada " EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cliente Entrada</title>
</asp:Content>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Cliente">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Cedente"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Entrada na Santana">
                            <HeaderTemplate>
                                <asp:Label ID="lblDATA_DeDesc" runat="server" Text="Entrada na Santana"></asp:Label>
                                <asp:TextBox ID="txtNewDATA_De" runat="server" Width="150px" CssClass="clDate" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                 <asp:TextBox ID="txtDATA_De" runat="server" Text='<%# Eval("DT_DE", "{0:dd/MM/yyyy}")%>' Width="150px" CssClass="clDate" MaxLength="10"></asp:TextBox>
