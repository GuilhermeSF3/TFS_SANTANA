...
Namespace Paginas.Cadastro.Gerencial
    ...
    Public Class Relatorios
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbRelatorio().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewCOD_RPT As TextBox
                txtNewCOD_RPT = CType(GridView1.HeaderRow.FindControl("txtNewCOD_RPT"), TextBox)

                Dim txtNewDESCR As TextBox
                txtNewDESCR = CType(GridView1.HeaderRow.FindControl("txtNewDESCR"), TextBox)

                Dim cmbNewMODELO As DropDownList
                cmbNewMODELO = CType(GridView1.HeaderRow.FindControl("cmbNewMODELO"), DropDownList)



                If txtNewCOD_RPT.Text.Trim() = "" Or
                ...
                Else
                    ...
                    objData = New DbRelatorio
                    Dim tdData As DataTable = objData.CarregarRegistro(txtNewCOD_RPT.Text.Trim())
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewCOD_RPT.Text.Trim(), _
                                                txtNewDESCR.Text.Trim(),
                                                cmbNewMODELO.SelectedValue)
        ...
        Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
            ...
            Try
                If e.Row.RowType = DataControlRowType.DataRow Then
                    Dim cmbMODELO As DropDownList
                    cmbMODELO = CType(e.Row.FindControl("cmbMODELO"), DropDownList)

                    If Not cmbMODELO Is Nothing Then
                        cmbMODELO.SelectedValue = GridView1.DataKeys(e.Row.RowIndex).Values(1)
                    End If
                End If
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewCOD_RPT"), TextBox).Visible = True
            CType(GridView1.HeaderRow.FindControl("txtNewDESCR"), TextBox).Visible = True
            CType(GridView1.HeaderRow.FindControl("cmbNewMODELO"), DropDownList).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewCOD_RPT"), TextBox).Visible = False
            CType(GridView1.HeaderRow.FindControl("txtNewDESCR"), TextBox).Visible = False
            CType(GridView1.HeaderRow.FindControl("cmbNewMODELO"), DropDownList).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim cmbMODELO As DropDownList
                cmbMODELO = CType(GridView1.Rows(e.RowIndex).FindControl("cmbMODELO"), DropDownList)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Relatorios_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
