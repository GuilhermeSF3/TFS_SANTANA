    ...
    Public Class PadraoDozeMeses
        ...
        Private Sub Carrega_Relatorio()
            ...
            Try
                ...
                Dim connection As New SqlConnection(strConn)
                Dim command As SqlCommand = New SqlCommand( _
                "SELECT COD_RPT, DESCR FROM GER_RELATORIO (NOLOCK) WHERE MODELO=2", connection)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            ...
            Try
                ...
                'e.Row.Cells(6).Text = "Proc. Mês / Média"
                'e.Row.Cells(7).Text = "Mês atual / Mês Ano Ant."
                'e.Row.Cells(8).Text = "Média do Ano"
                'oData.Data = oData.Data.AddMonths(-12)
                'e.Row.Cells(9).Text = oData.NomeMesSigla + "/" + oData.Data.Year.ToString()
                'e.Row.Cells(10).Text = "Média" + oData.Data.Year.ToString()
                ...
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    'e.Row.Cells(5).Text = drow("M2")
                    e.Row.Cells(5).Text = CNumero.FormataNumero(drow("M1"), 2)
                    e.Row.Cells(6).Text = drow("ordem")

                    'Dim ordem As Integer = 4
                    'For mes As Integer = 13 To 8 Step -1
                    '    ordem += 1
        ...
        Private Function GetData() As DataTable
            ...
            Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
            Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_GERENCIAL_RELATORIO2] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlRelatorio.SelectedValue & "','" & ddlEmpresa.SelectedValue & "'", "PadraoTrezeMeses", strConn)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Padrao_Doze_Meses_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Padrão 1  Ref " & txtData.Text & " - Relatório " & ddlRelatorio.SelectedItem.Text)
        ...
        '            Response.Clear()
        '            Response.Buffer = True
        '            Dim filename As String = String.Format("Padrao_12_Meses_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
        '            Response.AddHeader("content-disposition", "attachment;filename=" + filename)
        ...
        '                Dim style As String = "<html><head><style type='text/css'>" & sb.ToString() & "</style><head>"
        '                Response.Write(style)
        '                Response.Write("Relatório Produção por Analista")
        '                Response.Output.Write(sw.ToString())
        '                HttpContext.Current.Response.Flush()
        '                HttpContext.Current.Response.SuppressContent = True
        '                HttpContext.Current.ApplicationInstance.CompleteRequest()
