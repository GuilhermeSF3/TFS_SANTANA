<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Cubo.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.Cubo" Title="Cubo" EnableEventValidation="false" %>
                                ...
                                <div style="margin: 5px">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <span class="btn" style="padding: 0; border-width: 0;">
                                            <cc1:Datax ID="txtData" runat="server" MaxLength="10" Width="130px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cod. Conta" SortExpression="COD_CONTA">
                        ...
                        <asp:TemplateField HeaderText="Valor" SortExpression="VLR">
