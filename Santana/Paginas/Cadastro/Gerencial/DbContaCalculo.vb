...
Public Class DbContaCalculo
    ...
    Public Sub AtualizarRegistro(ByVal COD_CONTA As String, _
        ...
        Dim sql As String = "UPDATE GER_CONTA_CALCULO SET SINAL=@SINAL " & _
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM GER_CONTA_CALCULO (NOLOCK) ORDER BY COD_CONTA"
    ...
    Public Sub CarregarContaCalculo(ByVal CONTA_CAMPO As String, ByVal ddlContaCalculo As DropDownList)
        ...
        'Dim sql As String = "SELECT * FROM PLANO_CONTAS (NOLOCK) " & _
