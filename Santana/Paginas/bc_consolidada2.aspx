<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.Master" AutoEventWireup="true" CodeBehind="bc_consolidada2.aspx.vb" Inherits="Santana.bc_consolidada" Title="Base de Crédito Consolidada"  EnableEventValidation="false" %>
                        ...
                        <ul class="nav navbar-nav" >
                            ...
                            <li> 
                                <div style="margin:5px" >
                                    ...
                                    <div class="btn-group">                                                              
                                        <asp:Button ID="Button1" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataAnterior_Click"></asp:Button>
                                        ...
                                        <asp:Button ID="Button2" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaData_Click"></asp:Button>                                   
                                    </div>
                                 <div>
                            </li>
