...
Public Class RollrateDiario
    ...
    Protected Sub BindGridView1Data()
        ...
        'GridView1.DataSource = Util.ClassBD.GetExibirGrid("[scr_RR_diario] '" & Convert.ToDateTime(txtData.Text).ToString("MM/dd/yy") & "', '" & ddlAgente.SelectedValue & "','" & ddlCobradora.SelectedValue & "'", "RollrateDiario", strConn)
    ...
    Protected Sub btnProcessar_Click(sender As Object, e As EventArgs)
        Try
            ...
            Dim connection As New SqlConnection(strConn)
            Dim command As SqlCommand = New SqlCommand( _
            "scr_PROCESSA_RRDIA '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "'", connection)
