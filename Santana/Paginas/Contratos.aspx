...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<asp:Table ID="Table6" runat="server" BorderWidth="1" Width="100%" CellSpacing="1"
     CellPadding="0" HorizontalAlign="Center" GridLines="None" 
     BorderColor="#006666" BorderStyle="None" >
  <asp:TableRow Height="20px" CssClass="tr-7">
    <asp:TableCell ColumnSpan="4" HorizontalAlign="Center">
            <asp:Label ID="Label1" runat="server" Text="" Visible="true"  CssClass="font-default-6"
              Font-Bold="true" />
    </asp:TableCell>
 </asp:TableRow>
</asp:Table>--%>
    ...
    <asp:UpdatePanel ID="UpdateManager" runat="server">
        <ContentTemplate>
         ...
         ToolTip="Imprimir" />
                    ...
                    <%--<asp:TableCell
     ToolTip="Contratos com Atraso acima de x dias, podendo selecionar o numero da parcela e intervalo de vencimento, com filtro de Cliente, Loja, Filial ou Supervisora.
Posição on-line."  
    ...
    <asp:Table ID="Table7" runat="server" BorderWidth="1" Width="100%">
        <asp:TableRow CssClass="tr-0">
            <asp:TableCell Width="10%" HorizontalAlign="center" BackColor="#00aaaa" Font-Bold="true" Font-Underline="false" ForeColor="White" VerticalAlign="Middle">
                <%-- <asp:ImageButton ID="ExpBrOffice" runat="server" Visible="true" Height="30px" Width="30px" ImageUrl="~/imagens/MarcAdvertencia.jpg" ToolTip="Exportar BR Office" /> --%>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="true" HeaderStyle-CssClass="font-default-4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RATING" SortExpression="PDD" HeaderStyle-HorizontalAlign="Center">
                            <%-- <FooterTemplate><%=sPdd.ToString("N2")%></FooterTemplate>--%>
                            <ItemTemplate>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
