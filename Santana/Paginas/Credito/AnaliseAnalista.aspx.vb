    ...
    Public Class AnaliseAnalista
        ...
        Private Sub Carrega_Produto()
            ...
            Try
                ...
                Dim connection As New SqlConnection(strConn)
                Dim command As SqlCommand = New SqlCommand( _
                "SELECT descr_tipo, descr_tipo as PRODUTO FROM Ttipo_prod (NOLOCK) where COD_PROD  in ( 'V','cg')", connection)
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("dt_contrato")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("dt_contrato")
                        End If

                        If IsDBNull(drow("produto")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("produto")
                        End If

                        If IsDBNull(drow("vlr_financiado")) OrElse drow("vlr_financiado") = 0 Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = CNumero.FormataNumero(drow("vlr_financiado"), 2)
                        End If
                        ...
                        If IsDBNull(drow("REANALISE")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("REANALISE")
                        End If
