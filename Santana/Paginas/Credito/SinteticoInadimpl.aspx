<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="SinteticoInadimpl.aspx.vb" Inherits="Santana.Paginas.Credito.SinteticoInadimpl" Title="Inadinplência por Analista Sintetico" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Inadinplência por Analista - Sintetico</title>
</asp:Content>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Quant. Atraso" SortExpression="atraso">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Financiado (Atraso)" SortExpression="vlr_ATRASO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Quant. Contratos (Adimpl)" SortExpression="qtd_adimpl">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Financiado (Adimpl)" SortExpression="vlr_adimpl">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Quant. Contratos Total" SortExpression="qtd">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Financiado Total" SortExpression="vlr_financ">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

<%--                        <asp:TemplateField HeaderText="% TTL" SortExpression="ttl">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>          

        --%>
                        <asp:TemplateField HeaderText="% Inadimplência" SortExpression="prc_atraso">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>    
