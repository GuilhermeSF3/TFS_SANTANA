...
Namespace Paginas.Credito
    ...
    Public Class SinteticoInadimpl
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        e.Row.Cells(1).Text = drow("atraso")
                        e.Row.Cells(2).Text = CNumero.FormataNumero(drow("vlr_ATRASO"), 2)
                        e.Row.Cells(3).Text = drow("ADIMPLENTE")
                        e.Row.Cells(4).Text = CNumero.FormataNumero(drow("vlr_ADIMPL"), 2)
                        e.Row.Cells(5).Text = drow("QTD")
                        e.Row.Cells(6).Text = drow("VLR_FINANC")
                        e.Row.Cells(7).Text = CNumero.FormataNumero(drow("prc_Atraso"), 2)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_credito_inadimpl_sint] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & _
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & _
                                                                "', '" & ddlAnalista.SelectedValue & _
                                                                "', " & txtValorDe.Text & _
                                                                ", " & txtValorAte.Text & _
                                                                "", "INADINPLANALISTASINTETICO", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Inadinplencia_Analista_Sintetico_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Relatório Inadiplencia por Analista - Sintetico")
