    ...
    Public Class SinteticoAnalise
        ...
        Private Sub Carrega_Analistas()
            ...
            Try
                ...
                ddlAnalista.Items.Insert(0, New ListItem("Todos", "MESA"))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        End If
                        If IsDBNull(drow("ANALISE")) OrElse drow("ANALISE") = 0 Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = CNumero.FormataNumero(drow("ANALISE"), 2)
                        End If

                        If IsDBNull(drow("Total")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = CNumero.FormataNumero(drow("Total"), 2)
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_credito_tempo_sintetico] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & _
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & _
                                                                "', '" & ddlAnalista.SelectedValue & _
                                                                "'", "SINTETICOANALISTA", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PSintetico_Analista_Tempo_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Relatório Produção Analista   De: " & txtDataDe.Text & "  Até: " & txtDataAte.Text & " Analista : " & ddlAnalista.SelectedValue)
