<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CETIPPotencialAnaliticoConsulta.aspx.vb" Inherits="Santana.Paginas.Cetip.CETIPPotencialAnaliticoConsulta" Title="CETIP Potencial Analitico" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CETIP Potencial Analitico</title>
</asp:Content>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">CEP DE:</p>
                                        <asp:TextBox ID="txtCepDe" Width="100px" runat="server" Visible="True" Enabled="true"  CssClass="form-control navbar-btn"></asp:TextBox>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">CEP ATÉ:</p>
                                        <asp:TextBox ID="TxtCepAte" Width="100px" runat="server" Visible="True" Enabled="true"  CssClass="form-control navbar-btn"></asp:TextBox>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">LOJA ATIVA: </p>
                                    </div>
                                    <asp:DropDownList ID="ddlLOJA" Width="30px" runat="server" Visible="True" Enabled="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Consorcio" SortExpression="Consorcio">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="F/J" SortExpression="TipoPessoa">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>
