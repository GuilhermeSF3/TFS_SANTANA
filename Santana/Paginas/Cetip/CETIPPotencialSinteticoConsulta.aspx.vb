...
Namespace Paginas.Cetip
    ...
    Public Class CETIPPotencialSinteticoConsulta
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                txtDataDe.Text = Mid(Convert.ToString(UltimoDiaMesAnterior), 4, 7) 'UltimoDiaUtilMesAnterior(UltimoDiaMesAnterior)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        e.Row.Cells(10).Text = drow("Numero")
                        e.Row.Cells(11).Text = drow("Bairro")
                        e.Row.Cells(12).Text = drow("Cidade")
                        e.Row.Cells(13).Text = drow("UF")
                        e.Row.Cells(14).Text = drow("CEP")
                        e.Row.Cells(15).Text = drow("Quantidade")
                        e.Row.Cells(16).Text = drow("Volume")
                        e.Row.Cells(17).Text = drow("MarketShareQuant")
                        e.Row.Cells(18).Text = drow("MarketShareValor")
                        e.Row.Cells(19).Text = drow("MarketShareAcimaQuant")
                        e.Row.Cells(20).Text = drow("MarketShareAcimaValor")
                        e.Row.Cells(21).Text = drow("MarketShareAbaixoQuant")
                        e.Row.Cells(22).Text = drow("MarketShareAbaxoValor")
        ...
        Private Function GetData() As DataTable
            ...
            'table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_POTENCIAL_SINTETICO_CONSULTA] " & formataData(txtDataDe.Text) & ", " & formataTexto(txtLocalizar.Text), "PSCETIP", strConn)
            table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_POTENCIAL_SINTETICO_CONSULTA] " & Mid(txtDataDe.Text, 4, 4) & Mid(txtDataDe.Text, 1, 2) & ", " & formataTexto(txtLocalizar.Text), "PSCETIP", strConn)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Cetip Potencial Sintetico  - " + txtLocalizar.Text)
