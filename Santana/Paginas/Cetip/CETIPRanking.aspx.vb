...
Namespace Paginas.Cetip
    ...
    Public Class CETIPRanking
        ...
        Dim strQuantidadedeBancos As String
        Dim strRankingCliente As String
                    ...
                    If System.IO.File.Exists(Arquivo) = True Then
                        ...
                        Do While objReader.Peek() <> -1
                            ...
                            If (strTipoRegistro = "H") Then
                                strMesReferencia = (Mid(TextLine, 27, 6))

                                command = New SqlCommand( _
                                "SCR_CETIP_RANKING_LIMPAR " + _
                                    strMesReferencia, connection)
                            ...
                            If (strTipoRegistro = "D") Then
                                ...
                                strQuantidadedeBancos = formataValor(Mid(TextLine, 699, 6), 0)
                                strRankingCliente = formataValor(Mid(TextLine, 705, 6), 0)

                                command = New SqlCommand( _
                                "SCR_CETIP_RANKING_GRAVAR " + _
                                    strMesReferencia + ", " + _
                                    strCNPJ + ", " + _
                                    strClassificacao + ", " + _
                                    strRazaoSocial + ", " + _
                                    ...
                                    strCidade + ", " + _
                                    strCEP + ", " + _
                                    strQuantidadedeBancos + ", " + _
                                    strRankingCliente, connection)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_RANKING_DADOS]", "RCETIP", strConn)
