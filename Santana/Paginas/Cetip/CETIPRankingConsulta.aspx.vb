...
Namespace Paginas.Cetip
    ...
    Public Class CETIPRankingConsulta
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_RANKING_CONSULTA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & "', '" & txtLocalizar.Text & "'", "RCETIP", strConn)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Cetip Ranking  - " + txtLocalizar.Text)
