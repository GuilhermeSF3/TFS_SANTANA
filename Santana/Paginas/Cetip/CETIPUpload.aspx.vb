        ...
        Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
            If FileUpload1.HasFile Then
                Try
                    ...
                    'Dim Arquivo = FileUpload1.PostedFile.FileName

                    'If FileUpload1.HasFile Then
                    'Dim Arquivo = FileUpload1.PostedFile.FileName
                    'End If
                    'Dim Arquivo = System.IO.Path.GetFullPath(FileUpload1.PostedFile.FileName)
                    'Dim Arquivo = System.IO.Path.GetFullPath(FileUpload1.PostedFile.FileName)

                    'Label1.Text = Arquivo.ToString

                    FileUpload1.SaveAs(Arquivo)
                    Label1.Text = "File name: " & FileUpload1.PostedFile.FileName
                    ' & "<br>" & "File Size: " & FileUpload1.PostedFile.ContentLength & "<br>" & "Content type: " & FileUpload1.PostedFile.ContentType & "<br>" & "Location Saved: C:\Uploads\" & FileUpload1.FileName
                    ...
                    If System.IO.File.Exists(Arquivo) = True Then
                        'If (FileUpload1.HasFile) And System.IO.File.Exists(Arquivo) Then
