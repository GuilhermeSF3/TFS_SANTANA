    ...
    Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                'col = 27
                'e.Row.Cells(col).Text = "Média " + oData.Data.Year.ToString()
...
10:
                    ...
                    'col += 1
                    'If IsDBNull(drow("mediaAnt")) Or drow("mediaAnt") = 0 Then
                    '    e.Row.Cells(col).Text = ""
                    'Else
                    '    e.Row.Cells(col).Text = CNumero.FormataNumero(drow("mediaAnt"), 0)
                    'End If
                    'e.Row.Cells(col).BackColor = cor
...
25:
                    ...
                    'col += 1
                    'If IsDBNull(drow("mediaAtual")) Or drow("mediaAtual") = 0 Then
                    '    e.Row.Cells(col).Text = ""
                    'Else
                    '    e.Row.Cells(col).Text = CNumero.FormataNumero(drow("mediaAtual"), 0)
                    '    'End If
                    '    e.Row.Cells(col).BackColor = cor2
            ...
            '        e.Row.Cells(1).Text = drow("m13")
            '        e.Row.Cells(2).Text = drow("P13")
            '        e.Row.Cells(3).Text = drow("m12")
            '        e.Row.Cells(4).Text = drow("P12")
            '        e.Row.Cells(5).Text = drow("m11")
            '        e.Row.Cells(6).Text = drow("P11")
            '        e.Row.Cells(7).Text = drow("m10")
            '        e.Row.Cells(8).Text = drow("P10")
            '        e.Row.Cells(9).Text = drow("m9")
            '        e.Row.Cells(10).Text = drow("P9")
            '        e.Row.Cells(11).Text = drow("m8")
            '        e.Row.Cells(12).Text = drow("P8")
            '        e.Row.Cells(13).Text = drow("m7")
            '        e.Row.Cells(14).Text = drow("P7")
            '        e.Row.Cells(15).Text = drow("m6")
            '        e.Row.Cells(16).Text = drow("P6")
            '        e.Row.Cells(17).Text = drow("m5")
            '        e.Row.Cells(18).Text = drow("P5")
            '        e.Row.Cells(19).Text = drow("m4")
            '        e.Row.Cells(20).Text = drow("P4")
            '        e.Row.Cells(21).Text = drow("m3")
            '        e.Row.Cells(22).Text = drow("P3")
            '        e.Row.Cells(23).Text = drow("m2")
            '        e.Row.Cells(24).Text = drow("P2")
            '        e.Row.Cells(25).Text = drow("m1")
            '        e.Row.Cells(26).Text = drow("P1")
            '    End If
            'End If
