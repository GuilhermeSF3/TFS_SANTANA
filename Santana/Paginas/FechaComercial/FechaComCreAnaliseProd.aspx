<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComCreAnaliseProd.aspx.vb" Inherits="Santana.FechaComCreAnaliseProd" Title="Análise de Produção" EnableEventValidation="false" %>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:DropDownList ID="ddlCarteira" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn" OnSelectedIndexChanged="ddlCarteira_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </li>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p id="ddlProdutoLabel" class="navbar-text" style="float: none; margin: auto" runat="server" visible="False">Produto</p>
                                    </div>
                                    <asp:DropDownList ID="ddlProduto" Width="50px" runat="server" Visible="False" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"  OnSelectedIndexChanged="ddlProduto_SelectedIndexChanged" ></asp:DropDownList>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p id="ddlTipoProdutoLabel" class="navbar-text" style="float: none; margin: auto" runat="server" visible="False">Tipo de Produto</p>
                                    </div>
                                    <asp:DropDownList ID="ddlTipoProduto" Width="50px" runat="server" Visible="False" Enabled="true" AutoPostBack="true" CausesValidation="false" CssClass="selectpicker navbar-btn" ></asp:DropDownList>
                                </div>
                            </li>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnDataBound="GridView1_DataBound" DataKeyNames="ordem">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Prod" SortExpression="PRODUTO">
                            <ItemStyle Width="15px" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descrição" SortExpression="DESCR" Visible="false" >
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descrição" SortExpression="DESCR2" >
