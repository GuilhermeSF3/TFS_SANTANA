<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComScoreMedio.aspx.vb" Inherits="Santana.FechaComScoreMedio" Title="Score Médio por Agente / Mensal" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Score Médio por Agente / Mensal</title>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" SortExpression="DESCR">
                            <ItemStyle Width="160px" HorizontalAlign="left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="qtde" SortExpression="m3_qtd">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VLR. OP" SortExpression="m3_vlr">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Score" SortExpression="m3_score">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>



                        <asp:TemplateField HeaderText="qtde" SortExpression="m2_qtd">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VLR. OP." SortExpression="m2_vlr">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Score" SortExpression="m2_score">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>



                        <asp:TemplateField HeaderText="qtde" SortExpression="m1_qtd">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VLR. OP." SortExpression="m1_vlr">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Score" SortExpression="m1_score">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>
