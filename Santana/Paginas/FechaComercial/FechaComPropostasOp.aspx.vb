...
Public Class FechaComPropostasOp
    ...
    Private Sub Carrega_Relatorio()
        ...
        Try
            ...
            ddlRelatorio.Items.Insert(0, New ListItem("Operador Qtde", "1"))
            ddlRelatorio.Items.Insert(1, New ListItem("Operador Valor", "2"))
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    ElseIf drow("COR_LINHA") = "A1" Then
                        cor1 = Drawing.ColorTranslator.FromOle(&HC98C50)
                        cor2 = Drawing.ColorTranslator.FromOle(&HD7B395)
                    ElseIf drow("COR_LINHA") = "A2" Then
                        cor1 = Drawing.ColorTranslator.FromOle(&HC98C50)
                        cor2 = cor1
                    ElseIf drow("COR_LINHA") = "A3" Then
                        cor1 = Drawing.ColorTranslator.FromOle(&HEAA9A9)
                        cor2 = cor1
                    Else
                        cor1 = e.Row.Cells(0).BackColor
                        cor2 = cor1
                    ...
                    If IsDBNull(drow("Recebidas")) Or drow("Recebidas") = 0 Then
                        e.Row.Cells(1).Text = ""
                    Else
                        e.Row.Cells(1).Text = CNumero.FormataNumero(drow("Recebidas"), 0)
                    End If
                    e.Row.Cells(1).BackColor = cor1
                    ...
                    If IsDBNull(drow("Aprovadas")) Or drow("Aprovadas") = 0 Then
                        e.Row.Cells(2).Text = ""
                    Else
                        e.Row.Cells(2).Text = CNumero.FormataNumero(drow("Aprovadas"), 0)
                    End If
                    e.Row.Cells(2).BackColor = cor1

                    If IsDBNull(drow("Pagas")) Or drow("Pagas") = 0 Then
                        e.Row.Cells(3).Text = ""
                    Else
                        e.Row.Cells(3).Text = CNumero.FormataNumero(drow("Pagas"), 0)
                    End If
                    e.Row.Cells(3).BackColor = cor1



                    If IsDBNull(drow("MES_ATUAL_APR")) Or drow("MES_ATUAL_APR") = 0 Then
                        e.Row.Cells(4).Text = ""
                    Else
                        e.Row.Cells(4).Text = CNumero.FormataNumero(drow("MES_ATUAL_APR"), 1)
                    End If
                    e.Row.Cells(4).BackColor = cor1

                    If IsDBNull(drow("M1A_APR")) Or drow("M1A_APR") = 0 Then
                        e.Row.Cells(5).Text = ""
                    Else
                        e.Row.Cells(5).Text = CNumero.FormataNumero(drow("M1A_APR"), 1)
                    End If
                    e.Row.Cells(5).BackColor = cor1

                    If IsDBNull(drow("M2A_APR")) Or drow("M2A_APR") = 0 Then
                        e.Row.Cells(6).Text = ""
                    Else
                        e.Row.Cells(6).Text = CNumero.FormataNumero(drow("M2A_APR"), 1)
                    End If
                    e.Row.Cells(6).BackColor = cor1

                    If IsDBNull(drow("M3A_APR")) Or drow("M3A_APR") = 0 Then
                        e.Row.Cells(7).Text = ""
                    Else
                        e.Row.Cells(7).Text = CNumero.FormataNumero(drow("M3A_APR"), 1)
                    End If
                    e.Row.Cells(7).BackColor = cor1

                    If IsDBNull(drow("M4A_APR")) Or drow("M4A_APR") = 0 Then
                        e.Row.Cells(8).Text = ""
                    Else
                        e.Row.Cells(8).Text = CNumero.FormataNumero(drow("M4A_APR"), 2)
                    End If
                    e.Row.Cells(8).BackColor = cor1

                    If IsDBNull(drow("M5A_APR")) Or drow("M5A_APR") = 0 Then
                        e.Row.Cells(9).Text = ""
                    Else
                        e.Row.Cells(9).Text = CNumero.FormataNumero(drow("M5A_APR"), 1)
                    End If
                    e.Row.Cells(9).BackColor = cor1
                    ...
                    If IsDBNull(drow("MES_ATUAL_PG")) Or drow("MES_ATUAL_PG") = 0 Then
                        e.Row.Cells(10).Text = ""
                    Else
                        e.Row.Cells(10).Text = CNumero.FormataNumero(drow("MES_ATUAL_PG"), 1)
                    End If
                    e.Row.Cells(10).BackColor = cor2

                    If IsDBNull(drow("M1A_PG")) Or drow("M1A_PG") = 0 Then
                        e.Row.Cells(11).Text = ""
                    Else
                        e.Row.Cells(11).Text = CNumero.FormataNumero(drow("M1A_PG"), 1)
                    End If
                    e.Row.Cells(11).BackColor = cor2

                    If IsDBNull(drow("M2A_PG")) Or drow("M2A_PG") = 0 Then
                        e.Row.Cells(12).Text = ""
                    Else
                        e.Row.Cells(12).Text = CNumero.FormataNumero(drow("M2A_PG"), 1)
                    End If
                    e.Row.Cells(12).BackColor = cor2

                    If IsDBNull(drow("M3A_PG")) Or drow("M3A_PG") = 0 Then
                        e.Row.Cells(13).Text = ""
                    Else
                        e.Row.Cells(13).Text = CNumero.FormataNumero(drow("M3A_PG"), 1)
                    End If
                    e.Row.Cells(13).BackColor = cor2

                    If IsDBNull(drow("M4A_PG")) Or drow("M4A_PG") = 0 Then
                        e.Row.Cells(14).Text = ""
                    Else
                        e.Row.Cells(14).Text = CNumero.FormataNumero(drow("M4A_PG"), 1)
                    End If
                    e.Row.Cells(14).BackColor = cor2

                    If IsDBNull(drow("M5A_PG")) Or drow("M5A_PG") = 0 Then
                        e.Row.Cells(15).Text = ""
                    Else
                        e.Row.Cells(15).Text = CNumero.FormataNumero(drow("M5A_PG"), 1)
                    End If
                    e.Row.Cells(15).BackColor = cor2
    ...
    Protected Sub GridView1_RowCreated(sender As Object, e As GridViewRowEventArgs)
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                tclCelula = New TableCell()
                tclCelula.Text = "Aprovadas / Recebidas"
                ...
                tclCelula = New TableCell()
                tclCelula.Text = "Pagas / Recebidas"
    ...
    Private Function GetData() As DataTable
        ...
        Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_COMERCIAL_PROPOSTA] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', 'V', '" & ddlRelatorio.SelectedValue & "'", "FechaComPropostasOp", strConn)
    ...
    Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If Not IsNothing(GridView1.HeaderRow) Then
                ...
                Dim filename As String = String.Format("FechaComPropostasOp_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                ...
                Using sw As New StringWriter()
                    ...
                    Select ddlRelatorio.SelectedValue
                        Case "1"
                            Response.Write("Data de Referencia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & txtData.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & "Análise Propostas - Veículos - Em Quantidade")
                        Case "2"
                            Response.Write("Data de Referencia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & txtData.Text & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & "Análise Propostas - Veículos - Em Valores")
                    End Select
