            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="(Efet.)" SortExpression="TX_AA">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="(Efet.)" SortExpression="TX_AM">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                   ...
                   <%-- <PagerTemplate>
                        ...
                        <asp:DropDownList ID="PagerPages" runat="server" AutoPostBack="true" Width="80px" CausesValidation="false" OnSelectedIndexChanged="PagerPages_SelectedIndexChanged" CssClass="navbar-btn" Style="z-index: 2000" />&nbsp;
