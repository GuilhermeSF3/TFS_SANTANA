...
Public Class FechaComClientes
    ...
    Public Function GetXaml1() As [String]
        ...
        myXaml = "<vc:Chart  xmlns:vc=""clr-namespace:Visifire.Charts;assembly=SLVisifire.Charts"" AnimatedUpdate=""True"" Width=""1200"" Height=""500"" Theme=""Theme1"" BorderBrush=""Gray"" IndicatorEnabled=""True""   ToolBarEnabled=""True""  >"
        myXaml = myXaml & "<vc:Chart.Titles>"

        myXaml = myXaml & "<vc:Title Text=""" & "Análise Maiores Clientes" & """/> "
