...
Public Class FechaComCreProducaoProdutos
    ...
    Protected Sub BindGraphData()
        ...
        Try
            Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
            Dim objData As DataTable = ClassBD.GetExibirGrid("scr_COMERCIAL_GRAFICO_PROD2 '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlProduto.SelectedValue & "'", "FechaComPropostasHis", strConn)
            ...
            For Each oDataRow As DataRow In objData.Rows
                ...
                If Not IsDBNull(oDataRow("m12")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""JAN""  YValue=""" & Replace((oDataRow("m12") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m11")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""FEV""  YValue=""" & Replace((oDataRow("m11") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m10")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""MAR""  YValue=""" & Replace((oDataRow("m10") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m9")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""ABR""  YValue=""" & Replace((oDataRow("m9") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m8")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""MAI""  YValue=""" & Replace((oDataRow("m8") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m7")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""JUN""  YValue=""" & Replace((oDataRow("m7") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m6")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""JUL""  YValue=""" & Replace((oDataRow("m6") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m5")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""AGO""  YValue=""" & Replace((oDataRow("m5") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m4")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""SET""  YValue=""" & Replace((oDataRow("m4") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m3")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""OUT""  YValue=""" & Replace((oDataRow("m3") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m2")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""NOV""  YValue=""" & Replace((oDataRow("m2") / 1.0), ",", ".") & """/> "
                End If
                If Not IsDBNull(oDataRow("m1")) Then
                    _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= ""DEZ""  YValue=""" & Replace((oDataRow("m1") / 1.0), ",", ".") & """/> "
                End If
    ...
    Public Function GetXaml1() As [String]
        ...
        Select Case ddlProduto.SelectedValue
            Case "T'"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - TOTAL" & """/> "
            Case "D'"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - Desconto" & """/> "
            Case "CG'"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - Capital Giro" & """/> "
            Case "V"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - Veiculo" & """/> "
            Case "R"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - Renegociacao" & """/> "
            Case "CP'"
                myXaml = myXaml & "<vc:Title Text=""" & "Análise de Produção Mensal - Credito Pessoal" & """/> "
        End Select
