            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    If IsDBNull(drow("PV")) Or drow("PV") = 0 Then
                        e.Row.Cells(9).Text = ""
                    Else
                        e.Row.Cells(9).Text = CNumero.FormataNumero(drow("PV"), 0)
                    End If
                    ...
                    If IsDBNull(drow("RECEITA")) Or drow("RECEITA") = 0 Then
                        e.Row.Cells(10).Text = ""
                    Else
                        e.Row.Cells(10).Text = CNumero.FormataNumero(drow("RECEITA"), 0)
                    End If
                    ...
                    If IsDBNull(drow("FV")) Or drow("FV") = 0 Then
                        e.Row.Cells(11).Text = ""
                    Else
                        e.Row.Cells(11).Text = CNumero.FormataNumero(drow("FV"), 0)
                    End If
                    ...
                    If IsDBNull(drow("LIBERADO")) Or drow("LIBERADO") = 0 Then
                        e.Row.Cells(12).Text = ""
                    Else
                        e.Row.Cells(12).Text = CNumero.FormataNumero(drow("LIBERADO"), 0)
                    End If
                    ...
                    If IsDBNull(drow("TC_TARIFA")) Or drow("TC_TARIFA") = 0 Then
                        e.Row.Cells(13).Text = ""
                    Else
                        e.Row.Cells(13).Text = CNumero.FormataNumero(drow("TC_TARIFA"), 0)
                    End If
                    ...
                    If IsDBNull(drow("IOF")) Or drow("IOF") = 0 Then
                        e.Row.Cells(14).Text = ""
                    Else
                        e.Row.Cells(14).Text = CNumero.FormataNumero(drow("IOF"), 0)
                    End If
