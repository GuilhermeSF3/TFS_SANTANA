...
Public Class FechaComPropostasHis
    ...
    Private Sub Carrega_Relatorio()
        ...
        Try
            ...
            ddlRelatorio.Items.Insert(0, New ListItem("Histórico Qtde", "3"))
            ddlRelatorio.Items.Insert(1, New ListItem("Histórico Valor", "4"))
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    ElseIf drow("COR_LINHA") = "A1" Then
                        cor1 = Drawing.ColorTranslator.FromOle(&HFFEAD6)
                        cor2 = Drawing.ColorTranslator.FromOle(&HEEBDBD)
                    Else
                        cor1 = e.Row.Cells(0).BackColor
                        cor2 = cor1
                    End If
                    ...
                    If IsDBNull(drow("MES_ATUAL_APR") Or drow("MES_ATUAL_APR") = 0) Then
                        e.Row.Cells(3).Text = ""
                    Else
                        e.Row.Cells(3).Text = CNumero.FormataNumero(drow("MES_ATUAL_APR"), 1)
                    End If
                    e.Row.Cells(3).BackColor = cor2

                    If IsDBNull(drow("Pagas") Or drow("Pagas") = 0) Then
                        e.Row.Cells(4).Text = ""
                    Else
                        e.Row.Cells(4).Text = CNumero.FormataNumero(drow("Pagas"), 0)
                    End If
                    ...
                    If IsDBNull(drow("M3A_APR")) Or drow("M3A_APR") = 0 Then
                        e.Row.Cells(5).Text = ""
                    Else
                        e.Row.Cells(5).Text = CNumero.FormataNumero(drow("M3A_APR"), 1)
                    End If
                    ...
                    If IsDBNull(drow("M4A_APR")) Or drow("M4A_APR") = 0 Then
                        e.Row.Cells(6).Text = ""
                    Else
                        e.Row.Cells(6).Text = CNumero.FormataNumero(drow("M4A_APR"), 2)
                    End If
    ...
    Private Function GetData() As DataTable
        ...
        Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_COMERCIAL_PROPOSTA_HIST] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', 'V', '" & ddlRelatorio.SelectedValue & "'", "FechaComPropostasHis", strConn)
    ...
    Protected Sub BindGraphData()
        ...
        Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
        Dim objData As DataTable = ClassBD.GetExibirGrid("SCR_COMERCIAL_PROPOSTA_GRAF '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', 'V', '" & ddlRelatorio.SelectedValue & "'", "FechaComPropostasHis", strConn)


        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries LegendText= ""Recebidas"" RenderAs=""Column"" MarkerType=""Circle"" SelectionEnabled=""True"" LineThickness=""3"">"
        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries.DataPoints> "

        For Each oDataRow As DataRow In objData.Rows
            If Not IsDBNull(oDataRow("Recebidas")) Then
                _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= """ & oDataRow("DESCR") & """  YValue=""" & Replace((oDataRow("Recebidas") / 1.0), ",", ".") & """/> "
            End If
        Next
        _hfDataSerie1 = _hfDataSerie1 & "</vc:DataSeries.DataPoints> "
        ...
        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries LegendText= ""Aprovadas"" RenderAs=""Column"" MarkerType=""Circle"" SelectionEnabled=""True"" LineThickness=""3"">"
        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries.DataPoints> "

        For Each oDataRow As DataRow In objData.Rows
            If Not IsDBNull(oDataRow("Aprovadas")) Then
                _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= """ & oDataRow("DESCR") & """  YValue=""" & Replace((oDataRow("Aprovadas") / 1.0), ",", ".") & """/> "
            End If
        Next
        _hfDataSerie1 = _hfDataSerie1 & "</vc:DataSeries.DataPoints> "
        _hfDataSerie1 = _hfDataSerie1 & "</vc:DataSeries> "
        ...
        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries LegendText= ""Pagas"" RenderAs=""Column"" MarkerType=""Circle"" SelectionEnabled=""True"" LineThickness=""3"">"
        _hfDataSerie1 = _hfDataSerie1 & "<vc:DataSeries.DataPoints> "

        For Each oDataRow As DataRow In objData.Rows
            If Not IsDBNull(oDataRow("Pagas")) Then
                _hfDataSerie1 = _hfDataSerie1 & "<vc:DataPoint  LabelEnabled=""True"" AxisXLabel= """ & oDataRow("DESCR") & """  YValue=""" & Replace((oDataRow("Pagas") / 1.0), ",", ".") & """/> "
            End If
        Next
        _hfDataSerie1 = _hfDataSerie1 & "</vc:DataSeries.DataPoints> "
        _hfDataSerie1 = _hfDataSerie1 & "</vc:DataSeries> "
    ...
    Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If Not IsNothing(GridView1.HeaderRow) Then
                ...
                Dim filename As String = String.Format("FechaComPropostasHis_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
    ...
    Public Function GetXaml1() As [String]
        ...
        myXaml = myXaml & "<vc:Title Text=""" & "Histório Analise de Propostas - Veículos" & """/> "
