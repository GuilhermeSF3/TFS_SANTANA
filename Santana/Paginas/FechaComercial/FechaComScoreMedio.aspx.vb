...
Public Class FechaComScoreMedio
    ...
    Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                cor = Drawing.ColorTranslator.FromOle(&HE8DEB7)
            ...
            'TODO: verificar valor de corte do Score para definição da cor
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    ElseIf drow("COR_LINHA") = "A1" Then
                        cor1 = Drawing.ColorTranslator.FromOle(&HF8F5E7)
                    Else
                        cor1 = e.Row.Cells(0).BackColor
                    End If

                    cor2 = Drawing.ColorTranslator.FromOle(&HE3E4F6)
                    cor3 = Drawing.ColorTranslator.FromOle(&HD7F5EC)
                    ...
                    If IsDBNull(drow("m3_qtd")) Or drow("m3_qtd") = 0 Then
                        e.Row.Cells(1).Text = ""
                    Else
                        e.Row.Cells(1).Text = CNumero.FormataNumero(drow("m3_qtd"), 0)
                    End If
                    e.Row.Cells(1).BackColor = cor1

                    If IsDBNull(drow("m3_vlr")) Or drow("m3_vlr") = 0 Then
                        e.Row.Cells(2).Text = ""
                    Else
                        e.Row.Cells(2).Text = CNumero.FormataNumero(drow("m3_vlr"), 0)
                    End If
                    e.Row.Cells(2).BackColor = cor1

                    If IsDBNull(drow("m3_score")) Or drow("m3_score") = 0 Then
                        e.Row.Cells(3).Text = ""
                    Else
                        e.Row.Cells(3).Text = CNumero.FormataNumero(drow("m3_score"), 0)
                    End If

                    If drow("COR_LINHA") = "A1" Then
                        e.Row.Cells(3).BackColor = cor1
                    Else
                        If CNumero.FormataNumero(drow("m3_score"), 0) < 550 Then
                            e.Row.Cells(3).BackColor = cor2
                            e.Row.Cells(3).ForeColor = Color.Red
                        Else
                            e.Row.Cells(3).BackColor = cor3
                    ...
                    If IsDBNull(drow("m2_qtd")) Or drow("m2_qtd") = 0 Then
                        e.Row.Cells(4).Text = ""
                    Else
                        e.Row.Cells(4).Text = CNumero.FormataNumero(drow("m2_qtd"), 0)
                    End If
                    e.Row.Cells(4).BackColor = cor1

                    If IsDBNull(drow("m2_vlr")) Or drow("m2_vlr") = 0 Then
                        e.Row.Cells(5).Text = ""
                    Else
                        e.Row.Cells(5).Text = CNumero.FormataNumero(drow("m2_vlr"), 0)
                    End If
                    e.Row.Cells(5).BackColor = cor1

                    If IsDBNull(drow("m2_score")) Or drow("m2_score") = 0 Then
                        e.Row.Cells(6).Text = ""
                    Else
                        e.Row.Cells(6).Text = CNumero.FormataNumero(drow("m2_score"), 0)
                    End If

                    If drow("COR_LINHA") = "A1" Then
                        e.Row.Cells(6).BackColor = cor1
                    Else
                        If CNumero.FormataNumero(drow("m2_score"), 0) < 550 Then
                            e.Row.Cells(6).BackColor = cor2
                            e.Row.Cells(6).ForeColor = Color.Red
                        Else
                            e.Row.Cells(6).BackColor = cor3
                    ...
                    If IsDBNull(drow("m1_qtd")) Or drow("m1_qtd") = 0 Then
                        e.Row.Cells(7).Text = ""
                    Else
                        e.Row.Cells(7).Text = CNumero.FormataNumero(drow("m1_qtd"), 0)
                    End If
                    e.Row.Cells(7).BackColor = cor1

                    If IsDBNull(drow("m1_vlr")) Or drow("m1_vlr") = 0 Then
                        e.Row.Cells(8).Text = ""
                    Else
                        e.Row.Cells(8).Text = CNumero.FormataNumero(drow("m1_vlr"), 0)
                    End If
                    e.Row.Cells(8).BackColor = cor1

                    If IsDBNull(drow("m1_score")) Or drow("m1_score") = 0 Then
                        e.Row.Cells(9).Text = ""
                    Else
                        e.Row.Cells(9).Text = CNumero.FormataNumero(drow("m1_score"), 0)
                    End If

                    If drow("COR_LINHA") = "A1" Then
                        e.Row.Cells(9).BackColor = cor1
                    Else
                        If CNumero.FormataNumero(drow("m1_score"), 0) < 550 Then
                            e.Row.Cells(9).BackColor = cor2
                            e.Row.Cells(9).ForeColor = Color.Red
                        Else
                            e.Row.Cells(9).BackColor = cor3
    ...
    Protected Sub GridView1_RowCreated(sender As Object, e As GridViewRowEventArgs)
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                tclCelula = New TableCell()
                tclCelula.Text = oData.NomeMesSigla + "/" + oData.Data.Year.ToString()
    ...
    Private Function GetData() As DataTable
        ...
        Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_COMERCIAL_SCORE] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "'", "FechaComScoreMedio", strConn)
    ...
    Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If Not IsNothing(GridView1.HeaderRow) Then
                ...
                Dim filename As String = String.Format("FechaComScoreMedio_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
