                                ...
                                <div style="margin: 5px">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDataSafra" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
      ...
      <%--  function pageLoad() {
        ...
        $(document).on("click", "[id$=btnCarregar]", function () {
            ...
            function OnSuccess_(reponse) {
               ...
               // legend(document.getElementById("dvLegend"), data);
