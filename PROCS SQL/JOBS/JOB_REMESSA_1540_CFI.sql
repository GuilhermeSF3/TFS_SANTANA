...
IF EXISTS (SELECT name FROM sysobjects 
         WHERE name = 'JOB_REMESSA_1540_CFI' AND type = 'P')
   DROP PROCEDURE [dbo].[JOB_REMESSA_1540_CFI]
GO   
CREATE PROCEDURE [DBO].[JOB_REMESSA_1540_CFI] AS                          

/*
drop index REMESSA_IND1 on AUX_REMESSA
CREATE INDEX REMESSA_IND1 ON AUX_REMESSA (O3CODORG, OPNROPER, OPDTBASE, OPCODORG6,DT_EMISSAO)
...
drop index REMESSA_IND1 on TB_REMESSA
CREATE INDEX REMESSA_IND1 ON TB_REMESSA (O3CODORG, OPNROPER, OPDTBASE, OPCODORG6,DT_EMISSAO)
...
'15:40', CONVERT(VARCHAR(10), GETDATE(), 121), '', 'CFI'
FROM 
...
WHERE P.EPDTHRFIM BETWEEN @DT_DE + '15:00:00' AND @DT_ATE + '15:39:00'
