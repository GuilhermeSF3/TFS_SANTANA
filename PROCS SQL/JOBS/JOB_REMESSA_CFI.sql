...
IF EXISTS (SELECT name FROM sysobjects 
         WHERE name = 'JOB_REMESSA_CFI' AND type = 'P')
   DROP PROCEDURE [dbo].[JOB_REMESSA_CFI]
GO   
CREATE PROCEDURE [DBO].[JOB_REMESSA_CFI] AS                          
...
SET @HR_ATE = CONVERT(CHAR(2),GETDATE(),114) + ':00:00'
SET @HR_DE = CONVERT(CHAR(2),DATEADD(HOUR,-1,GETDATE()),114) + ':00:00'
...
@HR_ATE, CONVERT(VARCHAR(10), GETDATE(), 121), '', 'CFI'
FROM 
