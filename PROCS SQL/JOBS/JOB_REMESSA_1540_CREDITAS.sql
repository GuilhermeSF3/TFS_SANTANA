...
IF EXISTS (SELECT name FROM sysobjects 
         WHERE name = 'JOB_REMESSA_1540_CREDITAS' AND type = 'P')
   DROP PROCEDURE [dbo].[JOB_REMESSA_1540_CREDITAS]
GO   
CREATE PROCEDURE [DBO].[JOB_REMESSA_1540_CREDITAS] AS                          
...
'15:40', CONVERT(VARCHAR(10), GETDATE(), 121), '', 'CREDITAS'
FROM 
