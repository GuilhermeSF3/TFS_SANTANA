...
IF EXISTS (SELECT name FROM sysobjects 
         WHERE name = 'JOB_REMESSA_09_CREDITAS' AND type = 'P')
   DROP PROCEDURE [dbo].[JOB_REMESSA_09_CREDITAS]
GO   
CREATE PROCEDURE [DBO].[JOB_REMESSA_09_CREDITAS] AS                          
...
'09:00:00', CONVERT(VARCHAR(10), GETDATE(), 121), '', 'CREDITAS'
FROM 
...
WHERE P.EPDTHRFIM BETWEEN @DT_DE + '15:40:00' AND @DT_ATE + '09:01:00'
