...
--				factor2	= convert(float,ROUND(( FACTOR1 * @CDI_CLI / 100.0  ) + 1.0, 16))
				factor2	= convert(float,ROUND(( ROUND( POWER( (ONTEM.TX_CDI/100.00000000 + 1.00000000), (1.00000000/252.00000000) ) -1.00000000   , 8)  * @CDI_CLI / 100.0000000000000000  ) + 1.0000000000000000, 16)),
--				AUX_FIN_OPER_PROJ.intermed_factor	= ROUND(AUX_FIN_OPER_PROJ.factor2,16,1)  -- TRUNCAR A 16 CASA

				AUX_FIN_OPER_PROJ.intermed_factor	= ROUND(ROUND(( ROUND( POWER( (ONTEM.TX_CDI/100.00000000 + 1.00000000), (1.00000000/252.00000000) ) -1.00000000   , 8)  * @CDI_CLI / 100.0000000000000000  ) + 1.0000000000000000, 16) ,16,1) , -- TRUNCAR A 16 CASA , 1o DIA CALCULAR SEM ONTEM
				AUX_FIN_OPER_PROJ.resultado			= ROUND(ROUND(( ROUND( POWER( (ONTEM.TX_CDI/100.00000000 + 1.00000000), (1.00000000/252.00000000) ) -1.00000000   , 8)  * @CDI_CLI / 100.0000000000000000  ) + 1.0000000000000000, 16) ,8)  -- arredondar A 8 CASA , 1o DIA CALCULAR SEM ONTEM
...
--				factor2	= convert(float,ROUND(( FACTOR1 * @CDI_CLI / 100.0  ) + 1.0, 16))
				factor2	= convert(float,ROUND(( ROUND( POWER( (ONTEM.TX_CDI/100.00000000 + 1.00000000), (1.00000000/252.00000000) ) -1.00000000   , 8)  * @CDI_CLI / 100.0000000000000000  ) + 1.0000000000000000, 16)),
--				AUX_FIN_OPER_PROJ.intermed_factor	= ROUND(AUX_FIN_OPER_PROJ.factor2,16,1)  -- TRUNCAR A 16 CASA
				AUX_FIN_OPER_PROJ.intermed_factor	= ROUND(ROUND(( ROUND( POWER( (ONTEM.TX_CDI/100.00000000 + 1.00000000), (1.00000000/252.00000000) ) -1.00000000   , 8)  * @CDI_CLI / 100.0000000000000000  ) + 1.0000000000000000, 16) * ONTEM.intermed_factor,16,1)  -- TRUNCAR A 16 CASA
/*			ANTERIOR
...
-- COM BAIXA PARCIAL, CONSIDERE ONTEM E ALTERADA CONTA FACTOR 2 * VLR ONTEM		APOS 10/7/17
			   ,AUX_FIN_OPER_PROJ.ATUALIZ_DIA	=  ROUND(ROUND(ROUND(AUX_FIN_OPER_PROJ.factor2,8) * ONTEM.VLR_DIA,2,1) - ONTEM.VLR_DIA , 2,1)   -- VLR DIA HJ - ONTEM--	AUX_FIN_OPER_PROJ.RESULTADO	= ROUND(AUX_FIN_OPER_PROJ.factor2*ontem.intermed_factor,8)   -- arred A 8 CASA
