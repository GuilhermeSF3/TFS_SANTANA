...
--  where LEFT(PAPEL_CODIGO,8)=LEFT(SERIE_OPERACAO,8) COLLATE DATABASE_DEFAULT
  where AUX_FIN_OPER.COD_OPERACAO= @COD_OP 
	AND	P.PAPEL_CODIGO=SERIE_OPERACAO COLLATE DATABASE_DEFAULT
	AND P.Data_operacao=@DataDe		-- DATA OPER
	AND P.INDICE_PERCENTUAL=@CDI_CLI  -- TX CLIENTE
...
-- exec [fin_operacao_proj] '2017-05-03','581', '5067', '2017-05-31',0.0
exec DBO.[Fin_operacao_proj] @DataDe,@CLIENTE, @COD_OP, @DataFECH , @vlr_CDI
