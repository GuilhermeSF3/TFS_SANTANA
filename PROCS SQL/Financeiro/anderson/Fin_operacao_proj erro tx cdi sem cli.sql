...
-- COM BAIXA PARCIAL, CONSIDERE ONTEM E ALTERADA CONTA FACTOR 2 * VLR ONTEM		APOS 10/7/17
			   ,AUX_FIN_OPER_PROJ.ATUALIZ_DIA	=  ROUND(ROUND(ROUND(AUX_FIN_OPER_PROJ.factor2,8) * ONTEM.VLR_DIA,2,1) - ONTEM.VLR_DIA , 2)   -- VLR DIA HJ - ONTEM--	AUX_FIN_OPER_PROJ.RESULTADO	= ROUND(AUX_FIN_OPER_PROJ.factor2*ontem.intermed_factor,8)   -- arred A 8 CASA
