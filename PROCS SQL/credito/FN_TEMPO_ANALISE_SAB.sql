...
-- ALTER 
--  create FUNCTION dbo.FN_TEMPO_ANALISE_SAB
-- 
ALTER FUNCTION dbo.FN_TEMPO_ANALISE_SAB
(
@DT_INI DATETIME,
@HR_INI VARCHAR(5),
@DT_FIN DATETIME,
    ...
    WHILE @DT_INI <= @DT_FIN
        BEGIN
			...
			END
				...
				-- ALTERADO OUT-15  SABADO  ************ ANALISTAS TRABALHAM 
				IF DATEPART(WEEKDAY, @DT_INI) IN (7)
				BEGIN
					--SET @DT_INI = DATEADD(DD, 2, @DT_INI)
					SET @HR8 = '08:30'		-- SAB 8:30
					SET @HRS = '13:00'		-- SAB ATEH 13H
					IF	@DT_INI = @DT_FIN
						SET @HRS = @HR_FIN
					SET @SOMA_TEMPO =  @SOMA_TEMPO +  DATEDIFF(N, @DT_INI + @HR_INI, @DT_INI + @HRS)
					SET @HR8 = '08:00'
				END
