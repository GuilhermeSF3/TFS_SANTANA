...
-- EXEC SCR_MAPA_PDV  '20160331',1 , '0'
...
END
-- *******************	SE 2017 DO NETFACTOR SISTEMA DE DESCONTO
ELSE
BEGIN
	-- SCR_MAPA_PDV_NETFACTOR (@DT_INI as datetime, @PRODUTO as int , @AGENTE AS VARCHAR(200))
	EXEC SCR_MAPA_PDV_NETFACTOR @DT_INI , @PRODUTO , @AGENTE 
END
END
GO