...
DATA_REF	RWA
2016-07-31 00:00:00.000	269371920

 SELECT DT_Fecha,COUNT(*) FROM DRE_ATRASO (NOLOCK)  GROUP BY DT_Fecha
*/

-- 2016  **************************************************************
use sig
INSERT RWA SELECT '20160831',269371920.0
...
/*
use sig
select * from rwa (nolock) order by data_ref
delete from rwa  where data_ref >='20150101'
delete from rwa  where data_ref ='20150831'
...
--  SELECT * FROM DRE_ATRASO (NOLOCK)   8M50S

-- JUN-15
-- USE SIG   DECLARE @DT DATETIME
...
USE SIG
 DECLARE @DT DATETIME
 EXEC DRE_RESULTADO_ANALITICO '20150731'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20150731'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20150731'
--  SELECT * FROM DRE_ATRASO (NOLOCK)

-- ago-15
-- USE SIG   DECLARE @DT DATETIME
 EXEC DRE_RESULTADO_ANALITICO '20150831'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20150831'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20150831'
--  SELECT * FROM DRE_ATRASO (NOLOCK)

 EXEC DRE_RESULTADO_ANALITICO '20150930'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20150930'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20150930'
...
-- RATEIO PELO CONTABIL
 ...
 EXEC DRE_RESULTADO_ANALITICO '20151231'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20151231'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20151231'

 EXEC DRE_RESULTADO_ANALITICO '20160131'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20160131'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20160131'


USE SIG
 EXEC [ger_base_contabil] '20160229'

 EXEC DRE_RESULTADO_ANALITICO '20160229'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20160229'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20160229'


EXEC [ger_base_contabil] '20150930'
 EXEC [ger_base_contabil] '20151031'

select * from GER_BASE_BALANCETE (nolock) where dt_fecha='20150930'
select * from GER_BASE_BALANCETE (nolock) where dt_fecha='20151031'

select * from dre_atraso (nolock) where dt_fecha='20150930'


USE SIG
-- EXEC [ger_base_contabil] '20160430'

 EXEC DRE_RESULTADO_ANALITICO '20160430'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO '20160430'
-- RATEIO PELO CONTABIL
 EXEC DRE_DESPESAS_ANALITICO '20160430'



USE SIG
 EXEC DRE_RESULTADO_ANALITICO		'20160531'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO	'20160531'
 EXEC DRE_DESPESAS_ANALITICO		'20160531'


USE SIG
 EXEC DRE_RESULTADO_ANALITICO		'20160731'
 EXEC DRE_FUNCAO_ATRASO_ANALITICO	'20160731'
 EXEC DRE_DESPESAS_ANALITICO		'20160731'

/*

select * from dre_atraso (nolock) where dt_fecha='20160731'

select MAX(dt_fecha) from dre_atraso (nolock)
