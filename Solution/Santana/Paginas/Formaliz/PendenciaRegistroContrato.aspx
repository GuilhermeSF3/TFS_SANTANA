<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciaRegistroContrato.aspx.vb" Inherits="Santana.Paginas.Formaliz.PendenciaRegistroContrato" Title="Registro Contrato" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Registro Contrato - Pendência</title>
</asp:Content>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>                                              
                        ...
                        <asp:TemplateField HeaderText="Contrato" SortExpression="NR_CONTRATO">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Proposta" SortExpression="NR_PROPOSTA">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Motivo(Pendência)" SortExpression="PENDENCIA">
                        ...
                        <asp:TemplateField HeaderText="Valor Liberado" SortExpression="VALOR_LIBERADO">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>     

                        <asp:TemplateField HeaderText="Data Pendência" SortExpression="DATA_PENDENCIA">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField> 
