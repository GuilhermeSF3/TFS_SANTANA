...
Namespace Paginas.Credito
    ...
    Public Class PassoEsteiraFormaliz
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_PASSO_ESTEIRA_FORMALIZ] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue &
                                          "', '" & ddlProduto.SelectedValue & "', '" & ddlAnalista.SelectedValue & "', '" & ddlSituacao.SelectedValue & "', '" & txtValorDe.Text & "', '" & txtValorAte.Text & "', '" & ddlReanalise.SelectedValue & "'", "TempoPassoEsteira", strConn)
        ...
        Protected Sub btnCarregar_Click(sender As Object, e As EventArgs)
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_PASSO_ESTEIRA_FORMALIZ_TOTAL '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", conexao)
        ...
        Private Sub Carrega_Analistas()
            ...
            Try
                ...
                "SELECT DISTINCT EPUSUARIO AS EPUSUARIO, EPUSUARIO AS NOME  FROM PROPWEBSMC..EPROP E (NOLOCK) INNER JOIN PROPWEBSMC..CPROP (NOLOCK) ON EPNRPROP = PPNRPROP " &
                    ...
                    "WHERE EPDTLNC BETWEEN '" & oDataDe.Data.ToString("yyyyMMdd") & "' AND '" & oDataAte.Data.ToString("yyyyMMdd") & "' AND PPCODPRD <> '000221' " &
                    "AND EPNRDECI IN ('600','603','107')  " &
                    "AND EPDTLNC = (SELECT MAX(E1.EPDTLNC) FROM PROPWEBSMC..EPROP E1 (NOLOCK) WHERE E1.EPNRPROP = E.EPNRPROP AND E.EPNRDECI IN ('600','603','107')) " &
