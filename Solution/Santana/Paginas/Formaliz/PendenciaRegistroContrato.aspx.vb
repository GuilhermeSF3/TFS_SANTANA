...
Namespace Paginas.Formaliz
    ...
    Public Class PendenciaRegistroContrato
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                Dim primeiroDiaMesCorrente As Date = Convert.ToDateTime("01/" + Now.Date.AddMonths(0).ToString("MM/yyyy"))
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("DATA_BASE")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("DATA_BASE")
                            e.Row.Cells(0).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("NR_CONTRATO")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("NR_CONTRATO")
                            e.Row.Cells(1).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("NR_PROPOSTA")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("NR_PROPOSTA")
                        ...
                        If IsDBNull(drow("CHASSI")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("CHASSI")
                        ...
                        If IsDBNull(drow("RENAVAM")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("RENAVAM")
                        ...
                        If IsDBNull(drow("VALOR_LIBERADO")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = CNumero.FormataNumero(drow("VALOR_LIBERADO"), 2)
                            e.Row.Cells(8).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("DATA_PENDENCIA")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("DATA_PENDENCIA")
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_REGISTRO_CONTRATO_PENDENCIA '" &
                                                oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                oDataAte.Data.ToString("yyyyMMdd") & "'", "SCR_REGISTRO_CONTRATO_PENDENCIA", strConn)
            Return table
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendênciaDeRegistroDeContrato_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pendência de Registro de Contrato - Data DE: " & txtDataDe.Text & " - Data ATÉ: " & txtDataAte.Text & " </p> ")
