...
Namespace Paginas.Formaliz
    ...
    Public Class PagtoCtaAgente
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("NOME_CLI")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("NOME_CLI")
                        End If
                        ...
                        If IsDBNull(drow("DCFAVNOME")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = drow("DCFAVNOME")
                        End If

                        If IsDBNull(drow("DCVALOR")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = CNumero.FormataNumero(drow("DCVALOR"), 2)
                        End If
                        ...
                        If IsDBNull(drow("ABUFLCPL")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = drow("ABUFLCPL")
                        End If

                        If IsDBNull(drow("EPDTLNC")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = drow("EPDTLNC")
                        End If

                        e.Row.Cells(12).Text = drow("EPHORALNC")
                        e.Row.Cells(13).Text = drow("OPNRPROP")
                        e.Row.Cells(14).Text = drow("COD_LOJA")
                        e.Row.Cells(15).Text = drow("LOJA")
                        e.Row.Cells(16).Text = drow("OPCODORG3")
                        e.Row.Cells(17).Text = drow("OPERADOR")
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_DCO_Prop_PG_Cta_AG_TTL '" &
                    oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "' ", conexao)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_DCO_Prop_PG_Cta_AG '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "' ", "SCR_CRV", strConn)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Verifica Pagamentos na Conta do AGENTE - Data DE: " & txtDataDe.Text & " Data Até: " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")

                        Response.Write("Qtde de CONTRATOS " & txtQteContratoRealizado.Text & " Total de PRODUÇÃO " & TxtVlr.Text & " </p> ")
