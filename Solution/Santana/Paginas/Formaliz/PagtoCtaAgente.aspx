<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PagtoCtaAgente.aspx.vb" Inherits="Santana.Paginas.Formaliz.PagtoCtaAgente" Title="Pagamento na Conta do Agente" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pagamento na Conta do Agente</title>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NOME DO CLIENTE" SortExpression="NOME_CLI">
                        ...
                        <asp:TemplateField HeaderText="UF LIC." SortExpression="ABUFLCPL">
                        ...
                        <asp:TemplateField HeaderText="COD LOJA" SortExpression="COD_LOJA">
                            <ItemStyle Width="6%" HorizontalAlign="Center" />
                        </asp:TemplateField>
