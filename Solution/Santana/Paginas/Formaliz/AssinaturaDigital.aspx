<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AssinaturaDigital.aspx.vb" Inherits="Santana.Paginas.Formaliz.AssinaturaDigital" Title="Assinatura Digital" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CÓD. OPERADOR" SortExpression="PPCODORG6">
