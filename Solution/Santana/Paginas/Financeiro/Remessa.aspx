<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Remessa.aspx.vb" Inherits="Santana.Paginas.Financeiro.Remessa" Title="Remessa" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:Button ID="btnCSV" runat="server" Text="Gerar Arquivo" class="btn btn-default navbar-btn" OnClick="btnCSV_Click"></asp:Button>
                                </div>
                            </li>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="COD.AGENTE" SortExpression="O3CODORG">
                        ...
                        <asp:TemplateField HeaderText="NOME DO CLIENTE" SortExpression="OPNOMEBNF">
                        ...
                        <asp:TemplateField HeaderText="COD OPERADOR" SortExpression="OPCODORG6">
                        ...
                        <asp:TemplateField HeaderText="HORA REMESSA" SortExpression="HORA_REMESSA">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DATA EMISSAO" SortExpression="DT_EMISSAO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nº REMESSA" SortExpression="NUM_REMESSA">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                    ...
                    <asp:GridView ID="GridView2" runat="server"
                        AutoGenerateColumns="false" GridLines="None" AllowSorting="false" Visible ="false"
                        AllowPaging="True" PageSize="30" OnPageIndexChanging="GridView2_PageIndexChanging"
                        OnRowCreated="GridView2_RowCreated" ShowFooter="true" OnDataBound="GridView2_DataBound">


                        <RowStyle Height="31px" />
                        <Columns>

                            <asp:TemplateField HeaderText="Código da Empresa" SortExpression="CODEMPRESA">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Data do lançamento" SortExpression="DTLANCTO">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Data do vencimento" SortExpression="DTVENCTO">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Competência" SortExpression="COMPET">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Conta bancária" SortExpression="CTABAN">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Forma de pagamento" SortExpression="FORMAPGTO">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Código do Histórico" SortExpression="CODHIST">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Complemento do Histórico" SortExpression="COMPLHIST">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Evento Contábil" SortExpression="EVECONT">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Centro de Custo" SortExpression="CENTROCUS">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Código do Cliente" SortExpression="CODCLI">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Debito/Credito" SortExpression="DEBCRED">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nota Fiscal" SortExpression="NOTA">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Codigo do Banco" SortExpression="CODBAN">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Agencia Destino" SortExpression="AGEDEST">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Dígito conta Destino" SortExpression="DIGDEST">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="conta Destino" SortExpression="CONDEST">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nome do Favorecido" SortExpression="NOMEFAV">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Modalidade" SortExpression="MODA">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Digito da Agencia" SortExpression="DIGAGE">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="CPF/CNPJ Favorecido" SortExpression="CGCFAV">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nome do banco" SortExpression="NOMEBAN">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Tipo da conta" SortExpression="TPCONTA">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Finalidade" SortExpression="FINALI">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Finalidade DOC" SortExpression="FINALIDOC">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Finalidade TED" SortExpression="FINALITED">
                                <ItemStyle Width="6%" HorizontalAlign="Right" />
                            </asp:TemplateField>
    ...
    <asp:HiddenField ID="hfGridView2SV" runat="server" OnValueChanged="hfGridView2SV_ValueChanged" />
    <asp:HiddenField ID="hfGridView2SH" runat="server" OnValueChanged="hfGridView2SH_ValueChanged" />
