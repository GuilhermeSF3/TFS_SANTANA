...
Namespace Paginas.Graficos
    ...
    Public Class P123Operador
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = ClassBD.GetExibirGrid("scr_vlr_AnaliseP123 '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "', null, 4", "GraficoMensal", strConn)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("P123Operador_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
