...
Public Class IndicePerformanceVR
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    e.Row.Cells(3).Text = If(drow("B_PERC") = 0.0, "", CNumero.FormataNumero(drow("B_PERC"), 2))
                    e.Row.Cells(3).Font.Bold = Bold

                    e.Row.Cells(4).Text = If(drow("C_PERC") = 0.0, "", CNumero.FormataNumero(drow("C_PERC"), 2))
                    e.Row.Cells(4).Font.Bold = Bold

                    e.Row.Cells(5).Text = If(drow("D_PERC") = 0.0, "", CNumero.FormataNumero(drow("D_PERC"), 2))
                    e.Row.Cells(5).Font.Bold = Bold

                    e.Row.Cells(6).Text = If(drow("E_PERC") = 0.0, "", CNumero.FormataNumero(drow("E_PERC"), 2))
    ...
    Private Function GetData() As DataTable
        ...
        Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
        Dim Table As DataTable = Util.ClassBD.GetExibirGrid("[scr_IP_COBRADORA] '" & Convert.ToDateTime(txtData.Text).ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue & "','" & ddlCobradora.SelectedValue & "'", "IndicePerformance", strConn)
    ...
    Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If Not IsNothing(GridView1.HeaderRow) Then
                ...
                Dim filename As String = String.Format("Indice_PerformanceVR_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
