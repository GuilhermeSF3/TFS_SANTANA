<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="SpreadCapitalDeGiro.aspx.vb" Inherits="Santana.SpreadCapitalDeGiro" Title="Spread Capital De Giro" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Spread Capital De Giro</title>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="TABELA" SortExpression="TABELA">
                            <ItemStyle Width="3%" HorizontalAlign="LEFT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome TABELA" SortExpression="TABELA_DESCR">
                            <ItemStyle Width="3%" HorizontalAlign="LEFT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Entrada" SortExpression="prc_Entrada">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vlr Entrada" SortExpression="VLR_ENTRADA">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Categoria Tabela" SortExpression="TABELA_CATEGORIA">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Agente Corban" SortExpression="COD_AGENTE_CORBAN">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Agente Corban" SortExpression="NOM_AGENTE_CORBAN">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Agente Atual" SortExpression="COD_AGENTE_ATUAL">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Agente Atual" SortExpression="NOM_AGENTE_ATUAL">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Alteração" SortExpression="DT_ALT_REPAC">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Base Original Reneg" SortExpression="DTBASE_RENEG_ORIGINAL">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Vlr. Liquido" SortExpression="VLR_LIQUIDO">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Ano Fipe" SortExpression="ANO_FIPE">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Fipe" SortExpression="VALOR_FIPE">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Renda Pro" SortExpression="RENDA_PRO">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Avalista" SortExpression="AVALISTA">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Segunda Garantia" SortExpression="SEGUNDA_GARANTIA">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Operador" SortExpression="NM_OPERADOR">
