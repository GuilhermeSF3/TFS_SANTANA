...
Namespace Paginas.Cadastro
    ...
    Public Class FaixaAnoSpread
        Inherits SantanaPage

        Dim objData As DbFaixaAnoSpread
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbFaixaAnoSpread().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                If txtNewDT_DE.Text.Trim() = "" Or
                    ...
                    txtNewATE.Text.Trim() = "" Or
                    txtNewORDEM.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbFaixaAnoSpread
            ...
            ElseIf e.CommandName.Equals("Delete") Then
                ...
                objData.ApagarRegistro(GridView1.DataKeys(index).Values(0).ToString(), GridView1.DataKeys(index).Values(2).ToString())
                FillDataInGrid()
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_FxAnoSpread_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
