...
Namespace Paginas.Cadastro
    ...
    Public Class SC_Risco
        Inherits SantanaPage

        Dim objData As DbScoreRisco
        ...
        Private Function GetData() As DataTable
            Return New DbScoreRisco().CarregarTodosRegistros()
        End Function
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewCOD.Text.Trim(),
                                                txtNewDescr.Text.Trim(), txtNewDe.Text.Trim(), txtNewAte.Text.Trim())
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtDe As TextBox
                txtDe = CType(GridView1.Rows(e.RowIndex).FindControl("txtDe"), TextBox)
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(GridView1.DataKeys(e.RowIndex).Values(0).ToString(), txtDescr.Text, txtDe.Text, txtAte.Text)
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Score_Risco_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
