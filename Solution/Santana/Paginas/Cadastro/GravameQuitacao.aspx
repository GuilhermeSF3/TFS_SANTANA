<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="GravameQuitacao.aspx.vb" Inherits="Santana.Paginas.Cadastro.GravameQuitacao" Title="Gravame Quitação" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gravame Quitação</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_GRAVAME"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_GRAVAME")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_GRAVAME")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Ocorrencia">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("DESCR_GRAVAME")%>' ID="txtDescr" Width="900px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("DESCR_GRAVAME")%>' ID="Label3" Width="900px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
