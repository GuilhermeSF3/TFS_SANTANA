...
Namespace Paginas.Cadastro
    ...
    Public Class MetaPDD
        Inherits SantanaPage

        Dim objData As DbMetaPDD
        ...
        Private Function GetData() As DataTable
            Return New DbMetaPDD().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Meta_PDD_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
