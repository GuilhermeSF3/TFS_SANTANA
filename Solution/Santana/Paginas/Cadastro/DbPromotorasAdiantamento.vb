...
Public Class DbPromotorasAdiantamento
    ...
    Public Sub InserirRegistro(ByVal DT_REF As DateTime,
        ...
        'Dim sql As String = "INSERT INTO TB_PROMOTORA_ADIANTAMENTO(DT_REF, COD_AGENTE, VLR) " &
        '                    "VALUES (@DT_REF, @COD_AGENTE, @VLR)"

        Dim sql As String = "INSERT INTO TB_PROMOTORA_ADIANTAMENTO(DT_REF, COD_AGENTE) " &
                            "VALUES (@DT_REF, @COD_AGENTE)"
    ...
    Public Sub AtualizarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "UPDATE TB_PROMOTORA_ADIANTAMENTO SET VLR=@VLR " &
    ...
    Public Sub ApagarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "DELETE FROM TB_PROMOTORA_ADIANTAMENTO Where DT_REF=@DT_REF AND COD_AGENTE=@COD_AGENTE"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT DT_REF, COD_AGENTE + ' - ' + O3DESCR AS COD_AGENTE, VLR FROM TB_PROMOTORA_ADIANTAMENTO (NOLOCK) " &
    ...
    Public Function CarregarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "select * from TB_PROMOTORA_ADIANTAMENTO (NOLOCK) WHERE DT_REF=@DT_REF AND COD_AGENTE=@COD_AGENTE"
