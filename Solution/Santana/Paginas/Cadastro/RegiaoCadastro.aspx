<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RegiaoCadastro.aspx.vb" Inherits="Santana.Paginas.Cadastro.RegiaoCadastro" Title="Cadastro Região" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_REGIAO"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_REGIAO")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_REGIAO")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Região">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewDescr" runat="server" Width="200px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("NOME_REGIAO")%>' ID="txtDescr" Width="200px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("NOME_REGIAO")%>' ID="Label3" Width="200px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
