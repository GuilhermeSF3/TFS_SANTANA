...
Public Class DbFaixaAnoSpread
    ...
    Public Sub AtualizarRegistro(ByVal DT_DE As DateTime,
                                 ByVal DESCR As String,
                                 ByVal DE As Integer,
                                 ByVal ATE As Integer,
                                 ByVal ORDEM As Integer)

        Dim sql As String = "UPDATE FX_ANO SET DESCR=@DESCR, ATE=@ATE, ORDEM=@ORDEM " &
        ...
        _cmd.Parameters.Add("@DT_DE", SqlDbType.SmallDateTime).Value = DT_DE.ToString("dd/MM/yyyy")
        _cmd.Parameters.Add("@DESCR", SqlDbType.VarChar, 30).Value = DESCR
        _cmd.Parameters.Add("@DE", SqlDbType.Int).Value = DE
        _cmd.Parameters.Add("@ATE", SqlDbType.Int).Value = ATE
        _cmd.Parameters.Add("@ORDEM", SqlDbType.Int).Value = ORDEM
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM FX_ANO ORDER BY DT_DE desc"
