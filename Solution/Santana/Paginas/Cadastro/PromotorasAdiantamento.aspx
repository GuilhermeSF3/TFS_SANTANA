<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PromotorasAdiantamento.aspx.vb" Inherits="Santana.Paginas.Cadastro.PromotorasAdiantamento" Title="Cadastro Promotoras - Adiantamento" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Promotoras - Adiantamento</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_REF,COD_AGENTE"
					...
					<Columns>
						<asp:TemplateField HeaderText="Data">
							<HeaderTemplate>
								<asp:Label ID="lblDATA_De" runat="server" Text="Data"></asp:Label>
						...
						<asp:TemplateField HeaderText="Promotora">
							<HeaderTemplate>
								<asp:Label runat="server" Text="Promotora"></asp:Label>
								<asp:DropDownList ID="cmbPromotora" runat="server" Width="250px">
								</asp:DropDownList>    
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:Label ID="lblPromotora" runat="server" Text='<%# Eval("COD_AGENTE")%>' Width="250px"></asp:Label>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("COD_AGENTE")%>' ID="lblPromotora" Width="250px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>


						<asp:TemplateField HeaderText="Vlr. Adiantamento" Visible="false">
							<HeaderTemplate>
							...
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("VLR")%>' ID="txtVLR_TC" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("VLR")%>' ID="lblVLR_TC" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
