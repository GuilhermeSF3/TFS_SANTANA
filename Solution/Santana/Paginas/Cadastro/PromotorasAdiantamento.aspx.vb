...
Namespace Paginas.Cadastro
    ...
    Public Class PromotorasAdiantamento
        Inherits SantanaPage

        Dim objData As DbPromotorasAdiantamento
        ...
        Private Function GetData() As DataTable
            Return New DbPromotorasAdiantamento().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim cmbPromotora As DropDownList
                cmbPromotora = CType(GridView1.HeaderRow.FindControl("cmbPromotora"), DropDownList)
                ...
                If txtNewDATA_De.Text.Trim() = "" Or
                    cmbPromotora.SelectedValue = "0" Then
                    'txtNewVLR_TC.Text.Trim() = "" 

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbPromotorasAdiantamento
                    Dim tdUser As DataTable = objData.CarregarRegistro(txtNewDATA_De.Text.Trim, cmbPromotora.SelectedValue)
        ...
        Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.Header Then
                    Dim cmbPromotora As DropDownList
                    cmbPromotora = CType(e.Row.FindControl("cmbPromotora"), DropDownList)
                    If Not cmbPromotora Is Nothing Then
                        objData = New DbPromotorasAdiantamento()
                        objData.CarregarPromotora(cmbPromotora)
                    End If
                End If
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("cmbPromotora"), DropDownList).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("cmbPromotora"), DropDownList).Visible = False
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        Dim lblPromotora As String
                        lblPromotora = CType(GridView1.Rows(e.RowIndex).FindControl("lblPromotora"), Label).Text.ToString
        ...
        Private Sub Carrega_Operadores()
            ...
            Try
                ...
                cmbPromotora.DataSource = ddlValues
                cmbPromotora.DataValueField = "OPER_ABV_NOM"
                cmbPromotora.DataTextField = "OPER_ABV_NOM"
                cmbPromotora.DataBind()

                cmbPromotora.Items.Insert(0, New ListItem("", "0"))
                cmbPromotora.SelectedIndex = 0
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Meta_Promotoras_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
