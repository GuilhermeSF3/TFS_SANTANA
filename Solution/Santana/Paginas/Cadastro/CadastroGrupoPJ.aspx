<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CadastroGrupoPJ.aspx.vb" Inherits="Santana.Paginas.Cadastro.CadastroGrupoPJ" Title="Cadastro De Grupos PJ" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro De Grupo PJ</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_CLIENTE, NOME_CLIENTE, COD_GRUPO"
                    ...
                    <Columns>                        
                        <asp:TemplateField HeaderText="Cliente">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewClie" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblCliente" runat="server" Text='<%# Eval("NOME_CLIENTE")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCliente" runat="server" Text='<%# Eval("NOME_CLIENTE")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Código do Grupo">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Código do Grupo"></asp:Label>
                                <asp:TextBox ID="txtNewGroup" runat="server" Width="250px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("COD_GRUPO")%>' ID="txtNewGroup" Width="250px" MaxLength="100"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("COD_GRUPO")%>' ID="Label1" Width="250px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
