...
Namespace Paginas.Cadastro
    ...
    Public Class MetaFormaliz
        Inherits SantanaPage

        Dim objData As DbMetaFormaliz
        ...
        Private Function GetData() As DataTable
            Return New DbMetaFormaliz().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewMeta_TC As TextBox
                txtNewMeta_TC = CType(GridView1.HeaderRow.FindControl("txtNewMeta_TC"), TextBox)
                ...
                Else
                    ...
                    objData = New DbMetaFormaliz
                    Dim tdUser As DataTable = objData.CarregarRegistro(txtNewDATA_De.Text.Trim)
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewDATA_De.Text,
                                                     Convert.ToDouble(txtNewMeta_TC.Text))
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewMeta_TC"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewMeta_TC"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtMeta_TC As TextBox
                txtMeta_TC = CType(GridView1.Rows(e.RowIndex).FindControl("txtMeta_TC"), TextBox)
                If txtMeta_TC.Text.Trim() = "" Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(lblDATA_De,
                                                  Convert.ToDouble(txtMeta_TC.Text))
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
                    End If
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Meta_Formaliz_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
