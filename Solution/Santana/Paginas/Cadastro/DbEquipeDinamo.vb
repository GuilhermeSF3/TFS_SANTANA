...
Public Class DbEquipeDinamo
    ...
    Public Sub InserirRegistro(ByVal codAgente As String,
        ...
        Dim sql As String = "INSERT INTO TB_EQUIPE_DINAMO(COD_AGENTE) " &
                            "VALUES (@codAgente)"
    ...
    Public Sub AtualizarRegistro(ByVal codAgente As String,
        ...
        Dim sql As String = "UPDATE TB_EQUIPE_DINAMO " &
    ...
    Public Sub ApagarRegistro(ByVal codAgente As String,
        ...
        Dim sql As String = "DELETE FROM TB_EQUIPE_DINAMO Where cod_agente = @codAgente"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        Dim sql As String = "SELECT COD_AGENTE + ' - ' + O3DESCR AS CODAGENTE, 'SÃO PAULO 'AS CODGERENCIA " &
                            "FROM TB_EQUIPE_DINAMO (NOLOCK) INNER JOIN CDCSANTANAMICROCREDITO..TORG3 (NOLOCK) ON COD_AGENTE = O3CODORG"
    ...
    Public Function CarregarRegistro(ByVal codAgente As String,
        ...
        Dim sql As String = "SELECT * FROM TB_EQUIPE_DINAMO (NOLOCK) WHERE cod_AGENTE=@codAgente"
