<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="EmpresaRegistro.aspx.vb" Inherits="Santana.Paginas.Cadastro.EmpresaRegistro" Title="Cadastro de Empresa de Registro" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de Empresa de Registro</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="UF,EMPRESA,VALOR"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="UF">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewcod_prod" runat="server" Width="250px" AutoPostBack="true" 
                                   OnSelectedIndexChanged="cmbNewcod_prod_OnSelectedIndexChanged">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblcod_prod" runat="server" Text='<%# Eval("UF")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblcod_prod" runat="server" Text='<%# Eval("UF")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Empresa">
                            <HeaderTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text="Empresa"></asp:Label>
                                <asp:DropDownList ID="cmbNewcod_modalidade" runat="server" Width="250px">
                                </asp:DropDownList>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text='<%# Eval("EMPRESA")%>' Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text='<%# Eval("EMPRESA")%>' Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Valor">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewcod_moda" runat="server" Width="150px" MaxLength="20"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox ID="txtcod_moda" runat="server" Text='<%#Eval("VALOR")%>' Width="150px" MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("VALOR")%>' ID="Label1" Width="150px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
