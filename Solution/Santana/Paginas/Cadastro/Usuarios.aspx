            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Login,Funcao,Ativo"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cód.Operador">                            
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Cód.Operador"></asp:Label>
                                <asp:TextBox ID="txtNewGerencia" runat="server" Width="150px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("CodGerente")%>' ID="txtGerencia" Width="150px" MaxLength="300"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("CodGerente")%>' ID="Label4" Width="150px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
