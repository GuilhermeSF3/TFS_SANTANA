...
Namespace Paginas.Cadastro
    ...
    Public Class OperadorAtendeCliente
        Inherits SantanaPage

        Dim objData As DbOperadorAtendeClente
        ...
        Private Function GetData() As DataTable
            Return New DbOperadorAtendeClente().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewDT_ATE As TextBox
                txtNewDT_ATE = CType(GridView1.HeaderRow.FindControl("txtNewDT_ATE"), TextBox)

                Dim ddlNewCOD_OPERADOR As DropDownList
                ddlNewCOD_OPERADOR = CType(GridView1.HeaderRow.FindControl("ddlNewCOD_OPERADOR"), DropDownList)


                If ddlNewCOD.SelectedValue().Trim() = "" Or
                    txtNewDATA_De.Text.Trim() = "0" Or
                    txtNewDT_ATE.Text.Trim() = "" Or
                    ddlNewCOD_OPERADOR.SelectedValue().Trim() = "" Then
                ...
                Else
                    ...
                    objData = New DbOperadorAtendeClente
                    Dim tdUser As DataTable = objData.CarregarRegistro(Convert.ToInt32(ddlNewCOD.SelectedValue.Trim()), Convert.ToDateTime(txtNewDATA_De.Text.Trim()), Convert.ToDateTime(txtNewDT_ATE.Text.Trim()), Convert.ToInt32(ddlNewCOD_OPERADOR.SelectedValue().Trim()))
                    If tdUser.Rows.Count > 0 Then
                        strMensagem = "O registro já esta cadastrado"
                    End If

                    If strMensagem = "" Then
                        objData.InserirRegistro(Convert.ToInt32(ddlNewCOD.SelectedValue().Trim()), Convert.ToDateTime(txtNewDATA_De.Text.Trim()), Convert.ToDateTime(txtNewDT_ATE.Text.Trim()), Convert.ToInt32(ddlNewCOD_OPERADOR.SelectedValue().Trim()))
        ...
        Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
            ...
            Try
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    Dim ddlCOD_OPERADOR As DropDownList
                    ddlCOD_OPERADOR = CType(e.Row.FindControl("ddlCOD_OPERADOR"), DropDownList)

                    If Not ddlCOD_OPERADOR Is Nothing Then
                        objData = New DbOperadorAtendeClente()
                        objData.CarregarOperador(ddlCOD_OPERADOR)
                        ddlCOD_OPERADOR.SelectedValue = GridView1.DataKeys(e.Row.RowIndex).Values(2)
                    End If
                ...
                If e.Row.RowType = DataControlRowType.Header Then
                    ...
                    Dim ddlNewCOD_OPERADOR As DropDownList
                    ddlNewCOD_OPERADOR = CType(e.Row.FindControl("ddlNewCOD_OPERADOR"), DropDownList)

                    If Not ddlNewCOD_OPERADOR Is Nothing Then
                        objData = New DbOperadorAtendeClente()
                        objData.CarregarOperador(ddlNewCOD_OPERADOR)
                    End If
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewDT_ATE"), TextBox).Visible = True
            CType(GridView1.HeaderRow.FindControl("ddlNewCOD_OPERADOR"), DropDownList).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewDT_ATE"), TextBox).Visible = False
            CType(GridView1.HeaderRow.FindControl("ddlNewCOD_OPERADOR"), DropDownList).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtDT_ATE As TextBox
                txtDT_ATE = CType(GridView1.Rows(e.RowIndex).FindControl("txtDT_ATE"), TextBox)

                Dim ddlCOD_OPERADOR As DropDownList
                ddlCOD_OPERADOR = CType(GridView1.Rows(e.RowIndex).FindControl("ddlCOD_OPERADOR"), DropDownList)



                If ddlCOD_OPERADOR.SelectedValue() = "0" Then
                    strMensagem = "Por favor, preencher todos os campos."
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        Dim lblCOD As Integer
                        lblCOD = Convert.ToInt32(CType(GridView1.Rows(e.RowIndex).FindControl("lblCOD"), Label).Text.Trim())



                        objData.AtualizarRegistro(lblCOD, Convert.ToDateTime(lblDT_DE.Text.Trim()), Convert.ToDateTime(txtDT_ATE.Text.Trim()), Convert.ToInt32(ddlCOD_OPERADOR.SelectedValue().Trim()))
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
                    End If
