<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ModalidadePJ.aspx.vb" Inherits="Santana.Paginas.Cadastro.Comissao_PJ.ModalidadePJ" Title="Modalidade PJ" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Modalidade PJ</title>
</asp:Content>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cod"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Cliente">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Código Modalidade"></asp:Label>
                                <asp:TextBox ID="txtNewCOD" runat="server" Width="150px" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("cod")%>' ID="txtcod"  Width="100px" MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="A partir de">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("DT_DE", "{0:dd/MM/yyyy}")%>' ID="txtDT_DE"  Width="200px" MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Descrição">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewDESCR" runat="server" Width="200px"  MaxLength="200"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%DESCR%>' ID="txtDESCR"  Width="200px" MaxLength="200"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%DESCR%>' ID="lblDESCR" Width="200px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
