<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Modalidade.aspx.vb" Inherits="Santana.Paginas.Cadastro.Modalidade" Title="Cadastro de Modalidade" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cod_prod,cod_modalidade,cod_moda"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cód TIPO">
                            <HeaderTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text="Cód TIPO"></asp:Label>
                                <asp:DropDownList ID="cmbNewcod_modalidade" runat="server" Width="250px">
                                </asp:DropDownList>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text='<%# Eval("cod_modalidade")%>' Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblcod_modalidade" runat="server" Text='<%# Eval("cod_modalidade")%>' Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Modalidade">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtcod_moda" runat="server" Text='<%#Eval("cod_moda")%>' Width="150px" MaxLength="20"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("cod_moda")%>' ID="Label1" Width="150px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
