<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaAgentes.aspx.vb" Inherits="Santana.Paginas.Cadastro.DeParaAgentes" Title="Cadastro de De/Para Agentes" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CODAGENTE, CODAGENTEATIVO"
                    ...
                    <Columns>                        
                        ...
                        <asp:TemplateField HeaderText="Agente Ativo">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Agente Ativo"></asp:Label>
                               <asp:DropDownList ID="cmbNewAGAtivo" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODAGENTEATIVO")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODAGENTEATIVO")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
