<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaRegiao.aspx.vb" Inherits="Santana.Paginas.Cadastro.DeParaRegiao" Title="Cadastro de De/Para Região" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de De/Para de Região</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_AGENTE, COD_REGIAO"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Agente">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("COD_AGENTE")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("COD_AGENTE")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Região">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewRegiao" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("COD_REGIAO")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("COD_REGIAO")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
