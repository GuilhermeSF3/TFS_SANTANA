<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaOperadoresInternos.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaOperadoresInternos" Title="Meta dos Operadores" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta dos Operadores</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_REF,COD_OPERADOR"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Operador">
							<HeaderTemplate>
								...
								<asp:DropDownList ID="cmbOperador" runat="server" Width="250px">
								</asp:DropDownList>    
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:Label ID="lblOperador" runat="server" Text='<%# Eval("COD_OPERADOR")%>' Width="250px"></asp:Label>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("COD_OPERADOR")%>' ID="lblOperador" Width="250px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
