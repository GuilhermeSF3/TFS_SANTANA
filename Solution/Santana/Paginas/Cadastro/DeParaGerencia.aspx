<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaGerencia.aspx.vb" Inherits="Santana.Paginas.Cadastro.DeParaGerencia" Title="Cadastro de De/Para Gerência" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de De/Para de Gerência</title>
</asp:Content>
