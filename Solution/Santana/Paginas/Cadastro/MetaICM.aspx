<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaICM.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaICM" Title="Meta ICM" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta ICM</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_REF,COD_COBRADORA"
					...
					<Columns>
						<asp:TemplateField HeaderText="Mês Ref.">
							<HeaderTemplate>
								<asp:Label ID="lblDATA_De" runat="server" Text="Mês Ref."></asp:Label>
								<asp:TextBox ID="txtNewDATA_De" runat="server" Width="100px" CssClass="clDate" MaxLength="10"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:Label ID="lblDATA_De" runat="server" Text='<%# Eval("DT_REF", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label ID="lblDATA_De" runat="server" Text='<%# Eval("DT_REF", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
							</ItemTemplate>
						...
						<asp:TemplateField HeaderText="Cobradora">
							<HeaderTemplate>
								...
								<asp:DropDownList ID="cmbCobradora" runat="server" Width="250px">
								</asp:DropDownList>    
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:Label ID="lblCobradora" runat="server" Text='<%# Eval("COD_COBRADORA")%>' Width="250px"></asp:Label>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("COD_COBRADORA")%>' ID="lblCobradora" Width="250px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Faixa">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewFaixa" runat="server" Width="100px">
                                    <asp:ListItem>2- 6 a 15</asp:ListItem>
                                    <asp:ListItem>3- 16 a 30</asp:ListItem>
                                    <asp:ListItem>4- 31 a 60</asp:ListItem>
                                    <asp:ListItem>5- 61 a 90</asp:ListItem>
                                    <asp:ListItem>6- 91 a 120</asp:ListItem>
                                    <asp:ListItem>7- 121 a 150</asp:ListItem>
                                    <asp:ListItem>8- 151 a 180</asp:ListItem>
                                    <asp:ListItem>9- 181 a 360</asp:ListItem>
                                    <asp:ListItem>99- >360</asp:ListItem>
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <%--<asp:DropDownList ID="cmbFaixa" runat="server" Width="100px">
                                    <asp:ListItem>2- 6 a 15</asp:ListItem>
                                    <asp:ListItem>3- 16 a 30</asp:ListItem>
                                    <asp:ListItem>4- 31 a 60</asp:ListItem>
                                    <asp:ListItem>5- 61 a 90</asp:ListItem>
                                ...
                                <asp:Label runat="server" Text='<%# Eval("FAIXA")%>' ID="cmbFaixa" Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("FAIXA")%>' ID="lblFaixa" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
						...
						<asp:TemplateField HeaderText="Meta">
							...
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("ICM")%>' ID="txtVLR_TC" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("ICM")%>' ID="lblVLR_TC" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
