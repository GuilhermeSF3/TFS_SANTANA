<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaOcorrenciasAR.aspx.vb" Inherits="Santana.Paginas.Cadastro.AR.DeParaOcorrenciasAR" Title="DE PARA - Retorno" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_RETORNO"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código Cartório">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_RETORNO")%>' Width="150px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_RETORNO")%>' Width="150px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Ocorrencia RETORNO">
                            <HeaderTemplate>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("OCORRENCIA_RET")%>' ID="txtOcorrencia" Width="100px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("OCORRENCIA_RET").ToString().Substring(0, Math.Min(Eval("OCORRENCIA_RET").ToString().Length, 300))%>' ID="Label3" Width="350px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
