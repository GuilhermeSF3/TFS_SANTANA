...
Namespace Paginas.Cadastro.AR
    ...
    Public Class NumeroCarta
        ...
        Private Function GetData() As DataTable
            Return New DbNumeroCarta().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(Convert.ToInt32(txtNewCOD.Text.Trim()), _
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Numero_Carta_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
