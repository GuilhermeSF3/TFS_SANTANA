<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Retorno.aspx.vb" Inherits="Santana.Paginas.Cadastro.AR.Retorno" Title="AR Retorno" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>AR Retorno</title>
</asp:Content>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewCod" runat="server" Width="100px" CssClass="allownumericwithoutdecimal" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Retorno">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Retorno"></asp:Label>
                                <asp:TextBox ID="txtNewDescr" runat="server" Width="500px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("DESCR")%>' ID="txtDescr" Width="500px"  MaxLength="300"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("DESCR").ToString().Substring(0, Math.Min(Eval("DESCR").ToString().Length, 300))%>' ID="Label3" Width="500px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
