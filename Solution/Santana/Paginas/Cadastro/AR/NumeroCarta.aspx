<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="NumeroCarta.aspx.vb" Inherits="Santana.Paginas.Cadastro.AR.NumeroCarta" Title="Número Carta" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Número Carta</title>
</asp:Content>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Número Carta">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Número Carta"></asp:Label>
