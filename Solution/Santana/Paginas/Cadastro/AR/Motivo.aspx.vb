...
Namespace Paginas.Cadastro.AR
    ...
    Public Class Motivo
        ...
        Private Function GetData() As DataTable
            Return New DbMotivo().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Motivo_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
