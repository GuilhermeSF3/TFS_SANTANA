<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Usu_Operador_SVC.aspx.vb" Inherits="Santana.Paginas.Cadastro.Usu_Operador_SVC" Title="Cadastro de Agentes Operadores nas Services" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de Agentes Operadores nas Services</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CodAGENTE, CodAgSVC, CodOperador"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AGENTE">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewAG" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CodAGENTE")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CodAGENTE")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Service">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewSvc" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CodAgSVC")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CodAgSVC")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Codigo Operador na Service">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Codigo Operador na Service"></asp:Label>
                                <asp:TextBox ID="txtNewOp" runat="server" Width="250px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("CodOperador")%>' ID="txtNewOp" Width="250px" MaxLength="100"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("CodOperador").ToString().Substring(0, Math.Min(Eval("CodOperador").ToString().Length, 100))%>' ID="Label1" Width="250px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
