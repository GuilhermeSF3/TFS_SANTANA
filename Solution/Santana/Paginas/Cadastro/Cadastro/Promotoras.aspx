<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Promotoras.aspx.vb" Inherits="Santana.Paginas.Cadastro.Promotoras" Title="Promotoras" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descrição Promotora" SortExpression="DESCRIÇÃO PROMOTORA">
                            <ItemStyle Width="8%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Rua" SortExpression="RUA">
                            <ItemStyle Width="30%" HorizontalAlign="Left"  />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Responsável" SortExpression="RESPONSÁVEL">
                            <ItemStyle Width="10%" HorizontalAlign="Left"  />
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Nome Agente" SortExpression="NOME AGENTE">
