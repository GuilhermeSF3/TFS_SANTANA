...
Namespace Paginas.Cadastro
    ...
    Public Class Produtos
                ...
                ElseIf e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("CÓDIGO PRODUTO")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("CÓDIGO PRODUTO")
                        End If

                        If IsDBNull(drow("DESCRIÇÃO PRODUTO")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("DESCRIÇÃO PRODUTO")
                        End If

                        If IsDBNull(drow("CARTEIRA")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("CARTEIRA")
                        End If

                        If IsDBNull(drow("MODALIDADE")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("MODALIDADE")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_PRODUTOS] '" & ddlRelatorio.SelectedValue & "'", "Produtos", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Produtos{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Select Case ddlRelatorio.SelectedValue
                            Case 1
                                Response.Write(String.Format("RELAÇÃO GERAL DE PRODUTOS"))
                            Case 2
                                Response.Write(String.Format("RELAÇÃO PRODUTOS ATIVOS"))
                            Case 3
                                Response.Write(String.Format("RELAÇÃO DE PRODUTOS INATIVOS"))
                        End Select
                        Response.Write("<p>")
