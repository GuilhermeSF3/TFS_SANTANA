...
Namespace Paginas.Cadastro
    ...
    Public Class Promotoras
                ...
                ElseIf e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("CÓDIGO PROMOTORA")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("CÓDIGO PROMOTORA")
                        End If

                        If IsDBNull(drow("NOME PROMOTORA")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("NOME PROMOTORA")
                        End If

                        If IsDBNull(drow("DESCRIÇÃO PROMOTORA")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("DESCRIÇÃO PROMOTORA")
                        End If

                        If IsDBNull(drow("RUA")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("RUA")
                        End If
                        ...
                        If IsDBNull(drow("CPF/CNPJ")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = drow("CPF/CNPJ")
                        End If

                        If IsDBNull(drow("RESPONSÁVEL")) Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = drow("RESPONSÁVEL")
                        End If

                        If IsDBNull(drow("ATIVA")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("ATIVA")
                        End If

                        If IsDBNull(drow("EMAIL")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("EMAIL")
                        End If
                        ...
                        If IsDBNull(drow("NOME AGENTE")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("NOME AGENTE")
                        End If
                    End If
                End If
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_PROMOTORAS] '" & ddlRelatorio.SelectedValue & "', '" & IIf(ddlAgente.SelectedValue <> "99", ddlAgente.SelectedValue.PadLeft(6, "0"), ddlAgente.SelectedValue) & "'", "Promotoras", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Promotoras_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Select Case ddlRelatorio.SelectedValue
                            Case 1
                                Response.Write(String.Format("RELAÇÃO GERAL DE PROMOTORAS"))
                            Case 2
                                Response.Write(String.Format("RELAÇÃO PROMOTORAS ATIVAS"))
                            Case 3
                                Response.Write(String.Format("RELAÇÃO DE PROMOTORAS INATIVAS"))
                        End Select
                        Response.Write("<p>")
