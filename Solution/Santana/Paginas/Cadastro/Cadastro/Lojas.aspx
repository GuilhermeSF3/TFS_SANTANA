<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Lojas.aspx.vb" Inherits="Santana.Paginas.Cadastro.Lojas" Title="Lojas" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código da Loja" SortExpression="CÓDIGO LOJA">
                            <ItemStyle Width="5%" HorizontalAlign="Center"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome da Loja" SortExpression="NOME LOJA">
                            <ItemStyle Width="20%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descrição da Loja" SortExpression="DESCRIÇÃO LOJA">
                            <ItemStyle Width="10%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Endereço" SortExpression="ENDEREÇO">
                        ...
                        <asp:TemplateField HeaderText="CPF/CNPJ" SortExpression="CPF/CNPJ">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Loja Ativa" SortExpression="LOJA ATIVA">
                            <ItemStyle Width="8%" HorizontalAlign="Left"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Data Desativação" SortExpression="DATA DESATIVAÇÃO">
                            <ItemStyle Width="8%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Data Ativação" SortExpression="DATA ATIVAÇÃO">
                            <ItemStyle Width="8%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Data Cadastro Loja" SortExpression="DATA CADASTRO LOJA">
                            <ItemStyle Width="8%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Código Agente" SortExpression="CÓDIGO AGENTE">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Descrição Agente" SortExpression="DESCRIÇÃO AGENTE">
                            <ItemStyle Width="10%" HorizontalAlign="Left"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Banco 1" SortExpression="BANCO 1">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Agência 1" SortExpression="AGENCIA 1">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Conta 1" SortExpression="CONTA 1">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Banco 2" SortExpression="BANCO 2">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Agência 2" SortExpression="AGENCIA 2">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Conta 2" SortExpression="CONTA 2">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>  
  
                        <asp:TemplateField HeaderText="Banco 3" SortExpression="BANCO 3">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Agência 3" SortExpression="AGENCIA 3">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>   

                        <asp:TemplateField HeaderText="Conta 3" SortExpression="CONTA 3">
                            <ItemStyle Width="5%" HorizontalAlign="Right"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="Usuário" SortExpression="USNOMEUSU">
                            <ItemStyle Width="8%" HorizontalAlign="Left"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="Produção (90d.)" SortExpression="VLROPCZ">
