<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Tabelas.aspx.vb" Inherits="Santana.Paginas.Cadastro.Tabelas" Title="Tabelas" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Código Tabela" SortExpression="CÓDIGO TABELA">
                            <ItemStyle Width="8%" HorizontalAlign="Center"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descrição Tabela" SortExpression="DESCRIÇÃO TABELA">
                            <ItemStyle Width="30%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Código Produto" SortExpression="CÓDIGO PRODUTO">
                            <ItemStyle Width="8%" HorizontalAlign="Center"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descrição Produto" SortExpression="DESCRIÇÃO PRODUTO">
                            <ItemStyle Width="30%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Início" SortExpression="DATA INÍCIO">
                            <ItemStyle Width="10%" HorizontalAlign="Right"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Fim" SortExpression="DATA FIM">
                            <ItemStyle Width="10%" HorizontalAlign="Right"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="Situação" SortExpression="SITUAÇÃO">
                            <ItemStyle Width="7%" HorizontalAlign="Left"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="Entrada Mínima" SortExpression="ENTRADA MINIMA">
                        ...
                        <asp:TemplateField HeaderText="Código da Ocupação" SortExpression="CÓDIGO DA OCUPAÇÃO">
                            <ItemStyle Width="10%" HorizontalAlign="Left"  />
                        </asp:TemplateField> 
                        
                        <asp:TemplateField HeaderText="Política Despesa" SortExpression="POLÍTICA DESPESA">
                            <ItemStyle Width="10%" HorizontalAlign="Right"  />
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Cadastro" SortExpression="CADASTRO">
                            <ItemStyle Width="7%" HorizontalAlign="Left"  />
                        </asp:TemplateField>                                                                                                  
