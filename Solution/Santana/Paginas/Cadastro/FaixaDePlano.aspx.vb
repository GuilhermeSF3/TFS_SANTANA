...
Namespace Paginas.Cadastro
    ...
    Public Class FaixaDePlano
        Inherits SantanaPage

        Dim objData As DbFaixasPlano
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbFaixasPlano().CarregarTodosRegistros()
            Try
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_FxPlano_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
