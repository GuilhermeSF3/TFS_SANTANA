<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaOperadoresFuncaoNF.aspx.vb" Inherits="Santana.Paginas.Cadastro.DeParaOperadoresFuncaoNF" Title="Cadastro de De/Para Agentes" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de De/Para de Agentes</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CODOPERFUNCAO, CODOPERNF"
                    ...
                    <Columns>                        
                        <asp:TemplateField HeaderText="Operador - FUNÇÃO">
                            <HeaderTemplate>
                               <asp:Label runat="server" Text="Operador - FUNÇÃO"></asp:Label>
                               <asp:DropDownList ID="cmbFuncao" runat="server" Width="250px">
                               </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CODOPERFUNCAO")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CODOPERFUNCAO")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Operador - NETFACTOR">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Operador - NETFACTOR"></asp:Label>
                               <asp:DropDownList ID="cmbNF" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODOPERNF")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODOPERNF")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
