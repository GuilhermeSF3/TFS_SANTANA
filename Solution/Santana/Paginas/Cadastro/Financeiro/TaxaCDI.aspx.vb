...
Namespace Paginas.Cadastro.Financeiro
    ...
    Public Class TaxaCDI
        Inherits SantanaPage

        Dim objData As DbTaxaCDI
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbTaxaCDI().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewPRC_CDI As TextBox
                txtNewPRC_CDI = CType(GridView1.HeaderRow.FindControl("txtNewPRC_CDI"), TextBox)

                Dim txtNewPRC_DIA As TextBox
                txtNewPRC_DIA = CType(GridView1.HeaderRow.FindControl("txtNewPRC_DIA"), TextBox)
                ...
                If txtNewDT_DE.Text.Trim() = "" Or txtNewPRC_CDI.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbTaxaCDI
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewDT_DE.Text.Trim(),
                                                txtNewPRC_CDI.Text.Trim())
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_CDI"), TextBox).Visible = True
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_DIA"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_CDI"), TextBox).Visible = False
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_DIA"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtPRC_CDI As TextBox
                txtPRC_CDI = CType(GridView1.Rows(e.RowIndex).FindControl("txtPRC_CDI"), TextBox)

                Dim txtPRC_DIA As TextBox
                txtPRC_DIA = CType(GridView1.Rows(e.RowIndex).FindControl("txtPRC_DIA"), TextBox)

                If txtPRC_CDI.Text.Trim() = ""  Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(GridView1.DataKeys(e.RowIndex).Values(0).ToString(), txtPRC_CDI.Text)
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Tx_CDI_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
