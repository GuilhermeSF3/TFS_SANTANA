...
Namespace Paginas.Cadastro.Financeiro


    Public Class Caixa
        Inherits SantanaPage

        Dim objData As DbCaixa
        ...
        Private Function GetData() As DataTable
            Return New DbCaixa().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim cmbEmpresa As DropDownList
                cmbEmpresa = CType(GridView1.HeaderRow.FindControl("cmbEmpresa"), DropDownList)
                ...
                Else
                    ...
                    objData = New DbCaixa
                    Dim tdUser As DataTable = objData.CarregarRegistro(txtNewDATA_De.Text.Trim, cmbEmpresa.SelectedValue)
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("cmbEmpresa"), DropDownList).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("cmbEmpresa"), DropDownList).Visible = False
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        Dim lblEmpresa As String
                        lblEmpresa = CType(GridView1.Rows(e.RowIndex).FindControl("lblEmpresa"), Label).Text.ToString
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Caixa_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
