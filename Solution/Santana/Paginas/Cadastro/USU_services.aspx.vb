...
Namespace Paginas.Cadastro
    ...
    Public Class Usu_services

        Inherits SantanaPage

        Dim objData As DbUsu_Services
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbUsu_Services().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                If txtNewCOD.Text.Trim() = "" Or txtNewSIGLA.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbUsu_Services
                    Dim tdData As DataTable = objData.CarregarRegistro(txtNewCOD.Text)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Services_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
