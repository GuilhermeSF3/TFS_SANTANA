<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaICMRepac.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaICMRepac" Title="Meta ICM - Microcrédito" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta ICM - Microcrédito</title>
</asp:Content>
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_REF,COD_COBRADORA"
					...
					<Columns>
                        ...
                        <asp:TemplateField HeaderText="Faixa">
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("FAIXA")%>' ID="label3" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
