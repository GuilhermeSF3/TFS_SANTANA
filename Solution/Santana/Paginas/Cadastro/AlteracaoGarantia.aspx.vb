...
Namespace Paginas.Cadastro
    ...
    Public Class AlteracaoGarantia
        Inherits SantanaPage

        Private Const HfGridView1Svid As String = "1399D405-7696-46C6-8FC6-2091DCE8A6F6"
        Private Const HfGridView1Shid As String = "D7177246-2FDD-477C-A27E-B94DEFD23EE4"

        Dim objAlteracaoGarantia As DbAlteracaoGarantia
        ...
        Protected Sub FillCustomerInGrid()
            ...
            Dim dtScore As DataTable = New DbAlteracaoGarantia().CarregarGarantia(txtProposta.Text, txtGarantia.Text)
            Try
                ...
                If dtScore.Rows.Count > 0 Then
                    ...
                    GridView1.DataBind()
                Else
                    dtScore.Rows.Add(dtScore.NewRow())
                    Me.GridView1.DataSource = dtScore
                    GridView1.DataBind()
                    ...
                    GridView1.Rows(0).Cells(0).Text = "Não foi localizado nenhum contrato/proposta."
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim lblGarantia As Label
                lblGarantia = CType(GridView1.Rows(e.RowIndex).FindControl("lblGarantia"), Label)

                Dim txtModelo As TextBox
                txtModelo = CType(GridView1.Rows(e.RowIndex).FindControl("txtModelo"), TextBox)

                Dim txtMarca As TextBox
                txtMarca = CType(GridView1.Rows(e.RowIndex).FindControl("txtMarca"), TextBox)

                Dim txtAnoMod As TextBox
                txtAnoMod = CType(GridView1.Rows(e.RowIndex).FindControl("txtAnoMod"), TextBox)

                Dim txtAnoFab As TextBox
                txtAnoFab = CType(GridView1.Rows(e.RowIndex).FindControl("txtAnoFab"), TextBox)

                Dim txtVlrMolicar As TextBox
                txtVlrMolicar = CType(GridView1.Rows(e.RowIndex).FindControl("txtVlrMolicar"), TextBox)

                Dim txtVlrVenda As TextBox
                txtVlrVenda = CType(GridView1.Rows(e.RowIndex).FindControl("txtVlrVenda"), TextBox)

                Dim txtVlrTabela As TextBox
                txtVlrTabela = CType(GridView1.Rows(e.RowIndex).FindControl("txtVlrTabela"), TextBox)

                Dim txtPlaca As TextBox
                txtPlaca = CType(GridView1.Rows(e.RowIndex).FindControl("txtPlaca"), TextBox)

                Dim txtRenavam As TextBox
                txtRenavam = CType(GridView1.Rows(e.RowIndex).FindControl("txtRenavam"), TextBox)

                If txtModelo.Text.Trim() = "" Or txtMarca.Text.Trim() = "" Or txtAnoMod.Text.Trim() = "" Or txtAnoFab.Text.Trim() = "" Or txtVlrMolicar.Text.Trim = "" Or txtVlrVenda.Text.Trim = "" Or txtVlrTabela.Text.Trim = "" Then
                    strMensagem = "Por favor, preencher todos os campos!"

                Else
                    objAlteracaoGarantia = New DbAlteracaoGarantia
                    Dim Proposta As String = lblProposta.Text
                    Dim Garantia As String = lblGarantia.Text


                    If strMensagem = "" Then
                        objAlteracaoGarantia.AtualizaGarantia(Proposta, Garantia, txtModelo.Text, txtMarca.Text, txtAnoMod.Text, txtAnoFab.Text, txtVlrMolicar.Text, txtVlrVenda.Text, txtVlrTabela.Text, txtPlaca.Text, txtRenavam.Text)
                        GridView1.EditIndex = -1
        ...
        Protected Sub btnCarregar_Click(sender As Object, e As EventArgs)
            If (txtProposta.Text.Trim = "" Or txtGarantia.Text.Trim = "") Then
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atenção!' ,'Obrigatório informar proposta e garantia!', 'danger');", True)
                txtProposta.Text = ""
                txtGarantia.Text = ""
            Else
                FillCustomerInGrid()
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("AlteracaoGarantia_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
