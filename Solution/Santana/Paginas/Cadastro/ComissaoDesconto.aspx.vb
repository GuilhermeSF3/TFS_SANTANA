...
Namespace Paginas.Cadastro
    ...
    Public Class ComissaoDesconto

        Inherits SantanaPage

        Dim objData As DbComissaoDesconto
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbComissaoDesconto().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtComissao As TextBox
                txtComissao = CType(GridView1.HeaderRow.FindControl("txtComissao"), TextBox)
                ...
                objData = New DbComissaoDesconto
                ...
                If strMensagem = "" Then
                    objData.InserirRegistro(txtDtRef.Text.ToString(), s_codOp, s_cpfOP, s_nomeOp, txtComissao.Text.ToString())
            ...
            ElseIf e.CommandName.Equals("Delete") Then
                ...
                Dim s_codOp As String = str_op(0)
                Dim s_nomeOp As String = str_op(1)
                Dim s_Comissao As String = GridView1.DataKeys(index).Values(2).ToString()

                objData.ApagarRegistro(GridView1.DataKeys(index).Values(0).ToString(), s_codOp, s_nomeOp, s_Comissao)
                FillDataInGrid()
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtComissao"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtComissao"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                If strMensagem = "" Then
                    ...
                    Dim lblComissao As TextBox
                    lblComissao = CType(GridView1.Rows(e.RowIndex).FindControl("lblComissao"), TextBox)
                    ...
                    objData.AtualizarRegistro(lblData.Text, s_CodOp.Trim, s_NomeOp.Trim, lblComissao.Text)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("CadastroComissao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
