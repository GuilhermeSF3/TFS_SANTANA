...
Namespace Paginas.Cadastro
    ...
    Public Class TaxCaptacao
        Inherits SantanaPage

        Dim objData As DbTaxaCaptacao
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbTaxaCaptacao().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewPRC_CAPTACAO As TextBox
                txtNewPRC_CAPTACAO = CType(GridView1.HeaderRow.FindControl("txtNewPRC_CAPTACAO"), TextBox)
                ...
                If txtNewDT_DE.Text.Trim() = "" Or
                    txtNewPRC_CAPTACAO.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbTaxaCaptacao
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_CAPTACAO"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewPRC_CAPTACAO"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtPRC_CAPTACAO As TextBox
                txtPRC_CAPTACAO = CType(GridView1.Rows(e.RowIndex).FindControl("txtPRC_CAPTACAO"), TextBox)


                If txtPRC_CAPTACAO.Text.Trim() = "" Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(GridView1.DataKeys(e.RowIndex).Values(0).ToString(), txtPRC_CAPTACAO.Text)
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_Tx_Captacao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
