<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaPromotoras.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaPromotoras" Title="Meta das promotoras" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta das promotoras</title>
</asp:Content>
