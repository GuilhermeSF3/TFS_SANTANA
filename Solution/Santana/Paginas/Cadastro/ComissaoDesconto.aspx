<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ComissaoDesconto.aspx.vb" Inherits="Santana.Paginas.Cadastro.ComissaoDesconto" Title="Cadastro Comissão" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="data_ref,Operador,Prc_Comissao"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="% Comissao">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="% Comissao"></asp:Label>
                               <asp:TextBox ID="txtComissao" runat="server" Width="100px">
                                </asp:TextBox>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:TextBox ID="lblComissao" runat="server" Text='<%# Eval("Prc_Comissao")%>'  Width="100px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblComissao" runat="server" Text='<%# Eval("Prc_Comissao")%>'  Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>  
