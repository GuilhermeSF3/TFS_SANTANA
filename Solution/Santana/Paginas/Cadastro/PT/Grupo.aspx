<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Grupo.aspx.vb" Inherits="Santana.Paginas.Cadastro.PT.Grupo" Title="Grupo" EnableEventValidation="false" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("codigo")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("codigo")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Grupo">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("grupo")%>' ID="txtDescr" Width="350px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("grupo").ToString().Substring(0, Math.Min(Eval("grupo").ToString().Length, 60))%>' ID="Label1" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Região">
                            <HeaderTemplate>
                                ...
                                <asp:DropDownList ID="cmbNewRegiao" runat="server" Width="250px"></asp:DropDownList>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("regiao").ToString().Substring(0, Math.Min(Eval("regiao").ToString().Length, 60))%>' ID="Label2" Width="350px"  ></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("regiao").ToString().Substring(0, Math.Min(Eval("regiao").ToString().Length, 60))%>' ID="Label3" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
