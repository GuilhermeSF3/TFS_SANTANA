...
Namespace Paginas.Cadastro.PT
    ...
    Public Class Grupo
        ...
        Private Function GetData() As DataTable
            Return New DbGrupo().CarregarTodosRegistros()
        End Function
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewCOD.Text.Trim(),
                                                txtNewDescr.Text.Trim(), cmbNewRegiao.SelectedValue.Trim())
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim cmbRegiao As DropDownList
                cmbRegiao = CType(GridView1.Rows(e.RowIndex).FindControl("cmbRegiao"), DropDownList)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                Dim filename As String = String.Format("Cadastro_Segmento_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
