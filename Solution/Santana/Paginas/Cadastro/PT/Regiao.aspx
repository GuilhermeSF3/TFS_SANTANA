<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Regiao.aspx.vb" Inherits="Santana.Paginas.Cadastro.PT.Regiao" Title="Região" EnableEventValidation="false" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewCod" runat="server" Width="100px" MaxLength="3"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Segmento">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Regiao"></asp:Label>
                                <asp:TextBox ID="txtNewDescr" runat="server" Width="350px" MaxLength="100"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("regiao")%>' ID="txtDescr" Width="350px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
