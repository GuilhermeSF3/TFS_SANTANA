...
Namespace Paginas.Cadastro.PT
    ...
    Public Class UF
        ...
        Private Function GetData() As DataTable
            Return New DbUF().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_UF_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
