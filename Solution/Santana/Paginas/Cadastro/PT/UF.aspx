<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="UF.aspx.vb" Inherits="Santana.Paginas.Cadastro.PT.UF" Title="UF" EnableEventValidation="false" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewCod" runat="server" Width="100px" MaxLength="2"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="UF">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("uf")%>' ID="txtDescr" Width="350px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("uf").ToString().Substring(0, Math.Min(Eval("uf").ToString().Length, 60))%>' ID="Label3" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
