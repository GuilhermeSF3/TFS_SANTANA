<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ContratosExcecao.aspx.vb" Inherits="Santana.Paginas.Cadastro.Protesto.ContratosExcecao" Title="Contrato Exceção" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Contrato Exceção</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CONTRATO"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Contrato">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewContrato" runat="server" Width="100px" MaxLength="20"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblContrato" runat="server" Text='<%# Eval("CONTRATO")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblContrato" runat="server" Text='<%# Eval("CONTRATO")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Observação">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewObs" runat="server" Width="350px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("OBS")%>' ID="txtObs" Width="350px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("OBS").ToString().Substring(0, Math.Min(Eval("OBS").ToString().Length, 60))%>' ID="Label3" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
