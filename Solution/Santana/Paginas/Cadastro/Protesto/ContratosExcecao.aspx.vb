...
Namespace Paginas.Cadastro.Protesto
    ...
    Public Class ContratosExcecao
        Inherits SantanaPage

        Dim objData As DbContratoExcecao
        ...
        Private Function GetData() As DataTable
            Return New DbContratoExcecao().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewContrato As TextBox
                txtNewContrato = CType(GridView1.HeaderRow.FindControl("txtNewContrato"), TextBox)

                Dim txtNewObs As TextBox
                txtNewObs = CType(GridView1.HeaderRow.FindControl("txtNewObs"), TextBox)


                If txtNewContrato.Text.Trim() = "" Or
                    txtNewObs.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher todos os campos."

                Else

                    objData = New DbContratoExcecao
                    Dim tdData As DataTable = objData.CarregarRegistro(txtNewContrato.Text.Trim())
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewContrato.Text.Trim(), _
                                                txtNewObs.Text.Trim())
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewContrato"), TextBox).Visible = True
            CType(GridView1.HeaderRow.FindControl("txtNewObs"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewContrato"), TextBox).Visible = False
            CType(GridView1.HeaderRow.FindControl("txtNewObs"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                txtObs = CType(GridView1.Rows(e.RowIndex).FindControl("txtObs"), TextBox)
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(GridView1.DataKeys(e.RowIndex).Values(0).ToString(), txtObs.Text)
                        GridView1.EditIndex = -1
                        FillDataInGrid()
                        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atualização' ,'Os dados foram salvos com sucesso.', 'success');", True)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("ContratosExcecao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
