<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="OcorrenciasCartorio.aspx.vb" Inherits="Santana.Paginas.Cadastro.Protesto.OcorrenciasCartorio" Title="Ocorrencias Cartório" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Ocorrencias Cartório</title>
</asp:Content>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewCod" runat="server" Width="100px" MaxLength="20"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Ocorrencia">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Ocorrencia"></asp:Label>
                                <asp:TextBox ID="txtNewDescr" runat="server" Width="900px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("OCORRENCIA")%>' ID="txtDescr" Width="900px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("OCORRENCIA")%>' ID="Label3" Width="900px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
