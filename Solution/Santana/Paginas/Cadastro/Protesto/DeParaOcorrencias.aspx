<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DeParaOcorrencias.aspx.vb" Inherits="Santana.Paginas.Cadastro.Protesto.DeParaOcorrencias" Title="Motivo de Devolução" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Motivo de Devolução</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_CART"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código Cartório">
                            <HeaderTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text="Código Cartório"></asp:Label>
                                <asp:TextBox ID="txtNewCod" runat="server" Width="150px" MaxLength="20"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_CART")%>' Width="150px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Eval("COD_CART")%>' Width="150px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Ocorrencia Cartório">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Ocorrencia Cartório"></asp:Label>
                                <asp:TextBox ID="txtNewOcorrencia" runat="server" Width="350px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("OCORRENCIA_CART")%>' ID="txtOcorrencia" Width="100px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("OCORRENCIA_CART").ToString().Substring(0, Math.Min(Eval("OCORRENCIA_CART").ToString().Length, 60))%>' ID="Label3" Width="350px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>


                        <asp:TemplateField HeaderText="Código Função">
                            <HeaderTemplate>
                                <asp:Label ID="lblCodigoFC" runat="server" Text="Código Função"></asp:Label>
                                <asp:TextBox ID="txtNewCodFC" runat="server" Width="150px" MaxLength="20"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("COD_FC")%>' ID="txtCodFC" Width="150px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblCodigoFC" runat="server" Text='<%# Eval("COD_FC")%>' Width="150px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                                                                                                                                           
                        <asp:TemplateField HeaderText="Ocorrencia Função">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Ocorrencia Função"></asp:Label>
                                <asp:TextBox ID="txtNewOcorrenciaFC" runat="server" Width="350px" MaxLength="300"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("OCORRENCIA_FC")%>' ID="txtOcorrenciaFC" Width="350px"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("OCORRENCIA_FC").ToString().Substring(0, Math.Min(Eval("OCORRENCIA_FC").ToString().Length, 60))%>' ID="Label4" Width="350px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
