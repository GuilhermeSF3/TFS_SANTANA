...
Namespace Paginas.Cadastro
    ...
    Public Class Score
        ...
        Protected Sub FillCustomerInGrid()
            ...
            Dim dtScore As DataTable = New DbScore().CarregarScore(txtContrato.Text, txtProposta.Text)
            Try
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                txtScore = CType(GridView1.Rows(e.RowIndex).FindControl("txtScore"), TextBox)

                If txtScore.Text.Trim() = "" Then

                    strMensagem = "Por favor, preencher Score."

                Else
                    objScore = New DbScore
                    Dim Contrato As String = lblContrato.Text


                    If strMensagem = "" Then
                        If (txtProposta.Text.Trim = "") Then
                            objScore.AtualizaScore(Contrato, "", txtScore.Text)
                            GridView1.EditIndex = -1
                            ...
                            FillCustomerInGrid()
                        ElseIf (txtContrato.Text.Trim = "") Then
                            objScore.AtualizaScore("", Contrato, txtScore.Text)
                            GridView1.EditIndex = -1
        ...
        Protected Sub btnCarregar_Click(sender As Object, e As EventArgs)
            If (txtContrato.Text.Trim <> "" And txtProposta.Text.Trim <> "") Then
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Atenção!' ,'Informar apenas contrato OU proposta!', 'danger');", True)
                txtContrato.Text = ""
                txtProposta.Text = ""
            Else
                FillCustomerInGrid()
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Ajuste_Score_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
