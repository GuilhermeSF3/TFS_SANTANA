...
Namespace Paginas.Cadastro
    ...
    Public Class MetaOperadoresInternos
        Inherits SantanaPage

        Dim objData As DbMetaOperadoresInternos
        ...
        Private Function GetData() As DataTable
            Return New DbMetaOperadoresInternos().CarregarTodosRegistros()
        End Function
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Else
                    ...
                    objData = New DbMetaOperadoresInternos
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Meta_Operadores_Interno_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
