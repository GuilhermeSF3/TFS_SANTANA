<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PesoIp.aspx.vb" Inherits="Santana.Paginas.Cadastro.PesoIp" Title="Cadastro de Peso IP" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de Peso IP</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   DataKeyNames="DATA_REF,rating,FAIXA"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Data Ref">
                            <HeaderTemplate>
                                <asp:Label ID="lblDATA_REF" runat="server" Text="Data Ref"></asp:Label>
                                <asp:TextBox ID="txtNewDATA_REF" runat="server" Width="100px" CssClass="clDate" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblDATA_REF" runat="server" Text='<%# Eval("DATA_REF", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblDATA_REF" runat="server" Text='<%# Eval("DATA_REF", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Rating">
                            <HeaderTemplate>
                                ...
                                <asp:DropDownList ID="cmbNewRATING" runat="server" Width="100px">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblRATING" runat="server" Text='<%# Eval("RATING")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("RATING")%>' ID="Label1" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Faixa">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Faixa"></asp:Label>
                                <asp:DropDownList ID="cmbNewFAIXA" runat="server" Width="100px">
                                    <asp:ListItem>16 a 30</asp:ListItem>
                                    <asp:ListItem>31 a 60</asp:ListItem>
                                    <asp:ListItem>61 a 90</asp:ListItem>
                                    <asp:ListItem>91 a 120</asp:ListItem>
                                    <asp:ListItem>121 a 150</asp:ListItem>
                                    <asp:ListItem>151 a 180</asp:ListItem>
                                    <asp:ListItem>181 a 359</asp:ListItem>
                                </asp:DropDownList>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblFAIXA" runat="server" Text='<%# Eval("FAIXA")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("FAIXA")%>' ID="Label2" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Peso">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewPESO" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="10"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("PESO")%>' ID="txtPESO" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PESO")%>' ID="Label3" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
