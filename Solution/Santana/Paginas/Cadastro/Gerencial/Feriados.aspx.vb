...
Namespace Paginas.Cadastro.Gerencial
    ...
    Public Class Feriados
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbFeriados().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        objData.InserirRegistro(txtNewDT_DE.Text, txtNewDESCR.Text)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Feriados_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
