...
Public Class DbContaCalculo
    ...
    Public Sub AtualizarRegistro(ByVal COD_CONTA As String, _
        ...
        Dim sql As String = "UPDATE GER_CONTA_CALCULO SET SINAL=@SINAL, CONTA_CAMPO=@CONTA_CAMPO " &
                            "WHERE COD_CONTA=@COD_CONTA AND " &
    ...
    Public Function CarregarTodosRegistros(ByVal COD_CONTA As String) As DataTable
        ...
        Dim sql As String = "SELECT G.*,C.nume_cont_fmtd  as conta_format,C.nome_cont FROM GER_CONTA_CALCULO G (NOLOCK) " &
                            "JOIN (select nume_cont_fmtd,nome_cont,nume_cont from [SRV-AWS].ZAP_CNT_P.dbo.PLANO_CONTABIL (nolock) ) AS C " &
    ...
    Public Sub CarregarContaCalculo(ByVal CONTA_CAMPO As String, ByVal ddlContaCalculo As DropDownList)
        ...
        Dim sql As String = "SELECT nume_cont,(nume_cont_fmtd+ ' - '+ nome_cont) as descricao from [SRV-AWS].ZAP_CNT_P.dbo.PLANO_CONTABIL with (nolock) " &
