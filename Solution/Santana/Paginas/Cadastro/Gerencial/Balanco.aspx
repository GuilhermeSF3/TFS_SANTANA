<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Balanco.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.Balanco" Title="Balanco" EnableEventValidation="false" %>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p id="ddlRelatorioslabel" class="navbar-text" style="float: none; margin: auto">Relatório: </p>
                                    </div>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cod. Conta" SortExpression="cod_conta_at">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Descrição" SortExpression="DESCR_at">
                            <ItemStyle Width="25%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Vlr. Ativo" SortExpression="vlr_Ativo">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Cod. Conta" SortExpression="cod_conta_pas">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Descrição" SortExpression="DESCR_pas">
                            <ItemStyle Width="25%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Vlr. Passivo" SortExpression="vlr_passivo">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
