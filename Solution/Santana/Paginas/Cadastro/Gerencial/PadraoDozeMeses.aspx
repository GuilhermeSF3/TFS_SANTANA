<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PadraoDozeMeses.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.PadraoDozeMeses" Title="Padrao 12 Meses" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Title" ContentPlaceHolderID="head" runat="Server">
    <title>Padrão 12 Meses</title>
</asp:Content>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Mes Ref" SortExpression="m1">
