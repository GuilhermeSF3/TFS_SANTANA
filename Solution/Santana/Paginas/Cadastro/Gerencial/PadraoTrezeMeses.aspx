<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PadraoTrezeMeses.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.PadraoTrezeMeses" Title="Padrao 13 Meses" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Title" ContentPlaceHolderID="head" runat="Server">
    <title>Padrão 13 Meses</title>
</asp:Content>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0">Data de Referência</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p id="ddlRelatorioslabel" class="navbar-text" style="float: none; margin: auto">Relatórios</p>
                                    </div>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:Button ID="btnProcessar" runat="server" Text="Processar" class="btn btn-primary navbar-btn" OnClick="btnProcessar_Click"></asp:Button>
                                    <asp:Button ID="btnRelatorio" runat="server" Text="Processar 13m" class="btn btn-primary navbar-btn" OnClick="btnProcessar13_Click"></asp:Button>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnDataBound="GridView1_DataBound" DataKeyNames="COD_EMPRESA,ordem">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cod. Empresa" SortExpression="COD_EMPRESA">
                        ...
                        <asp:TemplateField HeaderText="Cod. Conta" SortExpression="CODCONTA">
