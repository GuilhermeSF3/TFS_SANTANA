<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Feriados.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.Feriados" Title="Cadastro de Feriados" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                    ...
                    OnRowDeleting="GridView1_RowDeleting" OnRowCreated="GridView1_RowCreated" DataKeyNames="DT_FERI,DESCR_FERI"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="A partir de">
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblDT_DE" runat="server" Text='<%#Eval("DT_FERI", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblDT_DE" runat="server" Text='<%#Eval("DT_FERI", "{0:dd/MM/yyyy}")%>' Width="100px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Descrição">                            
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewDESCR" runat="server" Width="200px" MaxLength="30"></asp:TextBox>
                            </HeaderTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDESCR" runat="server" Text='<%#Eval("DESCR_FERI")%>' Width="200px" MaxLength="30"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%#Eval("DESCR_FERI")%>' ID="Label2" Width="200px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
