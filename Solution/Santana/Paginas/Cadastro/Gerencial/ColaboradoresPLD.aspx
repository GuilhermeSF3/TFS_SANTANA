<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ColaboradoresPLD.aspx.vb" Inherits="Santana.Paginas.Cadastro.Gerencial.ColaboradoresPLD" Title="Colaboradores - PLD" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Colaboradores - PLD</title>
</asp:Content>
