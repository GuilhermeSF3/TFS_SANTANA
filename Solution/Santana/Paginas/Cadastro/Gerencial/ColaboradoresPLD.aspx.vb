...
Namespace Paginas.Cadastro.Gerencial
    ...
    Public Class ColaboradoresPLD
        ...
        Private Function GetData1() As DataTable
            ...
            Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
            Dim table As DataTable = Util.ClassBD.GetExibirGrid("SCR_COLABORADORES_CONSULTA '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & "'", "COLAB_PLD", strConn)
