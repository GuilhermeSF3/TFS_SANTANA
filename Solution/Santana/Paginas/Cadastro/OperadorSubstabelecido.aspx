<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="OperadorSubstabelecido.aspx.vb" Inherits="Santana.Paginas.Cadastro.OperadorSubstabelecido" Title="Cadastro Operador Substabelecido" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro Operador Substabelecido</title>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CODOPERADOR"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Agente">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewOperador" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CODOPERADOR")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblAG" runat="server" Text='<%# Eval("CODOPERADOR")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
