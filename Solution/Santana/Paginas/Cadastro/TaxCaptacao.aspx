<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="TaxCaptacao.aspx.vb" Inherits="Santana.Paginas.Cadastro.TaxCaptacao" Title="Cadastro de Taxa de Captação" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cadastro de Taxa de Captação</title>
</asp:Content>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="DT_DE"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tx. Captação">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Tx. Captação"></asp:Label>
                                <asp:TextBox ID="txtNewPRC_CAPTACAO" runat="server" Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPRC_CAPTACAO" runat="server" Text='<%# Eval("PRC_CAPTACAO")%>'  Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PRC_CAPTACAO")%>' ID="Label3" Width="100px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
