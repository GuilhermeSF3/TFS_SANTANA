<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CadastroEquipe.aspx.vb" Inherits="Santana.Paginas.Cadastro.CadastroEquipe" Title="Cadastro Equipe" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CODAGENTE, CODEQUIPE, CODGERENCIA"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Equipe">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Equipe"></asp:Label>
                               <asp:DropDownList ID="cmbNewEquipe" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblEquipe" runat="server" Text='<%# Eval("CODEQUIPE")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblEquipe" runat="server" Text='<%# Eval("CODEQUIPE")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Gerência" Visible="false">
                            <HeaderTemplate>
                                <asp:Label runat="server" Text="Gerência"></asp:Label>
                               <asp:DropDownList ID="cmbNewGerencia" runat="server" Width="250px">
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODGERENCIA")%>'  Width="250px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSvc" runat="server" Text='<%# Eval("CODGERENCIA")%>'  Width="250px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="" ShowHeader="False">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Edit" CssClass="btn btn-primary" Text="Editar" Visible ="False"></asp:LinkButton>
                            </ItemTemplate>
                            <EditItemTemplate>
