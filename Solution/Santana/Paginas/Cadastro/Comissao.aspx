<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Comissao.aspx.vb" Inherits="Santana.Paginas.Cadastro.Comissao" Title="Cadastro de Comissão" EnableEventValidation="false" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="% Comissão">
                            <HeaderTemplate>
                                ...
                                <asp:TextBox ID="txtNewPRC_COMISSAO" runat="server" Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </HeaderTemplate>                             
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPRC_COMISSAO" runat="server" Text='<%# Eval("PRC_COMISSAO")%>'  Width="100px" MaxLength ="10" CssClass="allownumericwithdecimal"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PRC_COMISSAO")%>' ID="Label3" Width="100px"  ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
