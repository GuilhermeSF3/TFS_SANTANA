<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Score.aspx.vb" Inherits="Santana.Paginas.Cadastro.Score" Title="Score" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="OPER_PROP, PPSCORING"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Contrato/Proposta">
                            <EditItemTemplate>
                                <asp:Label ID="lblContrato" runat="server" Text='<%# Eval("OPER_PROP")%>' Width="50px"></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblContrato" runat="server" Text='<%# Eval("OPER_PROP")%>' Width="50px"></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Score">
                            <ItemStyle Width="7%" />                      
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("PPSCORING")%>' ID="txtScore" Width="50px" MaxLength="50"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("PPSCORING")%>' ID="lblScore" Width="50px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
