...
Public Class DbRisco
    ...
    Public Sub InserirRegistro(ByVal dataref As String, ByVal codop As String, ByVal cpfop As String, ByVal op As String, ByVal risco As String, ByVal vlr_risco As String)

        Dim sql As String = "INSERT INTO TBL_RISCO_DESCONTO(DATA_REF, COD_OPERADOR, CPF_OPERADOR, OPERADOR, PRC_RISCO,VLR_RISCO) " &
                            "VALUES (@data_ref, @cod_op, @cpf_op, @op, @risco, @vlr_risco)"
        ...
        _cmd.Parameters.Add("@risco", SqlDbType.Float, 20).Value = risco.Trim
        _cmd.Parameters.Add("@vlr_risco", SqlDbType.Float, 20).Value = vlr_risco.Trim
    ...
    Public Sub AtualizarRegistro(ByVal dataref As String, ByVal codop As String, ByVal op As String, ByVal risco As String, ByVal vlr_risco As String)

        Dim sql As String = "UPDATE TBL_RISCO_DESCONTO SET  prc_risco=@risco, vlr_risco=@vlr_risco " &
        ...
        _cmd.Parameters.Add("@risco", SqlDbType.Float, 50).Value = risco.Trim
        _cmd.Parameters.Add("@vlr_risco", SqlDbType.Float, 50).Value = vlr_risco.Trim
    ...
    Public Sub ApagarRegistro(ByVal dataref As DateTime, ByVal codop As String, ByVal op As String, ByVal risco As String, ByVal vlr_risco As String)


        Dim sql As String = "DELETE FROM TBL_RISCO_DESCONTO Where data_ref=@data_ref AND cod_operador=@cod_op and operador = @op and prc_risco = @risco and vlr_risco = @vlr_risco"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT CONVERT(CHAR,DATA_REF,103) AS DATA_REF, COD_OPERADOR, CPF_OPERADOR, CAST(COD_OPERADOR AS VARCHAR(20)) + ' - ' + OPERADOR AS OPERADOR, PRC_RISCO, VLR_RISCO FROM TBL_RISCO_DESCONTO (NOLOCK)"
    ...
    Public Function CarregarRegistro(ByVal dataref As String, ByVal codOp As String, ByVal Op As String, ByVal cpfOp As String) As DataTable
        ...
        Dim sql As String = "SELECT * FROM TBL_RISCO_DESCONTO (NOLOCK) WHERE DATA_REF = @DATAREF AND COD_OPERADOR = @CODOP AND CPF_OPERADOR=@CPFOP AND OPERADOR = @OP"
