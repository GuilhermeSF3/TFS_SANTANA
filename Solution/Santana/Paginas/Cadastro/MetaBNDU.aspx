<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaBNDU.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaBNDU" Title="Meta BNDU" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta BNDU</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DT_REF,COD_COBRADORA,TIPO"
					...
					<Columns>
                        ...
                        <asp:TemplateField HeaderText="Tipo">
                            <HeaderTemplate>
                               ...
                               <asp:DropDownList ID="cmbNewTipo" runat="server" Width="200px">
                                    <asp:ListItem>638 - Busca e Apreensão</asp:ListItem>
                                    <asp:ListItem>099 - Entrega Amigável</asp:ListItem>
                                </asp:DropDownList>                                
                            </HeaderTemplate>                            
                            <EditItemTemplate>
                                <asp:DropDownList ID="cmbTipo" runat="server" Width="100px">
                                    <asp:ListItem>638 - Busca e Apreensão</asp:ListItem>
                                    <asp:ListItem>099 - Entrega Amigável</asp:ListItem>
                                </asp:DropDownList>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("TIPO")%>' ID="label3" Width="100px"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
						...
						<asp:TemplateField HeaderText="Meta">
							...
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("META")%>' ID="txtVLR_TC" CssClass="allownumericwithdecimal" Width="100px" MaxLength="10"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("META")%>' ID="lblVLR_TC" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
