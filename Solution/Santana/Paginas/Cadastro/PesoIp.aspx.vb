    ...
    Public Class PesoIp
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            ElseIf e.CommandName.Equals("Delete") Then
                ...
                Dim dataRef1 As String = Right(dataRef, 4) & Right("00" & Trim(Mid(dataRef, 4, 2)), 2) & Right("00" & Trim(Left(dataRef, 2)), 2)

                objData.ApagarRegistro(dataRef1, GridView1.DataKeys(index).Values(1).ToString(), GridView1.DataKeys(index).Values(2).ToString())
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Else
                    ...
                    If strMensagem = "" Then
                        ...
                        objData.AtualizarRegistro(dataRef1, _
