...
Public Class DbGravameInclusao
    ...
    Public Sub InserirRegistro(ByVal COD As String,
        ...
        Dim sql As String = "INSERT INTO AUX_GRAVAME_INCLUSAO(COD_GRAVAME, DESCR_GRAVAME) " &
                                "VALUES (@COD, @DESCR)"
    ...
    Public Sub AtualizarRegistro(ByVal COD As String,
        ...
        Dim sql As String = "UPDATE AUX_GRAVAME_INCLUSAO SET DESCR_GRAVAME=@DESCR " &
    ...
    Public Sub ApagarRegistro(ByVal COD As String)
        ...
        Dim sql As String = "DELETE FROM AUX_GRAVAME_INCLUSAO Where COD_GRAVAME=@COD"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT * FROM AUX_GRAVAME_INCLUSAO (NOLOCK) ORDER BY COD_GRAVAME"
    ...
    Public Function CarregarRegistro(ByVal COD As String) As DataTable
        ...
        Dim sql As String = "SELECT * FROM AUX_GRAVAME_INCLUSAO (NOLOCK) WHERE COD_GRAVAME=@COD"
