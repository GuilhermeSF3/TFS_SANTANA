<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="MetaFormaliz.aspx.vb" Inherits="Santana.Paginas.Cadastro.MetaFormaliz" Title="Meta Formalização" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Meta Formalização</title>
</asp:Content>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="DATAREF"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="Meta">
							<HeaderTemplate>
								...
								<asp:TextBox ID="txtNewMeta_TC" runat="server" Width="100px" CssClass="allownumericwithdecimal" MaxLength="53"></asp:TextBox>
							</HeaderTemplate>
							<EditItemTemplate>
								<asp:TextBox runat="server" Text='<%# Eval("META")%>' ID="txtMeta_TC" CssClass="allownumericwithdecimal" Width="100px" MaxLength="50"></asp:TextBox>
							</EditItemTemplate>
							<ItemTemplate>
								<asp:Label runat="server" Text='<%# Eval("META")%>' ID="lblMeta_TC" Width="100px"></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
