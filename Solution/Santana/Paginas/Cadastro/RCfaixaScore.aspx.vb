...
Namespace Paginas.Cadastro
    ...
    Public Class RCfaixaScore
        Inherits SantanaPage

        Dim objData As DbRcScore
        ...
        Protected Sub FillDataInGrid()
            ...
            Dim dtData As DataTable = New DbRcScore().CarregarTodosRegistros()
            Try
        ...
        Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            If e.CommandName.Equals("AddNew") Then
                ...
                Dim txtNewVEIC As TextBox
                txtNewVEIC = CType(GridView1.HeaderRow.FindControl("txtNewVEIC"), TextBox)
                ...
                Else
                    ...
                    objData = New DbRcScore
                    Dim tdData As DataTable = objData.CarregarRegistro(txtNewDT_DE.Text.Trim(), txtNewVEIC.Text.Trim(), txtNewDE.Text.Trim())
        ...
        Protected Sub GridView1_RowCancelingEdit(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCancelEditEventArgs) Handles GridView1.RowCancelingEdit
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewVEIC"), TextBox).Visible = True
        ...
        Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs)
            ...
            CType(GridView1.HeaderRow.FindControl("txtNewVEIC"), TextBox).Visible = False
        ...
        Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
            ...
            If (GridView1.EditIndex <> -1) Then
                ...
                Dim txtVEIC As TextBox
                txtVEIC = CType(GridView1.Rows(e.RowIndex).FindControl("txtVEIC"), TextBox)

                Dim txtATE As TextBox
                txtATE = CType(GridView1.Rows(e.RowIndex).FindControl("txtATE"), TextBox)


                If txtDESCR.Text.Trim() = "" Or txtVEIC.Text.Trim() = "" Or txtATE.Text.Trim() = "" Then
                    strMensagem = "Por favor, preencher todos os campos."
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Cadastro_FxSCORE_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
