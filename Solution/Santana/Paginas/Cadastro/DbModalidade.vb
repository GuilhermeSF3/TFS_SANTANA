...
Public Class DbModalidade
    ...
    End Function
    Public Function VerificaRegistro(ByVal cod_moda As String) As DataTable

        Dim sql As String = "SELECT * FROM TModa_tipo_prod (NOLOCK) WHERE cod_moda=@cod_moda"
    ...
    Public Sub AtualizarRegistro(ByVal cod_prod As String, _
        ...
        _cmd.Parameters.Add("@cod_prod", SqlDbType.VarChar, 3).Value = cod_prod
        _cmd.Parameters.Add("@cod_modalidade", SqlDbType.VarChar, 30).Value = cod_modalidade
        _cmd.Parameters.Add("@cod_moda", SqlDbType.VarChar, 30).Value = cod_moda
