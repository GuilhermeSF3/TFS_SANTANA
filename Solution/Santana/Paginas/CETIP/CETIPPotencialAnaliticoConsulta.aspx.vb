...
Namespace Paginas.Cetip
    ...
    Public Class CETIPPotencialAnaliticoConsulta
        ...
        Private Function GetData() As DataTable
            ...
            AGENTE = ContextoWeb.UsuarioLogado.codGerente

            table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_POTENCIAL_ANALITICO_CONSULTA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 1, 2) & "', '" & Right(txtDataATE.Text, 4) & Mid(txtDataATE.Text, 1, 2) & "', '" & txtLocalizar.Text & "', '" & txtCepDe.Text & "', '" & TxtCepAte.Text & "', '" & ddlLOJA.SelectedValue & "'," & AGENTE, "PACETIP", strConn)
