<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CETIPRankingConsulta.aspx.vb" Inherits="Santana.Paginas.Cetip.CETIPRankingConsulta" Title="CETIP Ranking" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CETIP Ranking</title>
</asp:Content>
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="CNPJ" SortExpression="CNPJ">
                        ...
                        <asp:TemplateField HeaderText="Quantidade Bancos" SortExpression="QuantidadedeBancos">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Ranking" SortExpression="RankingCliente">
