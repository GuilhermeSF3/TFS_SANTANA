    ...
    Public Class CETIPPotencialSinteticoConsulta
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                txtDataDe.Text = Mid(Convert.ToString(UltimoDiaMesAnterior), 4, 7)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_CETIP_POTENCIAL_SINTETICO_CONSULTA] " & Mid(txtDataDe.Text, 4, 4) & Mid(txtDataDe.Text, 1, 2) & ", " & formataTexto(txtLocalizar.Text) & ", " & AGENTE, "PSCETIP", strConn)
