<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CETIPSintetico.aspx.vb" Inherits="Santana.Paginas.Credito.CETIPSintetico" Title="Relatório Sintético CETIP" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Conversão Sintético CETIP</title>
</asp:Content>
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:DropDownList ID="ddlSituacao" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Faixas de Ano:</p>
                                    </div>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Quantidade:</p>
                                    </div>
                                    <asp:TextBox ID="txtTotal" runat="server" Width="100px" CssClass="form-control navbar-btn" Enabled="false"></asp:TextBox>
                                </div>
                            </li>   
                    </div>
                </div>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Agente" SortExpression="NOME_AGENTE_FINANCEIRO">
                        ...
                        <asp:TemplateField HeaderText="Porcentagem" SortExpression="PORCENTAGEM">
