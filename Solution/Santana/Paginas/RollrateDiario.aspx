<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RollrateDiario.aspx.vb" Inherits="Santana.RollrateDiario" Title="Rollrate Diario" EnableEventValidation="false"%>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Rollrate Diário</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" >
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_RowCommand" DataKeyNames="ORDEM_LINHA, DT_FECHA"  
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="AA QTDE" SortExpression="Aa_QTDE">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AA SALDO" SortExpression="Aa_SALDO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>                                                                         <%--ESTAVA ORDEM_LINHA EM TODOS--%>
                                <asp:LinkButton  ID="AddButtonAA" runat="server" CommandName="AA" CommandArgument='<%# Container.DataItemIndex %>' >
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton  ID="AddButtonA" runat="server" CommandName="A" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonB" runat="server" CommandName="B" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonC" runat="server" CommandName="C" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonD" runat="server" CommandName="D" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonE" runat="server" CommandName="E" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonF" runat="server" CommandName="F" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonG" runat="server" CommandName="G" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonH" runat="server" CommandName="H" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemStyle Width="2%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:LinkButton ID="AddButtonHH" runat="server" CommandName="HH" CommandArgument='<%# Container.DataItemIndex %>' >
                                    <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
