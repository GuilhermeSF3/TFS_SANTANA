<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="IndicePerformanceVR.aspx.vb" Inherits="Santana.IndicePerformanceVR" Title="Indice de Performance Valor Recebido" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Indice de Performance Valor Recebido</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 360px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnDataBound="GridView1_DataBound" DataKeyNames="ORDEM_LINHA">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VALOR BAIXADO" SortExpression="C_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="VALOR RECEBIDO" SortExpression="E_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>
