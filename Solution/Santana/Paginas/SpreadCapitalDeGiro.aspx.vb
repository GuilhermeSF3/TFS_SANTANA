...
Public Class SpreadCapitalDeGiro
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    If IsDBNull(drow("vlr_risco")) Then
                        e.Row.Cells(35).Text = ""
                    Else
                        e.Row.Cells(35).Text = CNumero.FormataNumero(drow("vlr_risco"), 4)
                    End If

                    If IsDBNull(drow("VF_ORIGINAL")) Then
                        e.Row.Cells(36).Text = ""
                    Else
                    ...
                    If IsDBNull(drow("VLR_VEICULO")) Then
                        e.Row.Cells(38).Text = ""
                    Else
                    ...
                    If IsDBNull(drow("TABELA")) Then
                        e.Row.Cells(39).Text = ""
                    Else
                        e.Row.Cells(39).Text = drow("TABELA")
                    End If

                    If IsDBNull(drow("TABELA_DESCR")) Then
                        e.Row.Cells(40).Text = ""
                    Else
                        e.Row.Cells(40).Text = drow("TABELA_DESCR")
                    End If

                    If IsDBNull(drow("prc_Entrada")) Then
                        e.Row.Cells(41).Text = ""
                    Else
                        e.Row.Cells(41).Text = CNumero.FormataNumero(drow("prc_Entrada"), 2)
                    End If

                    If IsDBNull(drow("qtd_Parc_Abertas")) Then
                        e.Row.Cells(42).Text = ""
                    Else
                        e.Row.Cells(42).Text = drow("qtd_Parc_Abertas")
                    End If

                    If IsDBNull(drow("qtd_Parc_Avencer")) Then
                        e.Row.Cells(43).Text = ""
                    Else
                        e.Row.Cells(43).Text = drow("qtd_Parc_Avencer")
                    End If

                    If IsDBNull(drow("qtd_Parc_Pagas")) Then
                        e.Row.Cells(44).Text = ""
                    Else
                        e.Row.Cells(44).Text = drow("qtd_Parc_Pagas")
                    End If

                    If IsDBNull(drow("Tx_Cliente_am")) Then
                        e.Row.Cells(45).Text = ""
                    Else
                        e.Row.Cells(45).Text = CNumero.FormataNumero(drow("Tx_Cliente_am"), 2)
                    End If

                    If IsDBNull(drow("CPF_Cliente")) Then
                        e.Row.Cells(46).Text = ""
                    Else
                        e.Row.Cells(46).Text = drow("CPF_Cliente")
                    End If

                    If IsDBNull(drow("Dt_vcto_contrato")) Then
                        e.Row.Cells(47).Text = ""
                    Else
                        e.Row.Cells(47).Text = drow("Dt_vcto_contrato")
                    End If

                    If IsDBNull(drow("Dt_Liq_Oper")) Then
                        e.Row.Cells(48).Text = ""
                    Else
                        e.Row.Cells(48).Text = drow("Dt_Liq_Oper")
                    End If

                    If IsDBNull(drow("VLR_ENTRADA")) Then
                        e.Row.Cells(49).Text = ""
                    Else
                        e.Row.Cells(49).Text = CNumero.FormataNumero(drow("VLR_ENTRADA"), 2)
                    End If

                    If IsDBNull(drow("TABELA_CATEGORIA")) Then
                        e.Row.Cells(50).Text = ""
                    Else
                        e.Row.Cells(50).Text = drow("TABELA_CATEGORIA")
                    End If

                    If IsDBNull(drow("COD_AGENTE_CORBAN")) Then
                        e.Row.Cells(51).Text = ""
                    Else
                        e.Row.Cells(51).Text = drow("COD_AGENTE_CORBAN")
                    End If

                    If IsDBNull(drow("NOM_AGENTE_CORBAN")) Then
                        e.Row.Cells(52).Text = ""
                    Else
                        e.Row.Cells(52).Text = drow("NOM_AGENTE_CORBAN")
                    End If

                    If IsDBNull(drow("COD_AGENTE_ATUAL")) Then
                        e.Row.Cells(53).Text = ""
                    Else
                        e.Row.Cells(53).Text = drow("COD_AGENTE_ATUAL")
                    End If

                    If IsDBNull(drow("NOM_AGENTE_ATUAL")) Then
                        e.Row.Cells(54).Text = ""
                    Else
                        e.Row.Cells(54).Text = drow("NOM_AGENTE_ATUAL")
                    End If

                    If IsDBNull(drow("DT_ALT_REPAC")) Then
                        e.Row.Cells(55).Text = ""
                    Else
                        e.Row.Cells(55).Text = drow("DT_ALT_REPAC")
                    End If
                    ...
                    If IsDBNull(drow("DTBASE_RENEG_ORIGINAL")) Then
                        e.Row.Cells(56).Text = ""
                    Else
                        e.Row.Cells(56).Text = drow("DTBASE_RENEG_ORIGINAL")
                    End If

                    If IsDBNull(drow("VLR_LIQUIDO")) Then
                        e.Row.Cells(57).Text = ""
                    Else
                        e.Row.Cells(57).Text = CNumero.FormataNumero(drow("VLR_LIQUIDO"), 2)
                    End If

                    If IsDBNull(drow("ANO_FIPE")) Then
                        e.Row.Cells(58).Text = ""
                    Else
                        e.Row.Cells(58).Text = drow("ANO_FIPE")
                    End If

                    If IsDBNull(drow("VALOR_FIPE")) Then
                        e.Row.Cells(59).Text = ""
                    Else
                        e.Row.Cells(59).Text = CNumero.FormataNumero(drow("VALOR_FIPE"), 2)
                    End If

                    If IsDBNull(drow("RENDA_PRO")) Then
                        e.Row.Cells(60).Text = ""
                    Else
                        e.Row.Cells(60).Text = drow("RENDA_PRO")
                    End If

                    If IsDBNull(drow("AVALISTA")) Then
                        e.Row.Cells(61).Text = ""
                    Else
                        e.Row.Cells(61).Text = drow("AVALISTA")
                    End If

                    If IsDBNull(drow("SEGUNDA_GARANTIA")) Then
                        e.Row.Cells(62).Text = ""
                    Else
                        e.Row.Cells(62).Text = drow("SEGUNDA_GARANTIA")
                    End If

                    If IsDBNull(drow("NM_OPERADOR")) Then
                        e.Row.Cells(63).Text = ""
                    Else
                        e.Row.Cells(63).Text = drow("NM_OPERADOR")
                    End If
    ...
    Private Function GetData() As DataTable
        ...
        table = Util.ClassBD.GetExibirGrid("[scr_SPREAD_ANALITICO_CG] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & Right(txtDataDE.Text, 4) & Mid(txtDataDE.Text, 4, 2) & Left(txtDataDE.Text, 2) & "', '" & ddlAgente.SelectedValue & "', '" & ddlCobradora.SelectedValue & "', '" & Right(txtDataINI.Text, 4) & Mid(txtDataINI.Text, 4, 2) & Left(txtDataINI.Text, 2) & "', '" & Right(txtDataFIM.Text, 4) & Mid(txtDataFIM.Text, 4, 2) & Left(txtDataFIM.Text, 2) & "', '" & txtDiasAtraso.Text & "','" & IIf(codGerente = "0", codGerente, ddlPromotora.SelectedValue) & "'", "SPREADANALITICO", strConn)
    ...
    Private Function GetDataProd() As DataTable
        ...
        table = Util.ClassBD.GetExibirGrid("[scr_SPREAD_ANALITICO_Prod_CG] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & Right(txtDataDE.Text, 4) & Mid(txtDataDE.Text, 4, 2) & Left(txtDataDE.Text, 2) & "','" & IIf(codGerente = "0", codGerente, ddlPromotora.SelectedValue) & "'", "SPREADANALITICO", strConn)
