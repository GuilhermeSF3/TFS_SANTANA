<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="IpSafraDiaria.aspx.vb" Inherits="Santana.Paginas.IpSafraDiaria" Title="Indice de Performance Valor Recebido" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Índice de Performance Safra Diária</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 360px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnDataBound="GridView1_DataBound" DataKeyNames="DT_FECHA">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CLASSE DE ATRASO" SortExpression="DESCRICAO" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="Left" BackColor="#EFEFEF" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ESTOQUE DE PARC." SortExpression="B_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VALOR REC. PARC." SortExpression="C_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="T%" SortExpression="D_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="QTDE PARC." SortExpression="E_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="QTDE RECEB." SortExpression="F_PERC" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="11%" HorizontalAlign="RIGHT" BackColor="#EFEFEF" />
                        </asp:TemplateField>
