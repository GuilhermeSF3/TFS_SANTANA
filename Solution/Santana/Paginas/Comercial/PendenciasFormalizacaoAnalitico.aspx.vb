...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasFormalizacaoAnalitico
            ...
            Try
                ...
                ElseIf e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("AGATIVO")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("AGATIVO")
                        End If

                        If IsDBNull(drow("CPF_CNPJ")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("CPF_CNPJ")
                        End If

                        If IsDBNull(drow("PROPOSTA")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("PROPOSTA")
                        End If

                        If IsDBNull(drow("DT_FORMALIZ")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("DT_FORMALIZ")
                        End If

                        If IsDBNull(drow("MOTIVO")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("MOTIVO")
                        End If
                        ...
                        If IsDBNull(drow("LOJA")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("LOJA")
                        End If

                        If IsDBNull(drow("COD_OPERADOR")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("COD_OPERADOR")
                        End If

                        If IsDBNull(drow("OPERADOR")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = drow("OPERADOR")
                        End If

                        If IsDBNull(drow("PEND_AGENTE")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = drow("PEND_AGENTE")
                        End If

                        If IsDBNull(drow("PEND_DCO")) Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = drow("PEND_DCO")
                        End If

                        If IsDBNull(drow("PEND_CONTRATO")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("PEND_CONTRATO")
                        End If

                        If IsDBNull(drow("PEND_GRAVAMES")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("PEND_GRAVAMES")
                        End If

                        If IsDBNull(drow("PG_CTA_AG")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("PG_CTA_AG")
                        End If

                        If IsDBNull(drow("BALCAO")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("BALCAO")
                        End If

                        If IsDBNull(drow("SUBSTITUI_GARANTIA")) Then
                            e.Row.Cells(17).Text = ""
                        Else
                            e.Row.Cells(17).Text = drow("SUBSTITUI_GARANTIA")
                        End If

                        If IsDBNull(drow("USUARIO")) Then
                            e.Row.Cells(18).Text = ""
                        Else
                            e.Row.Cells(18).Text = drow("USUARIO")
                        End If
                        ...
                        If IsDBNull(drow("DT_INTEG")) Then
                            e.Row.Cells(20).Text = ""
                        Else
                            e.Row.Cells(20).Text = drow("DT_INTEG")
                        End If

                        If IsDBNull(drow("DT_APR")) Then
                            e.Row.Cells(21).Text = ""
                        Else
                            e.Row.Cells(21).Text = drow("DT_APR")
                        End If

                        If IsDBNull(drow("VLR_LIB")) Then
                            e.Row.Cells(22).Text = ""
                        Else
                            e.Row.Cells(22).Text = CNumero.FormataNumero(drow("VLR_LIB"), 2)
                        End If

                        If IsDBNull(drow("SCORE")) Then
                            e.Row.Cells(23).Text = ""
                        Else
                            e.Row.Cells(23).Text = drow("SCORE")
                        End If

                        If IsDBNull(drow("DT_INI")) Then
                            e.Row.Cells(24).Text = ""
                        Else
                            e.Row.Cells(24).Text = drow("DT_INI")
                        End If

                        If IsDBNull(drow("HR_INI")) Then
                            e.Row.Cells(25).Text = ""
                        Else
                            e.Row.Cells(25).Text = drow("HR_INI")
                        End If

                        If IsDBNull(drow("DT_FIM")) Then
                            e.Row.Cells(26).Text = ""
                        Else
                            e.Row.Cells(26).Text = drow("DT_FIM")
                        End If

                        If IsDBNull(drow("HR_FIM")) Then
                            e.Row.Cells(27).Text = ""
                        Else
                            e.Row.Cells(27).Text = drow("HR_FIM")
                        End If

                        If IsDBNull(drow("TEMPO")) Then
                            e.Row.Cells(28).Text = ""
                        Else
                            e.Row.Cells(28).Text = drow("TEMPO")
                        End If

                        If IsDBNull(drow("DT_INI_ANALISE")) Then
                            e.Row.Cells(29).Text = ""
                        Else
                            e.Row.Cells(29).Text = drow("DT_INI_ANALISE")
                        End If

                        If IsDBNull(drow("HR_INI_ANALISE")) Then
                            e.Row.Cells(30).Text = ""
                        Else
                            e.Row.Cells(30).Text = drow("HR_INI_ANALISE")
                        End If

                        If IsDBNull(drow("DT_FIM_ANALISE")) Then
                            e.Row.Cells(31).Text = ""
                        Else
                            e.Row.Cells(31).Text = drow("DT_FIM_ANALISE")
                        End If

                        If IsDBNull(drow("HR_FIM_ANALISE")) Then
                            e.Row.Cells(32).Text = ""
                        Else
                            e.Row.Cells(32).Text = drow("HR_FIM_ANALISE")
                        End If

                        If IsDBNull(drow("TEMPO_ANALISE")) Then
                            e.Row.Cells(33).Text = ""
                        Else
                            e.Row.Cells(33).Text = drow("TEMPO_ANALISE")
                        End If
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_PendFORMALIZ_TTL '" &
                    oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue, conexao)
                comando.Connection.Open()
                Dim ddlValues As SqlDataReader
                ddlValues = comando.ExecuteReader()
                ddlValues.Read()
                txtTotalFormaliz.Text = CNumero.FormataNumero(ddlValues("TOTAL").ToString(), 0)
                txtTotalInt.Text = CNumero.FormataNumero(ddlValues("TOTAL_INT").ToString(), 0)
                txtTotalPen.Text = CNumero.FormataNumero(ddlValues("TOTAL_PEN").ToString(), 0)
                txtTotalCan.Text = CNumero.FormataNumero(ddlValues("TOTAL_CAN").ToString(), 0)
                txtTotalRep.Text = CNumero.FormataNumero(ddlValues("TOTAL_REP").ToString(), 0)
                txtTotalApr.Text = CNumero.FormataNumero(ddlValues("TOTAL_APR").ToString(), 0)
                txtTotalAnd.Text = CNumero.FormataNumero(ddlValues("TOTAL_AND").ToString(), 0)
            ...
            Try
                ...
                ddlValues = comando.ExecuteReader()
                ddlValues.Read()
                txtIntPen.Text = CNumero.FormataNumero(ddlValues("TOTAL").ToString(), 0)
        ...
        Private Function GetData() As DataTable
            ...
            Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
            Dim table As DataTable = Util.ClassBD.GetExibirGrid("SCR_PendFORMALIZ_analitico '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue, "SCR_PendenciaFormalizacaoAnalitico", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendenciasFormalizacaoAnalitico_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pendências de Formalização - Analitico - Data De. " & txtDataDe.Text & " Data Até. " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")
