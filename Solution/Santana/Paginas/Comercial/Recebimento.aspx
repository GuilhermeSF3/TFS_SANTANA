<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Recebimento.aspx.vb" Inherits="Santana.Paginas.Comercial.Recebimento" Title="Base de Recebimentos" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Base de Recebimentos</title>
</asp:Content>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cód. Agente" SortExpression="O3CODORG">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cód. Agente Atual" SortExpression="COD_AGENTE_ATIVO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Agente Atual" SortExpression="DESCR_AGENTE_ATIVO">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Produto" SortExpression="OPCODPROD">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Plano" SortExpression="OPQTDDPARC">
                        ...
                        <asp:TemplateField HeaderText="Dt. Pagto." SortExpression="PADTLIQ">
                        ...
                        <asp:TemplateField HeaderText="Valor Parcela" SortExpression="OPVLRPARC">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>                        
                        
                        <asp:TemplateField HeaderText="Valor Pago" SortExpression="PAVLRPAGO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Financiado" SortExpression="OPVLRFIN">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Mov. Fin." SortExpression="EFCODMOV">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
