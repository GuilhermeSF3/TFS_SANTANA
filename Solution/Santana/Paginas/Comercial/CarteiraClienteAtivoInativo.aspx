<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CarteiraClienteAtivoInativo.aspx.vb" Inherits="Santana.Paginas.Comercial.CarteiraClienteAtivoInativo" Title="Carteira de Clientes Ativos e Inativos" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Carteira de Clientes Ativos e Inativos</title>
</asp:Content>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Quitação De:</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Até:</p>
                                    </div>
                                    <div class="btn-group">
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Operação" SortExpression="NR_OPERACAO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Nome Cliente" SortExpression="NM_CLIENTE">
                        ...
                        <asp:TemplateField HeaderText="FIPE" SortExpression="FIPE">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtde. Parcelas" SortExpression="QTDE_PARCELAS">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtde. Parcelas Pagas" SortExpression="QTDE_PARCELAS_PAGAS">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Perc. Quitação" SortExpression="PCT_QUITACAO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vl. Financiado" SortExpression="VALOR_FINANCIADO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Dt. Quitação" SortExpression="DT_QUITACAO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>  
