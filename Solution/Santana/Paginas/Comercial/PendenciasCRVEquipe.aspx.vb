...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVEquipe
        ...
        Private Sub Carrega_Operadores()
            ...
            Try
                If ddlAgente.SelectedValue = "99" Then
                ...
                Else
                    ...
                    If ddlAgente.SelectedValue <> "99" Then
                        ...
                        Dim Command As New SqlCommand("Select O6DESCR, O6CODORG from CDCSANTANAMicroCredito..TORG6 (nolock) WHERE O6CODORG3 = '" & ddlAgente.SelectedValue & "' ORDER BY O6DESCR", con)
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                ...
                If codGerente = "99" Then
                    ...
                    "SELECT O3codOrg as AGCod, O3descr as AGDescr FROM	CDCSANTANAMicroCredito..TORG3 A (NOLOCK) WHERE O3ATIVA IN ('S','A') AND O3DESCR LIKE 'SHOP%' AND O3DESCR <> 'SHOPCRED' ORDER BY O3DESCR", connection)
                ...
                Else
                    ...
                    Dim cmd As New SqlCommand("Select O3DESCR, O3CODORG from CDCSANTANAMicroCredito..TORG3 (nolock) WHERE O3ATIVA IN ('S','A') AND O3codorg IN (" & codGerente & ") AND O3DESCR LIKE 'SHOP%' AND O3DESCR <> 'SHOPCRED'", con)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("VLR_OPER")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("VLR_OPER")
                        End If
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_CRV_TTL_EQUIPE '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                ...
                Dim comando2 As SqlCommand = New SqlCommand(
                    "SCR_CRV_PEND_EQUIPE '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                ...
                Dim conexao4 As New SqlConnection(strConn2)
                Dim comando4 As SqlCommand = New SqlCommand("SCR_CRV_BAIXA_EQUIPE_TTL '" & oDataBxDe.Data.ToString("yyyyMMdd") & "', '" & oDataBxAte.Data.ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue & "', '" & ddlOperador.SelectedValue & "', '" & ddlPreju.SelectedValue & "'", conexao4)
                ...
                If prc <= 10 Then
                    txtVlrBaixa.Text = txtQtdBaixa.Text * 10
                Else
                    txtVlrBaixa.Text = 0
                End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_EQUIPE '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             oDataBxDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataBxAte.Data.ToString("yyyyMMdd") & "', '" &
                                                             ddlOperador.SelectedValue & "', '" &
                                                             ddlPreju.SelectedValue & "'", "SCR_CRV_EQUIPE", strConn)
