...
Public Class MapaPDV
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    e.Row.Cells(11).Text = CNumero.FormataNumero(drow("vlr_carteira_PV"), 2)
                    ...
                    e.Row.Cells(19).Text = CNumero.FormataNumero(drow("SLD_DEVEDOR_CDC"), 2)
                    e.Row.Cells(19).ForeColor = Cor
                    e.Row.Cells(20).Text = CNumero.FormataNumero(drow("limite_op"), 2)
                    e.Row.Cells(20).ForeColor = Cor
                    e.Row.Cells(21).Text = CNumero.FormataNumero(drow("DUPLICATA"), 2)
                    e.Row.Cells(22).Text = CNumero.FormataNumero(drow("CHEQUE"), 2)
                    e.Row.Cells(23).Text = CNumero.FormataNumero(drow("NP"), 2)
    ...
    Private Function GetData() As DataTable
        ...
        table = Util.ClassBD.GetExibirGrid("[SCR_MAPA_PDV] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', 1 , '" & STROPERADOR & "'", "RRMENSALcubo", strConn)
    ...
    Protected Sub ddlRelatorio_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        ViewState("34AF154F-7129-4CA1-90B4-C1175088D384") = Nothing
