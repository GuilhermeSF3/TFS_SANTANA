<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ConsultaCrivo.aspx.vb" Inherits="Santana.Paginas.Comercial.ConsultaCrivo" Title="Consulta Crivo" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Consulta Crivo</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="CONSULTA" SortExpression="CSNRCONSEXT" >
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="AGENTE" SortExpression="PPCODORG3">
