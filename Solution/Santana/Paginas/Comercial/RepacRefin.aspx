<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RepacRefin.aspx.vb" Inherits="Santana.Paginas.Comercial.RepacRefin" Title="Repacs para Refin" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Repacs para Refin</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="CONTRATO" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Histórico Reneg" SortExpression="HIST_RENEG">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
