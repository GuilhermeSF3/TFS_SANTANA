<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasFormalizacao.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasFormalizacao" Title="Pendências de Formalização" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências de Formalização</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="ordem" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PEND DCO" SortExpression="PENDENCIAS">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="% DCO" SortExpression="PRC">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="AGENTE" SortExpression="PEND_AGENTE">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="% AGENTE" SortExpression="PRC_PEND_AGENTE">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CONTRATO" SortExpression="PEND_CONTRATO">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="% CONTRATO" SortExpression="PRC_PEND_CONTRATO">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                  
                        <asp:TemplateField HeaderText="GRAVAMES" SortExpression="PEND_GRAVAMES">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="% GRAVAMES" SortExpression="PRC_PEND_GRAVAMES">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Pg Cta AG" SortExpression="QTD_PG_CTA_AG">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Origem BALCÃO" SortExpression="QTD_BALCAO">
                            <ItemStyle Width="7%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
