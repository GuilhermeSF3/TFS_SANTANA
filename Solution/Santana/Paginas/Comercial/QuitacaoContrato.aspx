<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="QuitacaoContrato.aspx.vb" Inherits="Santana.Paginas.Credito.QuitacaoContrato" Title="Quitação Contrato" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Quitação Contrato</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dt. Base" SortExpression="OPDTBASE">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>  
                        
                        <asp:TemplateField HeaderText="Quant. Parcelas" SortExpression="OPQTDDPARC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>  
                        
                        <asp:TemplateField HeaderText="Dt. Liquidado" SortExpression="OPDTLIQ">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>  
                        
                        <asp:TemplateField HeaderText="Dt. Vencimento" SortExpression="OPDTVCTO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Descrição" SortExpression="TPDESCR">
                            <ItemStyle Width="15%" HorizontalAlign="left" />
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="E-mail" SortExpression="CLEMAIL">
                            <ItemStyle Width="15%" HorizontalAlign="left" />
                        </asp:TemplateField>    
                        ...
                        <asp:TemplateField HeaderText="Qtde. Contratos do cliente" SortExpression="QTDE_CONTRATOS">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>
