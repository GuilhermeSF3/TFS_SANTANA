<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRVEquipe.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRVEquipe" Title="Pendências CRV - Equipe" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV - Equipe</title>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        ...
                        <ul class="nav navbar-nav">
                           ...
                           <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Operadores</p>
                                    </div>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VLR OPERADOR" SortExpression="VLR_OPER">
