...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasGravameSint
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_PENDENCIAGRAVAME_SINT '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pendências de Gravames - Sint. - Data De. " & txtDataDe.Text & " Data Até. " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")
