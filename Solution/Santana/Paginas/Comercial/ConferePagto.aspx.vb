...
Namespace Paginas.Comercial
    ...
    Public Class ConferePagto
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("DCVALOR_PAGFROTA")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = CNumero.FormataNumero(drow("DCVALOR_PAGFROTA"), 2)
                        End If

                        If IsDBNull(drow("DCVALOR_BOLETO")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = CNumero.FormataNumero(drow("DCVALOR_BOLETO"), 2)
                        End If

                        If IsDBNull(drow("DCVALOR_ACESSORIOS")) Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = CNumero.FormataNumero(drow("DCVALOR_ACESSORIOS"), 2)
                        End If

                        If IsDBNull(drow("ABCHASSI")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("ABCHASSI")
                        End If

                        If IsDBNull(drow("ABUFLCPL")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("ABUFLCPL")
                        End If

                        If IsDBNull(drow("EPDTLNC")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("EPDTLNC")
                        End If

                        e.Row.Cells(16).Text = drow("EPHORALNC")

                        e.Row.Cells(17).Text = drow("OPCODORG3")
                        e.Row.Cells(18).Text = drow("OPERADOR")
                        e.Row.Cells(19).Text = drow("OPCODORG4")
                        e.Row.Cells(20).Text = drow("LOJA")
                        e.Row.Cells(21).Text = drow("CODPROD")
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_DCO_CONF_PAGTO_TTL '" &
                    oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", " & ddlPagto.SelectedValue & ", " & ddlFavorecido.SelectedValue, conexao)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_DCO_CONF_PAGTO '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", " & ddlPagto.SelectedValue & ", " & ddlFavorecido.SelectedValue, "SCR_CRV", strConn)
        ...
        Private Sub Carrega_Agentes()
            ...
            Try
                ...
                "SELECT DISTINCT A13CODORG, A13DESCR FROM DCO_CONF_PGTO", connection)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("ConferePagto_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Confere Pagamentos - Data DE: " & txtDataDe.Text & " Data Até: " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")

                        Response.Write("Qtde de CONTRATOS " & txtQteContratoRealizado.Text & " Total de PRODUÇÃO " & TxtVlr.Text)
        ...
        Private Sub Carrega_Favorecido()

            Try

                ddlFavorecido.Items.Insert(0, New ListItem("Todos", "0"))
                ddlFavorecido.Items.Insert(1, New ListItem("Favorecidos", "1"))
                ddlFavorecido.Items.Insert(2, New ListItem("Boleto", "2"))
                ddlFavorecido.Items.Insert(3, New ListItem("PagFrota", "3"))
                ddlFavorecido.Items.Insert(4, New ListItem("Acessórios", "4"))

                ddlFavorecido.SelectedIndex = 0
        ...
        Protected Sub ddlAgente_SelectedIndexChanged(sender As Object, e As EventArgs)
            If (ddlAgente.Text <> "99") Then
                ddlFavorecido.Enabled = False
            Else
                ddlFavorecido.Enabled = True
            End If
        End Sub
    End Class
