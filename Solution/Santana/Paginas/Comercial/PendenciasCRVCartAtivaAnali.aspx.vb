...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVCartAtivaAnali
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_ANALI_ttl '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                ...
                Dim comando2 As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_ANALI_pend '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                ...
                Dim comando3 As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_ANALI_AGENTE " & ddlAgente.SelectedValue, conexao3)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_CATIVA_ANALI '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             ...
                                                             ddlPreju.SelectedValue & "', '" &
                                                             ddlReneg.SelectedValue & "', '" &
                                                             ddlAtivo.SelectedValue & "'", "SCR_CRV_CATIVA_ANALI", strConn)
