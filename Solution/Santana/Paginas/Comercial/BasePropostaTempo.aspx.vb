...
Namespace Paginas.Credito
    ...
    Public Class BasePropostaTempo
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_CREDITO_BASE_TEMPO] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "BasePropostasCredito", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("BasePropostasMesa_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Relatório Base de Propostas - Mesa - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data)
