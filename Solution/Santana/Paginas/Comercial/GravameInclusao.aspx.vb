...
Namespace Paginas.Comercial
    ...
    Public Class GravameInclusao
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("ABCHASSI")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = drow("ABCHASSI")
                        End If

                        If IsDBNull(drow("ABUFLCPL")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("ABUFLCPL")
                        End If

                        If IsDBNull(drow("STATUSGRV")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("STATUSGRV")
                        End If

                        If IsDBNull(drow("DESCR_GRAVAME")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = drow("DESCR_GRAVAME")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_GRAVAME_INCLUSAO '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", " & ddlPagto.SelectedValue, "GRAVAME_INCLUSAO", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("GravameInclusao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Gravame Inclusão - Data DE: " & txtDataDe.Text & " Data Até: " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")
