<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRVInativos.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRVInativos" Title="Pendências CRV - Inativos" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV - Inativos</title>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Data De (Baixa):</p>
                                    </div>
                                    <div class="btn-group">
                                        <asp:Button ID="btnDtDeAnterior" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDtDeAnterior_Click"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDtDeBaixa" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
                                        <asp:Button ID="btnDtDeProxima" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDtDeProxima_Click"></asp:Button>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Data Até (Baixa):</p>
                                    </div>
                                    <div class="btn-group">
                                        ...
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDtAteBaixa" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor Desconto:</p>
                                    </div>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Qte. de Pendências Baixadas:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtdBaixa" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor a Pagar:</p>
                                    </div>
                                    <asp:TextBox ID="txtVlrBaixa" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
