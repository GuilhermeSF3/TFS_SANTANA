...
Namespace Paginas.Comercial
    ...
    Public Class CarteiraClienteAtivoInativo
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                ...
                ddlAtivo.Items.Insert(1, New ListItem("ATIVO", "1"))
                ddlAtivo.Items.Insert(2, New ListItem("INATIVO", "0"))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col += 1
                        If IsDBNull(drow("NR_OPERACAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NR_OPERACAO")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("NM_CLIENTE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NM_CLIENTE")
                        End If
                        ...
                        If IsDBNull(drow("LOGRADOURO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("LOGRADOURO")
                        End If
                        ...
                        If IsDBNull(drow("MUNICIPIO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("MUNICIPIO")
                        End If
                        ...
                        If IsDBNull(drow("NUMERO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NUMERO")
                        End If
                        ...
                        If IsDBNull(drow("COMPLEMENTO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("COMPLEMENTO")
                        End If
                        ...
                        If IsDBNull(drow("PLACA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PLACA")
                        End If
                        ...
                        If IsDBNull(drow("RENAVAM")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("RENAVAM")
                        End If
                        ...
                        If IsDBNull(drow("CHASSI")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("CHASSI")
                        End If

                        col += 1
                        If IsDBNull(drow("FIPE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("FIPE")
                        End If

                        col += 1
                        If IsDBNull(drow("QTDE_PARCELAS")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("QTDE_PARCELAS")
                        End If

                        col += 1
                        If IsDBNull(drow("QTDE_PARCELAS_PAGAS")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("QTDE_PARCELAS_PAGAS")
                        End If

                        col += 1
                        If IsDBNull(drow("PCT_QUITACAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("PCT_QUITACAO"), 2)
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("DT_QUITACAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DT_QUITACAO")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_CARTEIRA_CLIENTE_ATIVO_INATIVO] '" & ddlAtivo.SelectedValue & "', '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "BasePropostasCredito", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("CarteiraClienteAtivoInativo_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
