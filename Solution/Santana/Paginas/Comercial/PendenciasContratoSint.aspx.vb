...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasContratoSint
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("OPCODORG3")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("OPCODORG3")
                        End If
                        ...
                        If IsDBNull(drow("QTD_PEN")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("QTD_PEN")
                        End If

                        If IsDBNull(drow("QTD_FIN")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("QTD_FIN")
                        End If

                        If IsDBNull(drow("QTD_ABE")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("QTD_ABE")
                        End If

                        If IsDBNull(drow("O3EMAIL")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("O3EMAIL")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_PENDENCIACONTRATO_SINT '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', '" &
                                                             ddlAgente.SelectedValue & "', '" &
                                                             ddlAtivo.SelectedValue & "'", "SCR_PendenciaContrato_SINT", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendenciasContratoSintetico_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
