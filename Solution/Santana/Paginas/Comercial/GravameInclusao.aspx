<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="GravameInclusao.aspx.vb" Inherits="Santana.Paginas.Comercial.GravameInclusao" Title="Gravame Inclusão" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gravame Inclusão</title>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="UF PLACA" SortExpression="ABUFLCPL">
                            <ItemStyle Width="5%" HorizontalAlign="Left"/>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="STATUS" SortExpression="STATUSGRV">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="MOTIVO" SortExpression="DESCR_GRAVAME">
