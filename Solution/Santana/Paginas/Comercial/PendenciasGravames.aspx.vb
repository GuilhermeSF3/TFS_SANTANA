...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasGravames
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("VLR_PRODUCAO") Or drow("VLR_PRODUCAO") = 0) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = CNumero.FormataNumero(drow("VLR_PRODUCAO"), 2)
                        End If

                        If IsDBNull(drow("PRC_PEND") Or drow("PRC_PEND") = 0) Then
                            e.Row.Cells(14).Text = ""
                        Else
                        ...
                        If IsDBNull(drow("ABMODELO")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("ABMODELO")
                        End If

                        If IsDBNull(drow("ABPLACA")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("ABPLACA")
                        End If

                        If IsDBNull(drow("ABCHASSI")) Then
                            e.Row.Cells(17).Text = ""
                        Else
                            e.Row.Cells(17).Text = drow("ABCHASSI")
                        End If

                        If IsDBNull(drow("ABRENAVAM")) Then
                            e.Row.Cells(18).Text = ""
                        Else
                            e.Row.Cells(18).Text = drow("ABRENAVAM")
                        End If

                        If IsDBNull(drow("DIASATRASO")) Then
                            e.Row.Cells(19).Text = ""
                        Else
                            e.Row.Cells(19).Text = drow("DIASATRASO")
                        End If

                        If IsDBNull(drow("USUARIO")) Then
                            e.Row.Cells(20).Text = ""
                        Else
                            e.Row.Cells(20).Text = drow("USUARIO")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_DCO_PendenciaGravames '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             ddlRegiao.SelectedValue & "', '" &
                                                             ddlPreju.SelectedValue & "', '" &
                                                             ddlReneg.SelectedValue & "', '" &
                                                             ddlAtivo.SelectedValue & "'", "SCR_PendenciaGravames", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendenciasGravames_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
