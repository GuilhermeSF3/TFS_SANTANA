...
Namespace Paginas.Comercial
    ...
    Public Class RelCadastroLojas
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        Else
                            e.Row.Cells(index).Text = drow("MPSIT")
                        End If
                        ...
                        If IsDBNull(drow("PPDTBASE")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("PPDTBASE")
                        End If
                        ...
                        If IsDBNull(drow("O4NOME")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("O4NOME")
                        End If

                        index += 1
                        If IsDBNull(drow("O4CPFCGC")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("O4CPFCGC")
                        End If
                        ...
                        If IsDBNull(drow("O6CODORG")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("O6CODORG")
                        End If
                        ...
                        If IsDBNull(drow("O6DESCR")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("O6DESCR")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_CADASTRO_LOJAS] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) &
                                                                "', '" & ddlAgente.SelectedValue & "'", "CADASTROLOJA", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("CadastroDeLojas{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Cadastro de Lojas De: " & txtDataDe.Text & " até: " & txtDataAte.Text)
