<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ContratoPgPendSint.aspx.vb" Inherits="Santana.Paginas.Comercial.ContratoPgPendSint" Title="Contratos Pagos com Pendência - Sint." EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Contratos Pagos com Pendência - Sintético</title>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Pend. (DE):</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Data Pend. (ATÉ)</p>
                                    </div>
                                    <div class="btn-group">
...
<%--                <div>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="OPCODORG3" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CÓD. AGENTE" SortExpression="OPCODORG3">
                        ...
                        <asp:TemplateField HeaderText="QTD. PEND." SortExpression="QTD_PEN">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="QTD. FINALIZ." SortExpression="QTD_FIN">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtd. ABERTO" SortExpression="QTD_ABE">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="E-MAIL" SortExpression="O3EMAIL">
