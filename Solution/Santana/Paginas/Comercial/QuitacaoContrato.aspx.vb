...
Namespace Paginas.Credito
    ...
    Public Class QuitacaoContrato
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("OPDTLIQ")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("OPDTLIQ")
                        End If
                        ...
                        If IsDBNull(drow("OPCODPROD")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("OPCODPROD")
                        End If
                        ...
                        If IsDBNull(drow("OPCODORG3")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("OPCODORG3")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("CLEMAIL")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("CLEMAIL")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("QTDE_CONTRATOS")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("QTDE_CONTRATOS")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_QUITACAO_CONTRATO] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "BasePropostasCredito", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("QuitacaoContrato_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
