...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVPromotora
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                Dim dtBaixa As String = Now.Date.ToString("25/MM/yyyy")
                txtDtAteBaixa.Text = Convert.ToDateTime(dtBaixa)
                txtDtDeBaixa.Text = Convert.ToDateTime(dtBaixa).AddMonths(-1)
                txtDtDeBaixa.Text = Convert.ToDateTime(txtDtDeBaixa.Text).AddDays(1)
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                ...
                If codGerente = "99" Then
                    ...
                    "SELECT O3codOrg as AGCod, O3descr as AGDescr FROM	CDCSANTANAMicroCredito..TORG3 A (NOLOCK) WHERE O3ATIVA IN ('S','A') AND O3DESCR NOT LIKE 'SHOP%' ORDER BY O3DESCR", connection)
                ...
                Else
                    ...
                    Dim cmd As New SqlCommand("Select O3DESCR, O3CODORG from CDCSANTANAMicroCredito..TORG3 (nolock) WHERE O3ATIVA IN ('S','A') AND O3codorg IN (" & codGerente & ") AND O3DESCR NOT LIKE 'SHOP%'", con)
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("EPDTLNCBX")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("EPDTLNCBX")
                        End If
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_CRV_TTL_PROMOTORA '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                ...
                Dim comando2 As SqlCommand = New SqlCommand(
                    "SCR_CRV_PEND_PROMOTORA '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                ...
                'QTD BAIXADAS
                Dim oDataBxDe As New CDataHora(Convert.ToDateTime(txtDtDeBaixa.Text))
                Dim oDataBxAte As New CDataHora(Convert.ToDateTime(txtDtAteBaixa.Text))

                Dim strConn4 As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
                Dim conexao4 As New SqlConnection(strConn4)
                Dim comando4 As SqlCommand = New SqlCommand("SCR_CRV_BAIXA_PROMOTORA_TTL '" & oDataBxDe.Data.ToString("yyyyMMdd") & "', '" & oDataBxAte.Data.ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue & "', '" & ddlPreju.SelectedValue & "'", conexao4)
                comando4.Connection.Open()
                Dim ddlValues4 As SqlDataReader
                ddlValues4 = comando4.ExecuteReader()
                ddlValues4.Read()
                txtQtdBaixa.Text = ddlValues4("TOTAL").ToString()
                ddlValues4.Close()
                comando4.Connection.Close()
                comando4.Connection.Dispose()
                conexao4.Close()

                ''QTD ATRASO
                'Dim oDataAtrasoDe As New CDataHora(Convert.ToDateTime(txtDtDeBaixa.Text))
                'Dim oDataAtrasoAte As New CDataHora(Convert.ToDateTime(txtDtAteBaixa.Text))

                'Dim strConn5 As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
                'Dim conexao5 As New SqlConnection(strConn5)
                'Dim comando5 As SqlCommand = New SqlCommand("SCR_CRV_ATRASO_PROMOTORA_TTL '" & oDataAtrasoDe.Data.ToString("yyyyMMdd") & "', '" & oDataAtrasoAte.Data.ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue & "'", conexao5)
                'comando5.Connection.Open()
                'Dim ddlValues5 As SqlDataReader
                'ddlValues5 = comando5.ExecuteReader()
                'ddlValues5.Read()
                'txtVlrBaixa.Text = ddlValues5("TOTAL").ToString()
                'ddlValues5.Close()
                'comando5.Connection.Close()
                'comando5.Connection.Dispose()
                'conexao5.Close()

                If prc <= 10 Then
                    txtVlrBaixa.Text = txtQtdBaixa.Text * 50
                Else
                    'txtVlrBaixa.Text = txtVlrBaixa.Text * -50
                    txtVlrBaixa.Text = 0
                End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_PROMOTORA '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             ddlPreju.SelectedValue & "'", "SCR_CRV_PROMOTORA", strConn)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Qtde de Pendentes " & txtQtePendAlienacao.Text & " Total de Contratos " & txtQteContratoRealizado.Text & " Percentual (%) " & txtPercentual.Text & " Valor Retenção ")
