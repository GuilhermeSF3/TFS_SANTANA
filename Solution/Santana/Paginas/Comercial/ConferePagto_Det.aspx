<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ConferePagto_Det.aspx.vb" Inherits="Santana.Paginas.Comercial.ConferePagto_Det" Title="Confere Pagamento - Detalhado" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Confere Pagamento - Detalhado</title>
