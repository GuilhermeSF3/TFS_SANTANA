<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRVCartAtivaLiq.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRVCartAtivaLiq" Title="Pendências CRV Carteira Ativa - Liquidados" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV - Carteira Ativa - Liquidados</title>
...
<%--                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Data Contrato</p>
                                    </div>--%>
                                    <div class="btn-group">
                                        <asp:Button ID="btnDataAnteriorCont" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataAnteriorCont_Click" Visible="false"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDataContrato" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" Visible="false"></cc1:Datax>
                                        </span>
                                        <asp:Button ID="btnProximaDataCont" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaDataCont_Click" Visible="false"></asp:Button>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <div class="btn-group">
                                        <asp:Button ID="btnDataAnteriorRef" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataAnteriorRef_Click"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDataReferencia" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
                                        <asp:Button ID="btnProximaDataRef" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaDataRef_Click"></asp:Button>
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Ocorrências</p>
                                    </div>
                                    <asp:DropDownList ID="ddlOcorrencias" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                        ...
                        <ul class="nav navbar-nav">    
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:DropDownList ID="ddlRegiao" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Prejuízo</p>
                                    </div>
                                    <asp:DropDownList ID="ddlPreju" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Renegociados</p>
                                    </div>
                                    <asp:DropDownList ID="ddlReneg" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Ativo</p>
                                    </div>
                                    <asp:DropDownList ID="ddlAtivo" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Qte. De Contratos Realizado Até:</p>
                                    </div>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Qte. De Pendências De Alienação Até:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtePendAlienacao" runat="server" MaxLength="10" Width="100px" enabled="false"  CssClass="form-control navbar-btn"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Percentual (%):</p>
                                    </div>
                                    <asp:TextBox ID="txtPercentual" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Agente Ativo:</p>
                                    </div>
                                    <asp:TextBox ID="TxtATIVO" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="REGIÃO" SortExpression="REGIAO">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PREJUÍZO" SortExpression="PREJU">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="RENEGOCIADO" SortExpression="RENEG">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>
