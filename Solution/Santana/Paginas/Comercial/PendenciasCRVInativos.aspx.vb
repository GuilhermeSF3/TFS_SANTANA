...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVInativos
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                ...
                If codGerente = "99" Then
                    ...
                    "SELECT O3codOrg as AGCod, O3descr as AGDescr FROM	CDCSANTANAMicroCredito..TORG3 A (NOLOCK) WHERE O3ATIVA IN ('N','D') ORDER BY O3DESCR", connection)
                ...
                Else
                    ...
                    Dim cmd As New SqlCommand("Select O3DESCR, O3CODORG from CDCSANTANAMicroCredito..TORG3 (nolock) WHERE O3ATIVA IN ('N','D') AND O3codorg IN (" & codGerente & ")", con)
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_CRV_TTL_INATIVOS '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                ...
                Dim comando2 As SqlCommand = New SqlCommand(
                    "SCR_CRV_PEND_INATIVOS '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                ...
                '    "SCR_CRV_AGENTE_INATIVO " & ddlAgente.SelectedValue, conexao3)
                ...
                Dim comando4 As SqlCommand = New SqlCommand("SCR_CRV_BAIXA_INATIVA_TTL '" & oDataBxDe.Data.ToString("yyyyMMdd") & "', '" & oDataBxAte.Data.ToString("yyyyMMdd") & "', '" & ddlAgente.SelectedValue & "', '" & ddlPreju.SelectedValue & "'", conexao4)
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_INATIVOS '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
