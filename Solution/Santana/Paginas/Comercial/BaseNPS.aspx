<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="BaseNPS.aspx.vb" Inherits="Santana.Paginas.Comercial.BaseNPS" Title="Base NPS" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Base NPS</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="CPF,NOME" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nome Mãe" SortExpression="NOME_MAE">
                            <ItemStyle Width="10%" HorizontalAlign="LEft" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Nascimento" SortExpression="DATA_NASC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Atividade" SortExpression="ATIV">
                        ...
                        <asp:TemplateField HeaderText="FONE" SortExpression="FONE">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DDD Cel" SortExpression="DDD_CEL">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Valor Parc." SortExpression="VLR_PARC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Valor Financ." SortExpression="VLR_FIN">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cód. Modalidade" SortExpression="PPCODOP">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
