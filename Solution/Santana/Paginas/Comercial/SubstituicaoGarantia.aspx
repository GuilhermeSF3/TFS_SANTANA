<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="SubstituicaoGarantia.aspx.vb" Inherits="Santana.Paginas.Comercial.SubstituicaoGarantia" Title="Substituição de Garantia" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	<title>Substituição de Garantia</title>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<div id="msgHeader" runat="server" visible="False">
				<div>
					<span>RESSARCIMENTO DE TARIFAS AOS AGENTES
					</span>
				</div>
			</div>
			...
			<div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
				...
				<asp:GridView ID="GridView1" runat="server"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="SUBS.GARANTIA QTE." SortExpression="QTD_SUBSTITUI">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>

						<asp:TemplateField HeaderText="SUBS.GARANTIA VALOR" SortExpression="VLR_SUBSTITUI">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>

						<asp:TemplateField HeaderText="TRANSF.DIVIDA QTE." SortExpression="QTD_TRANSFER">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>

						<asp:TemplateField HeaderText="TRANSF.DIVIDA VALOR" SortExpression="VLR_TRANSFER">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>

						<asp:TemplateField HeaderText="TOTAL QUANTIDADE" SortExpression="QTD_TTL">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>

						<asp:TemplateField HeaderText="TOTAL VALOR" SortExpression="VLR_TTL">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>
						...
						<asp:TemplateField HeaderText="DATA OCORRÊNCIA" SortExpression="DATA_OCOR">
							<ItemStyle Width="10%" HorizontalAlign="Right" />
						</asp:TemplateField>
				...
				<div id="msgFooter" runat="server" visible="False">
					<div>
						<span
							style="color: red">Na data de hoje o valor para reembolso é de R$ 150,00 por operação.
						</span>
					</div>
				</div>
			</div>
