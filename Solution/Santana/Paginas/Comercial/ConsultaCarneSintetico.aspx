<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ConsultaCarneSintetico.aspx.vb" Inherits="Santana.Paginas.Comercial.ConsultaCarneSintetico" Title="Consulta Carnê Sintético" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Consulta Carnê Sintético</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="PANROPER" ShowFooter="false" 
                    OnDataBound="GridView1_DataBound" Font-Size="9pt">
                                       
                    <RowStyle Height="28px" />
                    <Columns>

                        <asp:TemplateField HeaderText="Operação" SortExpression="PANROPER">
                        ...
                        <asp:TemplateField HeaderText="Quant. Registros" SortExpression="QTD_REGISTRO">
                            <ItemStyle Width="12%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Última Parc. Registrada" SortExpression="ULT_PARC_REG">
                            <ItemStyle Width="12%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Vcto. da Parcela Registrada" SortExpression="ULT_VCTO_PARC_REG">
                            <ItemStyle Width="12%" HorizontalAlign="Left" />
                        </asp:TemplateField>
