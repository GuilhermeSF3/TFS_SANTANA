<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AcionamentoCliente.aspx.vb" Inherits="Santana.Paginas.Comercial.AcionamentoCliente" Title="Acionamento de Clientes" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Acionamento de Clientes</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="DT_BASE,CONTRATO" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CPF/CNPJ" SortExpression="CGC">
                            <ItemStyle Width="5%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Tel. Fixo" SortExpression="TELFIXO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Tel. Comercial" SortExpression="FONE_COM">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Parcelas Pagas" SortExpression="PARCELAS_PAGAS">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Último Pagto." SortExpression="DT_ULT_PGTO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Renda" SortExpression="RENDA" Visible="false">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vlr. Liberado" SortExpression="VALOR_LIB">
                            <ItemStyle Width="5%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Vlr. Financ." SortExpression="VALOR_FIN">
                            <ItemStyle Width="5%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Produto" SortExpression="COD_PROD">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Dt. Nascto." SortExpression="DATA_NASCTO">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Score" SortExpression="SCORE" Visible="false">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Reneg." SortExpression="RENEG">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cliente Santana" SortExpression="CLI_SANTANA">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Liquidação" SortExpression="DT_LIQ">
                            <ItemStyle Width="5%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Vlr. Fipe" SortExpression="VLR_FIPE">
                            <ItemStyle Width="5%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Prejuízo" SortExpression="PREJUIZO">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="BNDU" SortExpression="BNDU">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ATRASO 5D/3M" SortExpression="ATRASO_5D">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                         <asp:TemplateField HeaderText="REPAC" SortExpression="REPAC">
                            <ItemStyle Width="4%" HorizontalAlign="LEFT" />
                        </asp:TemplateField>

                         <asp:TemplateField HeaderText="% LIQ" SortExpression="PRC_LIQ">
                            <ItemStyle Width="4%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                         <asp:TemplateField HeaderText="ANTECIPACAO" SortExpression="ANTECIPACAO">
                            <ItemStyle Width="4%" HorizontalAlign="LEFT" />
                        </asp:TemplateField>
