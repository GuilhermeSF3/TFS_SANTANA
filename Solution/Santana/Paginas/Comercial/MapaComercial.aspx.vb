...
Public Class MapaComercial
    ...
    Private Sub Carrega_Cobradora()
        Try
            ...
            ddlCobradora.Items.Insert(3, New ListItem("Pesados", "4"))
    ...
    Private Sub GridViewCarteiras_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridViewCarteiras.RowDataBound
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                ...
                Dim command As SqlCommand = New SqlCommand("SELECT F.DESCR FROM FX_ANO_COML F (NOLOCK) WHERE DT_DE = (SELECT	MAX(DT_DE) " &
                                                        " FROM	FX_ANO_COML A1 (NOLOCK) " &
    ...
    Private Function GetData() As DataTable
        ...
        table = Util.ClassBD.GetExibirGrid("[scr_MAPACOMERCIAL] '" & Right(txtDataDE.Text, 4) & Mid(txtDataDE.Text, 4, 2) & Left(txtDataDE.Text, 2) & "', '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "','" & ddlCobradora.SelectedValue & "','" & ddlAgente.SelectedValue & "'", "RRMENSALcubo", strConn)
