<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasContrato.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasContrato" Title="Pendências de Contrato " EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências Contrato</title>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="msgHeader" runat="server" visible="False">
                ...
                <div>
                    <span>O(s) contrato(s) abaixo relacionado(s) estão incompletos, ou seja, Pendentes de Formalização a mais de 10 (dez) dias da data base da operação.
                    </span>
                </div>
                <div>
                    <span>
                        <small>Lembramos que, a não regularização desta(s) pendência(s) no prazo máximo de 10 (dez) dias uteis da data base das respectivas operações, acarretará a retenção das Comissões de Financiamentos  deste(s) contrato(s) no fechamento mensal.</small>
                    </span>
                </div>
            </div>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="OPDTBASE,OPNROPER" ShowFooter="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PROPOSTA" SortExpression="OPNRPROP">
                        ...
                        <asp:TemplateField HeaderText="MOTIVOS" SortExpression="OBS">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="VALOR LIB. CONTRATO" SortExpression="VLR_LIB">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% VALOR A RETER" SortExpression="VLR_RETER">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PRODUÇÃO" SortExpression="VLR_PRODUCAO">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% PENDENCIA" SortExpression="PRC_PEND">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DATA LIMITE" SortExpression="DT_LIMITE">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DATA BLOQUEIO" SortExpression="DT_BLOQUEIO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ATRASO PARC." SortExpression="DIASATRASO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ATRASO PEND." SortExpression="ATRASO_PEN">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                ...
                <div id="msgFooter" runat="server" visible="False">
                    <div>
                        <span
                            style="color: red">Atenção: O envio do processo completo é determinante para a Formalização e Legalização do Contrato.
                        </span>
                    </div>
                    <div>
                        <span
                            style="color: red">Portanto a ocorrência de uma destas irregularidades acima é considerada como FALTA DO CONTRATO, ou seja, CONTRATO PENDENTE. (Vide Comunicado 014/2013).
                        </span>
                    </div>
                </div>
            </div>
