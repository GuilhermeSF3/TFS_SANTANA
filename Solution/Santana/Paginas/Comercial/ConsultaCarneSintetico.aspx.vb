...
Namespace Paginas.Comercial
    ...
    Public Class ConsultaCarneSintetico
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("OPQTDDPARC")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("OPQTDDPARC")
                            e.Row.Cells(2).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("QTD_REGISTRO")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("QTD_REGISTRO")
                            e.Row.Cells(3).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("ULT_PARC_REG")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("ULT_PARC_REG")
                            e.Row.Cells(4).Font.Bold = Bold
                        End If

                        If IsDBNull(drow("ULT_VCTO_PARC_REG")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("ULT_VCTO_PARC_REG")
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CONSULTA_CARNE_SINT '" &
                                               oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                               oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                               ddlStatus.SelectedValue & ", '" &
                                               txtContrato.Text.Trim() & "','" &
                                               ddlAgente.SelectedValue & "'", "SCR_CONSULTA_CARNE_SINT", strConn)
