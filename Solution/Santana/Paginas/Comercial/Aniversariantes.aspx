<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Aniversariantes.aspx.vb" Inherits="Santana.Paginas.Comercial.Aniversariantes" Title="Aniversariantes" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dt. Nasc." SortExpression="DATA_NASC">
                        ...
                        <asp:TemplateField HeaderText="Atraso" SortExpression="IND_ATRASO">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dias Atraso" SortExpression="QTD_ATRASO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="(%) Quitação" SortExpression="PCT_QUITACAO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Maior Atraso" SortExpression="MAX_ATRASO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
