...
Public Class MapaPDVVeic
    ...
    Private Function GetData() As DataTable
        ...
        Dim STROPERADOR As String = ContextoWeb.UsuarioLogado.codGerente


        Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")

        Dim Table As DataTable = Util.ClassBD.GetExibirGrid("[SCR_MAPA_PDV_VEIC] '" & Convert.ToDateTime(txtData.Text).ToString("yyyyMMdd") & "','" & RTrim(STROPERADOR) & "'", "IndicePerformance", strConn)
