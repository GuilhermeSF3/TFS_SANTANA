<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasGravames.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasGravames" Title="Pendências de Gravames " EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências Gravames</title>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CÓD OPERADOR" SortExpression="OPCODORG3" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="% VLR A RETER" SortExpression="VLR_RETER">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="ATRASO" SortExpression="DIASATRASO">
