...
Namespace Paginas.Comercial
    ...
    Public Class Recebimento
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("OPNROPER")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("OPNROPER")
                        End If
                        ...
                        Else
                            e.Row.Cells(index).Text = drow("O3CODORG")
                        End If
                        ...
                        If IsDBNull(drow("O3DESCR")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("O3DESCR")
                        End If

                        index += 1
                        If IsDBNull(drow("COD_AGENTE_ATIVO")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("COD_AGENTE_ATIVO")
                        End If

                        index += 1
                        If IsDBNull(drow("DESCR_AGENTE_ATIVO")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("DESCR_AGENTE_ATIVO")
                        End If

                        index += 1
                        If IsDBNull(drow("OPCODPROD")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("OPCODPROD")
                        End If
                        ...
                        If IsDBNull(drow("TPDESCR")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("TPDESCR")
                        End If
                        ...
                        If IsDBNull(drow("OPQTDDPARC")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("OPQTDDPARC")
                        End If
                        ...
                        If IsDBNull(drow("PANRPARC")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("PANRPARC")
                        End If
                        ...
                        If IsDBNull(drow("PADTLIQ")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("PADTLIQ")
                        End If
                        ...
                        If IsDBNull(drow("PADTVCTO")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("PADTVCTO")
                        End If
                        ...
                        If IsDBNull(drow("OPVLRPARC")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = CNumero.FormataNumero(drow("OPVLRPARC"), 2)
                        End If

                        index += 1
                        If IsDBNull(drow("PAVLRPAGO")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = CNumero.FormataNumero(drow("PAVLRPAGO"), 2)
                        End If

                        index += 1
                        If IsDBNull(drow("OPVLRFIN")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = CNumero.FormataNumero(drow("OPVLRFIN"), 2)
                        End If
                        ...
                        If IsDBNull(drow("EFCODMOV")) Then
                            e.Row.Cells(index).Text = ""
                        Else
                            e.Row.Cells(index).Text = drow("EFCODMOV")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_BASE_RECEBIMENTO] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Recebimentos_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Recebimentos De: " & txtDataDe.Text & " até: " & txtDataAte.Text)
