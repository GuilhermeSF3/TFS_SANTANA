<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRVsint.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRVsint" Title="Pendências CRV - Sintético" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV - Sintético</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="A13DESCR" ShowFooter="false" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ATIVO" SortExpression="AGATIVO" >
                            <ItemStyle Width="10%" HorizontalAlign="LEFT"/>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="PENDENTES" SortExpression="QTDE_PEND" >
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT"/>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="VALOR RETIDO" SortExpression="VLR_RETIDO">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% M-1" SortExpression="PRC_ANT">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="QTDE M-1" SortExpression="QTDE_ANT">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PENDENTE M-1" SortExpression="QTDE_PEND_ANT">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
