<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="SegundaGarantia.aspx.vb" Inherits="Santana.Paginas.Comercial.SegundaGarantia" Title="Segunda Garantia" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Segunda Garantia</title>
</asp:Content>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nº Garantia" SortExpression="ABNRGAR">
                        ...
                        <asp:TemplateField HeaderText="Ano Fab." SortExpression="ABANOFAB">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cor" SortExpression="ABCOR">
                        ...
                        <asp:TemplateField HeaderText="A Vencer" SortExpression="AVENCER">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Atrasadas" SortExpression="ATRASADAS">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Não Pagas" SortExpression="NAOPAGAS">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtd. Parcela" SortExpression="QTDE">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor" SortExpression="OPVLROPCZ">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
