<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRVPromotora.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRVPromotora" Title="Pendências CRV - Promotora" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV - Promotora</title>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor:</p>
                                    </div>
