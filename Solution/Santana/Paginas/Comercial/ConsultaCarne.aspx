<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ConsultaCarne.aspx.vb" Inherits="Santana.Paginas.Comercial.ConsultaCarne" Title="Consulta Carnê" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Consulta Carnê</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="CLNOMECLI" ShowFooter="false" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PARCELA" SortExpression="PARCELAS" >
                            <ItemStyle Width="7%" HorizontalAlign="Right"/>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="CÓD. MOD." SortExpression="OPCODOP" >
                            <ItemStyle Width="7%" HorizontalAlign="Right"/>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="MODALIDADE" SortExpression="TONOMEOP" >
