<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PropostasBalcao.aspx.vb" Inherits="Santana.Paginas.Comercial.PropostasBalcao" Title="Propostas Balcão" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Propostas Balcão</title>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Valor Integrada" SortExpression="VALOR_INTEGRADA">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Balcão Integrada" SortExpression="VALOR_BALCAO_INTEGRADA">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
                  
                        <asp:TemplateField HeaderText="% Valor" SortExpression="PCT_VALOR">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtde. Integrada" SortExpression="QTD_INTEGRADA">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtd. Balcão Integrada" SortExpression="QTD_BALCAO_INTEGRADA">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Quantidade" SortExpression="PCT_QTD">
                            <ItemStyle Width="10%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
