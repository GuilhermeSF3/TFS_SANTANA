...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVCartAtivaLiq
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                If ddlRegiao.SelectedValue = "99" Then
                    Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
                    Dim con As New SqlConnection(strConn)
                    Dim Vagente As String = ""

                    Dim Command As New SqlCommand("Select O3DESCR, O3CODORG from CDCSANTANAMicroCredito..TORG3 (nolock) ORDER BY O3DESCR", con)
                ...
                Else
                    ...
                    Dim Command As New SqlCommand("Select O3DESCR, O3CODORG from CDCSANTANAMicroCredito..TORG3 (nolock) inner join depara_regiao (nolock) on o3codorg = COD_AGENTE where COD_REGIAO = " & ddlRegiao.SelectedValue & " ORDER BY O3DESCR", con)
                    Command.Connection.Open()
        ...
        Private Sub Carrega_Ocorrencia()

            Try

                ddlOcorrencias.Items.Insert(0, New ListItem("TODOS", "99"))
                ddlOcorrencias.Items.Insert(1, New ListItem("Ocorrência 090", "090"))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("REGIAO")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("REGIAO")
                        End If

                        If IsDBNull(drow("PREJU")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("PREJU")
                        End If

                        If IsDBNull(drow("RENEG")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("RENEG")
                        End If

                        If IsDBNull(drow("ATIVO")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("ATIVO")
                        End If
        ...
        Protected Sub BindGridView1Data()
            ...
            Try
                ...
                Dim comando As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_LIQ_ttl '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             ...
                                                             ddlOcorrencias.SelectedValue & "'", conexao)
                ...
                Dim comando2 As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_LIQ_pend '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             ...
                                                             ddlPreju.SelectedValue & "', '" &
                                                             ddlReneg.SelectedValue & "', '" &
                                                             ddlAtivo.SelectedValue & "'", conexao2)
                ...
                Dim comando3 As SqlCommand = New SqlCommand(
                    "SCR_CRV_CATIVA_LIQ_AGENTE " & ddlAgente.SelectedValue, conexao3)
                comando3.Connection.Open()
                Dim ddlValues3 As SqlDataReader
                ddlValues3 = comando3.ExecuteReader()
                ddlValues3.Read()
                TxtATIVO.Text = IIf(ddlAgente.SelectedValue = "99", "", ddlValues3("ativo").ToString())
                ddlValues3.Close()
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_CATIVA_LIQ '" & oDataContrato.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataReferencia.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", '" &
                                                             ...
                                                             ddlReneg.SelectedValue & "', '" &
                                                             ddlAtivo.SelectedValue & "', '" &
                                                             ddlOcorrencias.SelectedValue & "'", "SCR_CRV_CATIVA_LIQ", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendenciasCRVCarteiraAtivaLiq_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Qtde de Pendentes " & txtQtePendAlienacao.Text & " Total de Contratos " & txtQteContratoRealizado.Text & " Percentual (%) " & txtPercentual.Text & " Agente ATIVO " & TxtATIVO.Text)
