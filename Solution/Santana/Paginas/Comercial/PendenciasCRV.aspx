<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasCRV.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasCRV" Title="Pendências CRV" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências CRV</title>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                         <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto; display:none">Qte. De Contratos Realizado Até:</p>
                                    </div>
                                    <asp:TextBox Visible="false" ID="txtQteContratoRealizado" runat="server" MaxLength="10" Width="100px" enabled="false" CssClass="form-control navbar-btn" ></asp:TextBox>
                                </div>
                            </li>
                            <%--<li>
                                <div style="margin: 5px">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto;display:none">Percentual (%):</p>
                                    </div>
                                    <asp:TextBox Visible="false" ID="txtPercentual" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto;display:none">Valor Desconto:</p>
                                    </div>
                                    <asp:TextBox Visible="false" ID="TxtVlr" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto;display:none">Agente Ativo:</p>
                                    </div>
                                    <asp:TextBox Visible="false" ID="TxtATIVO" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" enabled="false" ></asp:TextBox>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CPF CLIENTE" SortExpression="CLCGC">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                        </asp:TemplateField>
