<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PagtoPendencia.aspx.vb" Inherits="Santana.Paginas.Comercial.PagtoPendencia" Title="Contratos Pagos com Pendência" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Contratos Pagos com Pendência</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" DataKeyNames="COD_AGENTE" ShowFooter="false"
                    OnDataBound="GridView1_DataBound" Font-Size="9pt">


                    <RowStyle Height="28px" />
                    <Columns>
                        <asp:TemplateField HeaderText="COD. AGENTE" SortExpression="COD_AGENTE" >
                        ...
                        <asp:TemplateField HeaderText="DT INTEGRAÇÃO" SortExpression="DT_INT">
                        ...
                        <asp:TemplateField HeaderText="PRAZO REGULARIZ." SortExpression="PRAZO">
                            <ItemStyle Width="8%" HorizontalAlign="RIGHT" />
                        </asp:TemplateField>
