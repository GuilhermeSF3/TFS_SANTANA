...
Namespace Paginas.Comercial
    ...
    Public Class GravameQuitacao
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("OPCODCLI")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("OPCODCLI")
                        End If

                        If IsDBNull(drow("CHASSI")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("CHASSI")
                        End If

                        If IsDBNull(drow("STATUSGRV")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("STATUSGRV")
                        End If

                        If IsDBNull(drow("DESCR_GRAVAME")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("DESCR_GRAVAME")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_GRAVAME_QUITACAO '" &
                                                             oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", " & ddlPagto.SelectedValue, "GRAVAME_QUITACAO", strConn)
        ...
        Protected Sub btnHelp_Click(sender As Object, e As EventArgs)
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Gravame Quitação' ,'Gravame Quitação, Gravame Quitação');", True)
        End Sub
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("GravameQuitacao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Gravame Quitação - Data DE: " & txtDataDe.Text & " Data Até: " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")
