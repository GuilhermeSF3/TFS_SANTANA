<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="BasePropostaTempo.aspx.vb" Inherits="Santana.Paginas.Credito.BasePropostaTempo" Title="Base de Propostas - Mesa" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Base de Propostas - Mesa</title>
</asp:Content>
