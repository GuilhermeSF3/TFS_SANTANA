<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AniversariantesPJ.aspx.vb" Inherits="Santana.Paginas.Comercial.AniversariantesPJ" Title="Aniversariantes PJ" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Aniversariantes PJ</title>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nome Empresa" SortExpression="NOME_EMPRESA">
                        ...
                        <asp:TemplateField HeaderText="Dt. Constituição" SortExpression="DATA_CONSTITUICAO">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="E-mail Empresa" SortExpression="EMAIL_PJ">
                            <ItemStyle Width="20%" HorizontalAlign="LEft" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Telefone Empresa" SortExpression="FONE_PF">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome Sócio" SortExpression="SOCIO">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CPF Sócio" SortExpression="CPF">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Nascimento Sócio" SortExpression="DATA_NASCIMENTO">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="E-mail Sócio" SortExpression="EMAIL_PF">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Telefone Sócio" SortExpression="FONE_PF">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Agente Responsável" SortExpression="AGENTE">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>
