...
Namespace Paginas.Comercial
    ...
    Public Class Prestamista
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("PPCODPRD")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("PPCODPRD")
                        End If

                        If IsDBNull(drow("TPDESCR")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("TPDESCR")
                        End If

                        If IsDBNull(drow("OPVLROPCZ")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = CNumero.FormataNumero(drow("OPVLROPCZ"), 2)
                        End If

                        If IsDBNull(drow("O3CODORG")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("O3CODORG")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_BASE_PRESTAMISTA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) &
                                                                "', '" & ddlAgente.SelectedValue & "'", "BasePrestamista", strConn)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Base Prestamista De: " & txtDataDe.Text & " até: " & txtDataAte.Text)
