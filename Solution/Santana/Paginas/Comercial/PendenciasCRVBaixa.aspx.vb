...
Namespace Paginas.Comercial
    ...
    Public Class PendenciasCRVBaixa
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                txtDataDe.Text = Convert.ToDateTime("01/" + Now.ToString("MM/yyyy"))
                txtDataAte.Text = Convert.ToDateTime(Now.ToString("dd/MM/yyyy"))
        ...
        Private Sub Carrega_Agente()
            ...
            Try
                ...
                If codGerente = "99" Then
                    ...
                    "SELECT O3codOrg as AGCod, O3descr as AGDescr FROM	CDCSANTANAMicroCredito..TORG3 A (NOLOCK) WHERE O3ATIVA IN ('S','A') ORDER BY O3DESCR", connection)
        ...
        Private Sub Carrega_Filtro()
            ddlFiltro.Items.Insert(0, New ListItem("Data Base", "1"))
            ddlFiltro.Items.Insert(1, New ListItem("Data Baixa", "2"))
        End Sub
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("SCR_CRV_BAIXA '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                                                             oDataAte.Data.ToString("yyyyMMdd") & "', " &
                                                             ddlAgente.SelectedValue & ", " &
                                                             ddlFiltro.SelectedValue, "SCR_CRV_BAIXA", strConn)
        ...
        Protected Sub btnHelp_Click(sender As Object, e As EventArgs)
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Pendencias CRV - Baixa' ,'Pendencias CRV, Contratos de Veículos com pendencias de Regularização de Documentos (codigo da Pendencia 151).');", True)
        End Sub
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PendenciasCRV-Baixas_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pendências CRV - Baixas - Data De. " & txtDataDe.Text & " Data Até. " & txtDataAte.Text & " -  Agente " & ddlAgente.SelectedItem.Text & " </p> ")
