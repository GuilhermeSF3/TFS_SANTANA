<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PendenciasGravameSint.aspx.vb" Inherits="Santana.Paginas.Comercial.PendenciasGravameSint" Title="Pendências de Gravame- Sintético" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pendências Gravame - Sintético</title>
