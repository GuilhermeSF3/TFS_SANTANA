<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RelCadastroLojas.aspx.vb" Inherits="Santana.Paginas.Comercial.RelCadastroLojas" Title="Cadastro de Lojas" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <ContentTemplate>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    AllowPaging="True" PageSize="25" OnPageIndexChanging="GridViewRiscoAnalitico_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dt. Base" SortExpression="PPDTBASE">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="CNPJ" SortExpression="O4CPFCGC">
