...
Namespace Paginas.Desconto
    ...
    Public Class CobrancaPJ
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col += 1
                        If IsDBNull(drow("NM_CEDENTE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NM_CEDENTE")
                        End If


                        col += 1
                        If IsDBNull(drow("CGC_CEDENTE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("CGC_CEDENTE")
                        End If

                        col += 1
                        If IsDBNull(drow("NM_SACADO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NM_SACADO")
                        End If

                        col += 1
                        If IsDBNull(drow("CGC_SACADO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("CGC_SACADO")
                        End If

                        col += 1
                        If IsDBNull(drow("PARC_TIT")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PARC_TIT")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("VLR_PARC_TIT")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VLR_PARC_TIT"), 2)
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("FONE1")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("FONE1")
                        End If

                        col += 1
                        If IsDBNull(drow("FONE2")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("FONE2")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("DESCR_PROD")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DESCR_PROD")
                        End If
                        ...
                        If IsDBNull(drow("COD_MODA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("COD_MODA")
                        End If

                        col += 1
                        If IsDBNull(drow("DESCR_MODA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DESCR_MODA")
                        End If
                        ...
                        If IsDBNull(drow("VLR_OPER")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VLR_OPER"), 2)
                        End If
                        ...
                        If IsDBNull(drow("DT_OPER")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DT_OPER")
                        End If

                        col += 1
                        If IsDBNull(drow("DT_OCOR")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DT_OCOR")
                        End If

                        col += 1
                        If IsDBNull(drow("DESCR_OCOR")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DESCR_OCOR")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("NN_PARC_TIT")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NN_PARC_TIT")
                        End If

                        col += 1
                        If IsDBNull(drow("LOCAL_COB")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("LOCAL_COB")
                        End If

                        col += 1
                        If IsDBNull(drow("TIPO_OPER")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("TIPO_OPER")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_VENCIDOS_PJ] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "VencidosPJ", strConn)
