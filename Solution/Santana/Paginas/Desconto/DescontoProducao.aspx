<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="DescontoProducao.aspx.vb" Inherits="Santana.Paginas.Desconto.DescontoProducao" Title="Desconto Produção" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="MES_ANO_ANT" SortExpression="MES_ANO_ANT">
                            <ItemStyle Width="7%" HorizontalAlign="Right"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="MES_ANT" SortExpression="MES_ANT">
                            <ItemStyle Width="7%" HorizontalAlign="Right"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="MES_ATUAL" SortExpression="MES_ATUAL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DIF_MES" SortExpression="DIF_MES">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PRC_DIF_MES" SortExpression="PRC_DIF_MES">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DIF_ANO" SortExpression="DIF_ANO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PRC_DIF_ANO" SortExpression="PRC_DIF_ANO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
