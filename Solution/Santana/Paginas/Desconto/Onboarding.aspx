<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Onboarding.aspx.vb" Inherits="Santana.Paginas.Desconto.Onboarding" Title="Onboarding" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Operação:</p>
                                    </div>
                                    <asp:DropDownList ID="ddlOperacao" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
                            <li>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>                        
                        ...
                        <asp:TemplateField HeaderText="Jornada" SortExpression="ID_JORNADA">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data da Simulação" SortExpression="DATA_SIMULACAO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Operação" SortExpression="TIPO_OPERACAO">
                        ...
                        <asp:TemplateField HeaderText="Faturamento em 6 Meses" SortExpression="FATURAMENTO_6_MESES">
                        ...
                        <asp:TemplateField HeaderText="Valor Bruto" SortExpression="VALOR_BRUTO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Parcela" SortExpression="VALOR_PARCELA">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Taxa Calculada" SortExpression="TAXA_CALCULADA">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Erro" SortExpression="RETORNO_ERRO">
