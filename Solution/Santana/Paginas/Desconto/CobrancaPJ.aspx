<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CobrancaPJ.aspx.vb" Inherits="Santana.Paginas.Desconto.CobrancaPJ" Title="Cobrança PJ" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cobrança PJ</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cedente" SortExpression="NM_CEDENTE">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CPF/CNPJ Ced." SortExpression="CGC_CEDENTE">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Sacado" SortExpression="NM_SACADO">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CPF/CNPJ Sac." SortExpression="CGC_SACADO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Parcela/Título" SortExpression="PARC_TIT">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Dt. Vcto." SortExpression="DT_VCTO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Parc/Tit" SortExpression="VLR_PARC_TIT">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Fone 1" SortExpression="FONE1">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Fone 2" SortExpression="FONE2">
                        ...
                        <asp:TemplateField HeaderText="Produto" SortExpression="DESCR_PROD">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Moda" SortExpression="COD_MODA">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Moda" SortExpression="DESCR_MODA">
                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Operação" SortExpression="VLR_OPER">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Operação" SortExpression="DT_OPER">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Ocorrência" SortExpression="DT_OCOR">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descr. Ocorrência" SortExpression="DESCR_OCOR">
                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Nosso Número" SortExpression="NN_PARC_TIT">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Local Cobrança" SortExpression="LOCAL_COB">
                            <ItemStyle Width="8%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tp. Operação" SortExpression="TIPO_OPER">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
