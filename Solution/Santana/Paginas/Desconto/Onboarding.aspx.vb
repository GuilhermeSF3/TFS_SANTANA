...
Namespace Paginas.Desconto
    ...
    Public Class Onboarding
        ...
        Private Sub Load_list()
            ...
            Try
                ddlOperacao.Items.Insert(0, New ListItem("Todos", "99"))
                ddlOperacao.Items.Insert(1, New ListItem("Capital de Giro", "1"))
                ddlOperacao.Items.Insert(2, New ListItem("Recebiveis", "2"))
                ddlOperacao.Items.Insert(3, New ListItem("Microcrédito", "3"))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col = 0
                        If IsDBNull(drow("ID_JORNADA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("ID_JORNADA")
                        End If

                        col += 1
                        If IsDBNull(drow("DATA_SIMULACAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("DATA_SIMULACAO")
                        End If

                        col += 1
                        If IsDBNull(drow("TIPO_OPERACAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("TIPO_OPERACAO")
                        End If
                        ...
                        If IsDBNull(drow("CNPJ")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("CNPJ")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("FATURAMENTO_6_MESES")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("FATURAMENTO_6_MESES"), 2)
                        End If
                        ...
                        If IsDBNull(drow("VALOR_SOLICITADO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_SOLICITADO"), 2)
                        End If
                        ...
                        If IsDBNull(drow("PRAZO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PRAZO")
                        End If
                        ...
                        If IsDBNull(drow("VALOR_BRUTO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_BRUTO"), 2)
                        End If
                        ...
                        If IsDBNull(drow("VALOR_PARCELA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_PARCELA"), 2)
                        End If
                        ...
                        If IsDBNull(drow("SCORE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("SCORE")
                        End If

                        col += 1
                        If IsDBNull(drow("TAXA_CALCULADA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("TAXA_CALCULADA")
                        End If

                        col += 1
                        If IsDBNull(drow("RETORNO_ERRO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("RETORNO_ERRO")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_RELATORIO_ONBOARDING] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "','" & ddlOperacao.SelectedValue & "'", "SCR_RELATORIO_ONBOARDING", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Onboarding_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Onboarding - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data & " - OPERAÇÃO: " & ddlOperacao.SelectedItem.Text)
