<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Desconto8020.aspx.vb" Inherits="Santana.Paginas.Desconto.Desconto8020" Title="Desconto Produção" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Desconto Produção</title>
</asp:Content>
            ...
            <div id="dvGrid" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Sequência" SortExpression="SEQ">
                        ...
                        <asp:TemplateField HeaderText="Frequência" SortExpression="FREQ">
                            <ItemStyle Width="7%" HorizontalAlign="Left"  />
                        </asp:TemplateField>  

                        <asp:TemplateField HeaderText="Status Empresa" SortExpression="STATUS">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cedente" SortExpression="CEDENTE">
                            <ItemStyle Width="30%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Risco Desconto" SortExpression="RISCO_DESCONTO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Risco FIDC" SortExpression="RISCO_FIDC">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Risco Giro" SortExpression="RISCO_GIRO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Risco Total" SortExpression="RISCO_TTL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Risco Acum." SortExpression="RISCO_ACUMULADO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Repres." SortExpression="PRC_REPRES">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Repres. Acum." SortExpression="PRC_REPRES_ACUMUL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="RATING_MERCADO_M3" SortExpression="RATING_MERCADO_M3" Visible="false">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="RATING_MERCADO_M2" SortExpression="RATING_MERCADO_M2">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="RATING_MERCADO_M1" SortExpression="RATING_MERCADO_M1" Visible="false">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Cód. Grupo" SortExpression="COD_GRUPO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
