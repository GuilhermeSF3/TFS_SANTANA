<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ContratoOperador.aspx.vb" Inherits="Santana.Paginas.Desconto.ContratoOperador" Title="Contratos por Operador - PJ" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Contratos por Operador</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Data Liquidação" SortExpression="DATA_LIQUIDACAO">
                        ...
                        <asp:TemplateField HeaderText="Qtd. Parcela" SortExpression="QTD_PARC">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Qtd. Parcela Pg." SortExpression="QTD_PARC_PG">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
