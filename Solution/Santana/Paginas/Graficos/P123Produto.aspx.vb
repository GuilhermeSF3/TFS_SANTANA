    ...
    Public Class P123Produto
        ...
        Private Sub Carrega_Produto()
            Try
                ...
                ddlProduto.Items.Insert(0, New ListItem("Renegociacao", "R"))
        ...
        <WebMethod()>
        Public Shared Function BindGraphData(ddlFaixa As Integer, txtData As String, ddlProduto As String) As List(Of Object)
            ...
            Dim objData As DataTable = ClassBD.GetExibirGrid("scr_grafico_P123Produto '" & Right(txtData, 4) & Mid(txtData, 4, 2) & Left(txtData, 2) & "', '" & ddlFaixa & "', '" & ddlProduto & "'", "GraficoMensal", strConn)
