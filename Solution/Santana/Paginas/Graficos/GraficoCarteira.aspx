<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="GraficoCarteira.aspx.vb" Inherits="Santana.Paginas.Graficos.GraficoCarteria" Title="Gráfico Carteira" EnableEventValidation="false"%>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gráfico Carteira</title>
    ...
    <script type="text/javascript">
        ...
        var lineChart;
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "GraficoCarteira.aspx/BindGraphData",
                    data: jsonData,
