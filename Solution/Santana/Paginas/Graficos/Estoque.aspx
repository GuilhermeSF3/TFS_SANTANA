<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Estoque.aspx.vb" Inherits="Santana.Paginas.Graficos.Estoque" Title="Gráfico Estoque" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="dvConsultas2" style="width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView2" runat="server"
                    ...
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="Data" SortExpression="Descricao" ItemStyle-BackColor="#EFEFEF">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="" SortExpression="M1">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
    ...
    var lineChart;
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Estoque.aspx/BindGraphData1",
                    data: jsonData,
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Estoque.aspx/BindGraphData2",
                    data: jsonData,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: OnSuccess_,
