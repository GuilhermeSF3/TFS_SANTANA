<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="P123Produto.aspx.vb" Inherits="Santana.Paginas.Graficos.P123Produto" Title="Gráfico Análise das Parcelas p123" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    var lineChart;
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "P123Produto.aspx/BindGraphData",
                    data: jsonData,
            ...
            $(document).bind("change", "[id$=ddlFaixa],[id$=txtData],[id$=ddlProduto]", function () {
                lineChart.clear();
                lineChart.destroy();
            });
