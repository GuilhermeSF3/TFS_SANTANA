<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="RollrateProjetadoAnalitico.aspx.vb" Inherits="Santana.RollrateProjetadoAnalitico" Title="Rollrate Projetado - Analítico" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Rollrate Projetado - Analítico</title>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 2px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Fechamento:</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 2px">
                                    ...
                                    <div class="btn-group">
                                        <asp:Button ID="btnDataRefAnt" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataRefAnt_Click"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                            ...
                            <li>
                                <div style="margin: 2px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Projeção:</p>
                                    </div>
                                    <div class="btn-group">
                                        <asp:Button ID="btnDataProjAnt" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataProjAnt_Click"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDataProj" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn"></cc1:Datax>
                                        </span>
                                        <asp:Button ID="btnProximaDataProj" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaDataProj_Click"></asp:Button>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div style="width: 10px" class="btn-group"></div>
                            </li>
                            <li>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible ">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="DATA FECH" SortExpression="DT_FECHA">
                        ...
                        <asp:TemplateField HeaderText="NIVEL DE RISCO" SortExpression="NVL_RISCO">
                            <ItemStyle Width="3%" HorizontalAlign="Left"  />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="M-1 NIVEL DE RISCO ANTERIOR" SortExpression="NVL_RISCO_ANT">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="SALDO INSCRITO" SortExpression="SALDO_INSCRITO" VISIBLE ="FALSE">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="M-1 SALDO ANTERIOR" SortExpression="SALDO_INSCRITO_ANT">
                            <ItemStyle Width="3%" HorizontalAlign="Right"/>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PDD ANTERIOR" SortExpression="PDD_ANT">
                            <ItemStyle Width="3%" HorizontalAlign="Right"/>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="ATRASO PROJETADO" SortExpression="ATRASO_PROJ">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PDD %" SortExpression="PDD_prc">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PDD R$" SortExpression="PDD_vlr">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="IMPACTO" SortExpression="IMPACTO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                       
                        <asp:TemplateField HeaderText="ATRASO NA REF" SortExpression="Atraso">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="PARCELAS A VENCER" SortExpression="PARCELA_AVENCER">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PARC EM ABERTO" SortExpression="PARCELA_ABERTO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PARC PAGAS" SortExpression="PARCELA_PAGA">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="TIPO REF" SortExpression="TIPO">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="TIPO PROJ" SortExpression="TIPO_PROJ">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="CPF/CNPJ" SortExpression="COD_CLI" visible ="false   ">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="MODALIDADE" SortExpression="COD_MODA">
                            <ItemStyle Width="3%" HorizontalAlign="LEFT" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Taxa Juros" SortExpression="TAXA_JUROS" visible="false">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Data Base" SortExpression="DATA_BASE">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
