...
Namespace Paginas.TI
    ...
    Partial Public Class AgendaAprovar
        ...
        '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
        '''</remarks>
        Protected WithEvents pnlAgendas As Global.System.Web.UI.WebControls.Panel
        ...
        '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
        '''</remarks>
        Protected WithEvents btnModalConfirmar As Global.System.Web.UI.WebControls.Button
    End Class
End Namespace
