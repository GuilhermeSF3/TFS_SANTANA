...
Namespace Paginas.TI
    ...
    Partial Public Class CadastroHistorico
        ...
        '''<summary>
        '''Controle btnCadastrarHistorico.
        '''</summary>
        '''<remarks>
        '''Campo gerado automaticamente.
        '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
        '''</remarks>
        Protected WithEvents btnCadastrarHistorico As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''Controle btnEditarHistorico.
        '''</summary>
        '''<remarks>
        '''Campo gerado automaticamente.
        '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
        '''</remarks>
        Protected WithEvents btnEditarHistorico As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''Controle btnExcluirHistorico.
        '''</summary>
        '''<remarks>
        '''Campo gerado automaticamente.
        '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
