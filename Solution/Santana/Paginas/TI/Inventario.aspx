<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Inventario.aspx.vb" Inherits="Santana.Paginas.TI.Inventario" Title="Inventario" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <div style="font-weight:600">Gerenciar Equipamentos</div>
                                    <div class="btn-group" style="display: flex; flex-direction: row; gap: 5px;">                                                                                  
                                        <div> 
                                             <p class="navbar-text" style="float: none; margin: 0px"></p>
...
<asp:Button ID="ExcluirInv"  runat="server" Text="Excluir"  CssClass="btn btn-danger navbar-btn" data-toggle="modal" data-target="#exampleModalDelete" />
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div id="dvRiscoAnalitico" runat="server" style="visibility: visible; margin-top: 0px; height:600px; text-align: center; overflow-x:auto; max-width:100%;">
