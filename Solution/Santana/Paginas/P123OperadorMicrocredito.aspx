<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="P123OperadorMicrocredito.aspx.vb" Inherits="Santana.Paginas.Graficos.P123OperadorMicrocredito" Title="P123 Operador" EnableEventValidation="false"%>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>P123 Operador</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="true" OnDataBound="GridView1_DataBound" DataKeyNames="DESCRICAO">
                    ...
                    <PagerTemplate>
                        ...
                        <asp:DropDownList ID="PagerPages" runat="server" AutoPostBack="true" Width="100px" CausesValidation="false" OnSelectedIndexChanged="PagerPages_SelectedIndexChanged" CssClass="navbar-btn" style="z-index:2000" />&nbsp;
