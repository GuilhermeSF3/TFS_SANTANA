<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="P123Gerencial.aspx.vb" Inherits="Santana.Paginas.Cobranca.P123Gerencial.P123Gerencial" Title="Gráfico Análise Risco Gerencial p123" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gráfico Análise Risco Gerencial p123</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Safra</p>
                                    </div>
                                    <div class="btn-group">
                                        <asp:Button ID="btnDataSafraAnterior" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataSafraAnterior_Click"></asp:Button>
                                        <span class="btn" style="padding: 0px; border-width: 0px;">
                                            <cc1:Datax ID="txtDataSafra" runat="server" MaxLength="10" Width="100px" CssClass="form-control navbar-btn" OnTextChanged="txtData_TextChanged"></cc1:Datax>
                                        </span>
                                        <asp:Button ID="btnProximaDataSafra" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaDataSafra_Click"></asp:Button>
                                    </div>
                                    <div>
                            </li>
                            ...
                            <li>
                                <div style="margin: 5px; z-index: 1">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Gráfico</p>
                                    </div>
                                    <asp:DropDownList ID="ddlGrafico" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn" OnSelectedIndexChanged="ddlGrafico_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </li>
                ...
                <div id="dvConsultas" style="width: 100%; overflow: auto;">
                    ...
                    <asp:GridView ID="GridView2" runat="server"
                        ...
                        <PagerTemplate>
                            ...
                            <asp:DropDownList ID="PagerPages" runat="server" AutoPostBack="true" Width="60px" CausesValidation="false" OnSelectedIndexChanged="PagerPages2_SelectedIndexChanged" CssClass="navbar-btn" Style="z-index: 2000" />&nbsp;
                        </PagerTemplate>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "[id$=btnCarregar]", function () {
            ...
            var grafico = $$("ddlGrafico").val();
            var dataSafra = $$("txtDataSafra").val();

            var jsonData = JSON.stringify({
                txtDataSafra: dataSafra,
                ddlFaixa: faixa,
                ddlGrafico: grafico
            });
            ...
            $.ajax({
                type: "POST",
                url: "P123Gerencial.aspx/BindGraphData",
                data: jsonData,
            ...
            function OnSuccess_(reponse) {
                ...
                var dataGraph = {
                    ...
                    datasets: [{
                        ...
                        //borderColor: "rgba(75,192,192,1)",   // cores alteradas cf chamado 15/02/17 ciano
                    ...
                    },
                    {
                        ...
                        pointBorderWidth: 1,
                        pointHoverRadius: 5,
                        pointHoverBackgroundColor: "rgba(255,128,64,1)",
                        pointHoverBorderColor: "rgba(255,128,64,1)",
                        pointBorderColor: "rgba(255,128,64,1)",
        ...
        $(document).bind("change", "[id$=ddlFaixa],[id$=ddlGrafico]", function () {
            lineChart.clear();
            lineChart.destroy();
        });
