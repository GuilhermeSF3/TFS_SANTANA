...
Namespace Paginas.Cobranca.P123Gerencial
    ...
    Partial Public Class P123Gerencial
        ...
        '''<summary>
        '''btnDataSafraAnterior control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnDataSafraAnterior As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''txtDataSafra control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents txtDataSafra As Global.Componentes.Datax

        '''<summary>
        '''btnProximaDataSafra control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnProximaDataSafra As Global.System.Web.UI.WebControls.Button
        ...
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents ddlGrafico As Global.System.Web.UI.WebControls.DropDownList
