<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="P123Gerencia13Meses.aspx.vb" Inherits="Santana.Paginas.Cobranca.P123Gerencial.P123Gerencia13Meses" Title="Score x Inadimplencia - 13 meses" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Score x Inadimplencia - 13 meses</title>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    AllowPaging="False" PageSize="16" OnPageIndexChanging="GridView1_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descrição Produção" SortExpression="DESCR" >
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        
                        <asp:TemplateField HeaderText="" SortExpression="m15" >
                        ...
                        <asp:TemplateField HeaderText="Média" SortExpression="m1" >
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
