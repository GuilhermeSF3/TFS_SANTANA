<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Ocorrencia.aspx.vb" Inherits="Santana.Paginas.Cobranca.Relatorios.OCORRENCIA" Title="OCORRENCIAS" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Data Até(Ref.):</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:TextBox ID="txtContrato" runat="server" MaxLength="20" Width="150px" CssClass="form-control navbar-btn"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Ocorrência:</p>
                                    </div>
                                    <asp:TextBox ID="txtOcorrencia" runat="server" MaxLength="20" Width="150px" CssClass="form-control navbar-btn"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Cód. Usuário:</p>
                                    </div>
                                    <asp:TextBox ID="txtCodUsuario" runat="server" MaxLength="20" Width="150px" CssClass="form-control navbar-btn"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="DATA" SortExpression="EvDtOcor">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CONTRATO" SortExpression="EvNrOper">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PARCELA" SortExpression="EvNrParc">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="COD.OCORRENCIA" SortExpression="EvCodOcor">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DESCR.OCORRENCIA" SortExpression="RrDescrOco">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="COMPLEMENTO" SortExpression="EvCmplto">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="COMPLEMENTO 2" SortExpression="EvCmplto2">
                            <ItemStyle Width="45%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="USUARIO" SortExpression="UsNomeUsuC">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="COD.USUARIO" SortExpression="EvUsuario">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Próx.PARC" SortExpression="PROX_PARC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Próx.VCTO" SortExpression="PROX_VCTO">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="VENCIDA em" SortExpression="VENCIDA">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="TX %am" SortExpression="TX">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CPF/CNPJ" SortExpression="CPF">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CLIENTE" SortExpression="NOME">
                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Cód. Modalidade" SortExpression="OPCODOP">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Modalidade" SortExpression="NOMEOP">
                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                        </asp:TemplateField>
