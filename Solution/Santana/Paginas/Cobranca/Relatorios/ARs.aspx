<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ARs.aspx.vb" Inherits="Santana.Paginas.Cobranca.Relatorios.ARs" Title="CETIP Potencial Analitico" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <div class="btn-group-sm  ">
                                        <asp:ImageButton ID="btnOcorrenciasGV" runat="server" CssClass="btn btn-default navbar-btn" OnClick="btnExportOcorrencias_Click" ImageUrl="~/imagens/txt_2424.png"></asp:ImageButton>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btnOcorrenciasGV" />
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tipo Registro" SortExpression="Tipo_Registro">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Sequencia" SortExpression="Sequencia">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Sistema" SortExpression="Sistema">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Segmento" SortExpression="Segmento">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descr. Segmento" SortExpression="DESCR_SEGMENTO">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Data Vcto. Débito" SortExpression="Data_Vcto_Debito">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Data Inclusão Débito" SortExpression="Data_Inclusao_Debito">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Envio Carta" SortExpression="Dt_Envio_Carta">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Agendam. Carta" SortExpression="Dt_Agendam_Carta">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tipo Carta" SortExpression="Tipo_Carta">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="No. Carta" SortExpression="No_Carta">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Descr. Num. Carta" SortExpression="DESCR_NUM_CARTA">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="NSU Carta" SortExpression="NSU_Carta">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt Retorno Correio" SortExpression="Dt_Retorno_Correio">
                            <ItemStyle Width="4%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cod Retorno	Descr." SortExpression="Cod_Retorno">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Retorno" SortExpression="DESCR_RETORNO">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Motivo Devolução" SortExpression="Motivo_Devolucao">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Descr. Motivo Dev." SortExpression="DESCR_MOTIVO_DEVOL">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Cod. Cliente" SortExpression="Cod_Cliente">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Reservado" SortExpression="Reservado">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Controle" SortExpression="Controle">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="COD OCORRENCIA FUNÇÃO" SortExpression="FC_COD">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DESCR OCORR FUNÇÃO" SortExpression="FC_DESCR">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
