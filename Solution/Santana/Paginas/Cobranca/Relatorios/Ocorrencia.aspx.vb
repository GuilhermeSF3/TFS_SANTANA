    ...
    Public Class OCORRENCIA
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                txtDataRef.Text = Convert.ToDateTime(Now.Date.AddDays(-1).ToString("dd/MM/yyyy"))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("EvDtOcor")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("EvDtOcor")
                        End If

                        If IsDBNull(drow("EvNrOper")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("EvNrOper")
                        End If

                        If IsDBNull(drow("EvNrParc")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("EvNrParc")
                        End If

                        If IsDBNull(drow("EvCodOcor")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("EvCodOcor")
                        End If

                        If IsDBNull(drow("RrDescrOco")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("RrDescrOco")
                        End If

                        If IsDBNull(drow("EvCmplto")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("EvCmplto")
                        End If

                        If IsDBNull(drow("EvCmplto2")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("EvCmplto2")
                        End If

                        If IsDBNull(drow("UsNomeUsuC")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = drow("UsNomeUsuC")
                        End If

                        If IsDBNull(drow("EvUsuario")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("EvUsuario")
                        End If

                        I = 8 + 1
                        'PMT	PROX_VCTO	VENCIDA	PLANO	CARGO	OCUPACAO	TX
                        If IsDBNull(drow("PMT")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("PMT")
                        End If
                        'PROX_PARC
                        I = I + 1
                        If IsDBNull(drow("PROX_PARC")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("PROX_PARC")
                        End If
                        I = I + 1
                        If IsDBNull(drow("PROX_VCTO")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("PROX_VCTO")
                        End If

                        I = I + 1
                        If IsDBNull(drow("VENCIDA")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("VENCIDA")
                        End If
                        ...
                        If IsDBNull(drow("CARGO")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("CARGO")
                        End If
                        I = I + 1
                        If IsDBNull(drow("OCUPACAO")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("OCUPACAO")
                        End If
                        I = I + 1
                        If IsDBNull(drow("TX")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("TX")
                        End If
                        I = I + 1
                        If IsDBNull(drow("CPF")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("CPF")
                        End If
                        I = I + 1
                        If IsDBNull(drow("NOME")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("NOME")
                        End If
                        I = I + 1
                        If IsDBNull(drow("OPCODOP")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("OPCODOP")
                        End If
                        I = I + 1
                        If IsDBNull(drow("NOMEOP")) Then
                            e.Row.Cells(I).Text = ""
                        Else
                            e.Row.Cells(I).Text = drow("NOMEOP")
                        End If
                    End If
                End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_COB_OCORRENCIA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & "','" & Right(txtDataRef.Text, 4) & Mid(txtDataRef.Text, 4, 2) & Left(txtDataRef.Text, 2) & "', '" + txtContrato.Text.Trim() + "', '" + txtOcorrencia.Text.Trim() + "', '" + txtCodUsuario.Text.Trim() + "'", "OCORRENCIA", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("OCORRENCIA{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("OCORRENCIAS - Data De: " & txtDataDe.Text & " - Data Até/Referência: " & txtDataRef.Text)
        ...
        Private Sub ExportCSV(objGrid As GridView)
            ...
            Try
                ...
                Dim filename As String = String.Format("OCORRENCIA{0}_{1}_{2}.csv", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
