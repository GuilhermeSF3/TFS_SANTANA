<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ParcelaVcto.aspx.vb" Inherits="Santana.Paginas.Credito.ParcelaVcto" Title="Parcelas por Vencimento" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: 0px">Vencto. De:</p>
                                    </div>
                                    <div class="btn-group">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Vencto. Até:</p>
                                    </div>
                                    <div class="btn-group">
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Contrato" SortExpression="PANROPER">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Dt. Vencto." SortExpression="PADTVCTO">
                        ...
                        <asp:TemplateField HeaderText="Nome Modalidade" SortExpression="TONOMEOP">
                        ...
                        <asp:TemplateField HeaderText="Vlr. Parcela" SortExpression="OPVLRPARC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tel. Celular" SortExpression="CELULAR">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tel. Residencial" SortExpression="RESIDENCIAL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tel. Comercial" SortExpression="COMERCIAL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
