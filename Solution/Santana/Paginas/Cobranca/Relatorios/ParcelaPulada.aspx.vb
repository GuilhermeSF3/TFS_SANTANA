...
Namespace Paginas.Cobranca.Relatorios
    ...
    Public Class ParcelaPulada
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("PAGO_OPER")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("PAGO_OPER")
                        End If

                        If IsDBNull(drow("PAGO_PARC")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("PAGO_PARC")
                        End If

                        If IsDBNull(drow("ABERTO_PARC")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("ABERTO_PARC")
                        End If

                        If IsDBNull(drow("QTD_PULADA")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("QTD_PULADA")
                        End If

                        If IsDBNull(drow("PADTLIQ")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("PADTLIQ")
                        End If
                        ...
                        If IsDBNull(drow("VLR_PARC")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = CNumero.FormataNumero(drow("VLR_PARC"), 2)
                        End If

                        If IsDBNull(drow("DIASATRASOREVERSAO")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("DIASATRASOREVERSAO")
                        End If
                        ...
                        If IsDBNull(drow("RATINGREVERSAO")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = drow("RATINGREVERSAO")
                        End If

                        If IsDBNull(drow("NVL_RISCO")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = drow("NVL_RISCO")
                        End If

                        If IsDBNull(drow("VLRREVERSAO")) Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = CNumero.FormataNumero(drow("VLRREVERSAO"), 2)
                        End If

                        If IsDBNull(drow("VLRRESULTADO")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = CNumero.FormataNumero(drow("VLRRESULTADO"), 2)
                        End If

                        If IsDBNull(drow("vlr_pdd")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = CNumero.FormataNumero(drow("vlr_pdd"), 2)
                        End If

                        If IsDBNull(drow("DTVENC_ABERTO")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("DTVENC_ABERTO")
                        End If

                        If IsDBNull(drow("DT_VCTO1")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("DT_VCTO1")
                        End If

                        If IsDBNull(drow("DT_BASE")) Then
                            e.Row.Cells(17).Text = ""
                        Else
                            e.Row.Cells(17).Text = drow("DT_BASE")
                        End If

                        If IsDBNull(drow("NOM_CLI")) Then
                            e.Row.Cells(18).Text = ""
                        Else
                            e.Row.Cells(18).Text = drow("NOM_CLI")
                        End If

                        If IsDBNull(drow("SLD_INSCRITO")) Then
                            e.Row.Cells(19).Text = ""
                        Else
                            e.Row.Cells(19).Text = CNumero.FormataNumero(drow("SLD_INSCRITO"), 2)
                        End If

                        If IsDBNull(drow("VLR_FV")) Then
                            e.Row.Cells(20).Text = ""
                        Else
                            e.Row.Cells(20).Text = CNumero.FormataNumero(drow("VLR_FV"), 2)
                        End If

                        If IsDBNull(drow("PERC_PDD")) Then
                            e.Row.Cells(21).Text = ""
                        Else
                            e.Row.Cells(21).Text = drow("PERC_PDD")
                        End If

                        If IsDBNull(drow("parc")) Then
                            e.Row.Cells(22).Text = ""
                        Else
                            e.Row.Cells(22).Text = CNumero.FormataNumero(drow("parc"), 0)
                        End If

                        If IsDBNull(drow("dtVencParc")) Then
                            e.Row.Cells(23).Text = ""
                        Else
                            e.Row.Cells(23).Text = drow("dtVencParc")
                        End If

                        If IsDBNull(drow("COBRADORA")) Then
                            e.Row.Cells(24).Text = ""
                        Else
                            e.Row.Cells(24).Text = drow("COBRADORA")
                        End If
                    End If
                End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_PARCELAPULADA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & "'", "ParcelaPulada", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("ParcelaPulada_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("ParcelaPulada - Data Referência: " & txtDataDe.Text)
