<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ControleAcoesPJ.aspx.vb" Inherits="Santana.Paginas.Cobranca.Relatorios.ControleAcoesPJ" Title="Controle de Ações - PF/PJ" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Controle de Ações - PF/PJ </title>
</asp:Content>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:DropDownList ID="ddlEscritorio" Width="200px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>   
                            <li>
                                <div style="margin: 5px">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Processo:</p>
                                    </div>
                                    <asp:TextBox ID="txtProcesso" runat="server" MaxLength="100" Width="200px" CssClass="form-control navbar-btn"></asp:TextBox>
                                </div>
                            </li>                                                                                                                                                
                            <li>
                                <div style="margin: 5px">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">PF/PJ:</p>
                                    </div>
                                    <asp:DropDownList ID="ddlTipoPessoa" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>       
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Autor/Réu:</p>
                                    </div>
                                    <asp:DropDownList ID="ddlTipoAutor" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>   
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Tipo Ação:</p>
                                    </div>
                                    <asp:DropDownList ID="ddlAcao" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>                                                                                                                                                                                                  
                        </ul>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor Causa:</p>
                                    </div>
                                    <asp:TextBox ID="txtVlrCausa" ReadOnly="true" runat="server" MaxLength="15" Width="150px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:TextBox ID="txtVlrCausaE" ReadOnly="true" runat="server" MaxLength="15" Width="150px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:TextBox ID="txtVlrCausaS" ReadOnly="true" runat="server" MaxLength="15" Width="150px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
                            <li>
                                <div style="margin: 5px">
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Título" SortExpression="TITPROC">
                        ...
                        <asp:TemplateField HeaderText="Valor Causa" SortExpression="VALOR_CAUSA">
                        ...
                        <asp:TemplateField HeaderText="Data Entrada" SortExpression="DATA_ENTRADA">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="PF/PJ" SortExpression="TIPO_PESSOA">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Autor/Réu" SortExpression="TIPO_AUTOR">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tipo Ação" SortExpression="TIPO_ACAO">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>
