...
Namespace Paginas.Credito
    ...
    Public Class BaseReneg
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        e.Row.Cells(1).Text = drow("NOME_CLIENTE")
                        e.Row.Cells(2).Text = drow("CODCOBRADORA")
                        e.Row.Cells(3).Text = drow("COBRADORA")
                        e.Row.Cells(4).Text = drow("USUARIO")
                        e.Row.Cells(5).Text = drow("PROPOSTA")
                        e.Row.Cells(6).Text = drow("ATRASO")
                        e.Row.Cells(7).Text = drow("AGENTE")
                        e.Row.Cells(8).Text = drow("DATA_CONTRATO")
                        e.Row.Cells(9).Text = drow("CONTRATO_ORIG")
                        ...
                        'e.Row.Cells(43).Text = drow("RATING")
                        'e.Row.Cells(44).Text = drow("VALOR_RISCO")
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_base_renegociados] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & "', '" & ddlCobradora.SelectedValue & "', '" & IIf(ContextoWeb.UsuarioLogado.Perfil = 5, 1, 0) & "'", "IPANALITICO", strConn)
        ...
        Protected Sub btnHelp_Click(sender As Object, e As EventArgs)
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "tmp", "Alerta('Base de Renegociação' ,'Renegociados no período indicado. Cobradora que efetivou a Renegociação. Demais dados do Função e do IP.');", True)
        End Sub
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Relatório Base de Renegociação - Período De: " & txtDataDe.Text & " Até: " & txtDataAte.Text)
