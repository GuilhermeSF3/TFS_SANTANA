...
Namespace Paginas.Graficos
    ...
    Public Class P123OperadorMicrocredito
        ...
        Private Function GetData() As DataTable
            ...
            Dim table As DataTable = ClassBD.GetExibirGrid("SCR_VLR_ANALISEP123_MC '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & ddlFaixa.SelectedValue & "', null, 4", "GraficoMensal", strConn)
        ...
        Protected Sub btnHelp_Click(sender As Object, e As EventArgs)
            ScriptManager.RegisterStartupScript(Page, Me.GetType(), "tmp", "Alerta('P123 Operador' ,'1o Momento = dia 30 do mes de Vencimento,     2o Momento = 30 dias após o Vencimento,    3o Momento = 60 dias após o Vencimento');", True)
        End Sub
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("P123OperadorMicrocredito_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
