                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("PPNROPER")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("PPNROPER")
                        End If

                        If IsDBNull(drow("PPNRPROP")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("PPNRPROP")
                        End If

                        If IsDBNull(drow("CLNOMECLI")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("CLNOMECLI")
                        End If
                        ...
                        If IsDBNull(drow("OPQTDDPARC")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("OPQTDDPARC")
                        End If

                        If IsDBNull(drow("OPPARCLIQ")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("OPPARCLIQ")
                        End If

                        If IsDBNull(drow("OPVLROPCZ")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("OPVLROPCZ")
                        End If

                        If IsDBNull(drow("PAVLRPARCELA")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = drow("PAVLRPARCELA")
                        End If

                        If IsDBNull(drow("PADTVCTO")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("PADTVCTO")
                        End If

                        If IsDBNull(drow("PANRPARC")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("PANRPARC")
                        End If
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("CP_Colab_Agentes_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("CP - Colaboradores e Agentes </p> ")
