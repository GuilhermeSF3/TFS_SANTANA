<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CPColaboradores.aspx.vb" Inherits="Santana.Paginas.RH.CPColaboradores" Title="CP Colaboradores" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CP Colaboradores</title>
</asp:Content>
