...
Public Class DetalheContratos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Select Case ContextoWeb.DadosTransferencia.Classe
                ...
                Case "HH"
                    lblClasse.Text = "HH - acima de 360 d"
    ...
    Private Function GetData() As DataTable
        ...
        Dim Table As DataTable = Util.ClassBD.GetExibirGrid("[scr_RR_mensal_DETALHE] '" & _
    ...
    Protected Sub btnExcel_Click(sender As Object, e As ImageClickEventArgs)
        ...
        Try
            ...
            If Not IsNothing(GridView1.HeaderRow) Then
                ...
                Dim filename As String = String.Format("Contrato_Detalhe_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
    ...
    Protected Sub btnImpressao_Click(sender As Object, e As ImageClickEventArgs)
        ...
        '                           Convert.ToDateTime(ContextoWeb.DadosTransferencia.DataReferencia).ToString("MM/dd/yy") & "', '" & _
        '                           ContextoWeb.DadosTransferencia.Agente & "', '" & _
        '                           ContextoWeb.DadosTransferencia.Cobradora & "', " & _
        '                           ContextoWeb.DadosTransferencia.Linha & ", '" & _
