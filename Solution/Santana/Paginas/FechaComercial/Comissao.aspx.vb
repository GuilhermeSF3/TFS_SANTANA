...
Public Class Comissao
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    If IsDBNull(drow("DT_BASE")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("DT_BASE")
                    End If
                    ...
                    If IsDBNull(drow("DESCONTO")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = CNumero.FormataNumero(drow("DESCONTO"), 2)
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("GRUPO_COMISSAO")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("GRUPO_COMISSAO")
                    End If
    ...
    Private Function GetData() As DataTable
        ...
        table = ClassBD.GetExibirGrid("[SCR_COMISSAO] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "Comissao", strConn)
