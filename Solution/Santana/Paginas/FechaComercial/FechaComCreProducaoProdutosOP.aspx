<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComCreProducaoProdutosOP.aspx.vb" Inherits="Santana.FechaComCreProducaoProdutosOP" Title="Vlr OPERADO - Produção Mensal vs Produtos (Gráfico)" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="dvConsultas" style="height: 500px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cód. Ger./Op." SortExpression="COD_OPERADOR" >
                            <ItemStyle Width="50px" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Ger./Operador" SortExpression="OPERADOR" >
                            <ItemStyle Width="180px" HorizontalAlign="Left" />
                        </asp:TemplateField>
    ...
    <script type="text/javascript">
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "FechaComCreProducaoProdutosOP.aspx/BindGraphData",
                    data: jsonData,
            ...
            $(document).bind("change", "[id$=txtData],[id$=ddlProduto]", function () {
                lineChart.clear();
                lineChart.destroy();
            });
