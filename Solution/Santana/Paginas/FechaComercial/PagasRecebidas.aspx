<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="PagasRecebidas.aspx.vb" Inherits="Santana.PagasRecebidas" Title="Pagas X Recebidas" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Pagas X Recebidas</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Código da Loja" SortExpression="PPCODORG4">
                        ...
                        <asp:TemplateField HeaderText="Operação" SortExpression="PPNROPER">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome Cliente" SortExpression="PPNOMECLI">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="CGC" SortExpression="PPCGC">
                        ...
                        <asp:TemplateField HeaderText="Nome Agente" SortExpression="O3DESCR">
                            <ItemStyle Width="9%" HorizontalAlign="LEft" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Usuário" SortExpression="PPUSUARIO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Produto" SortExpression="PPCODPRD">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Tabela" SortExpression="PPCODTAB">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome Tabela" SortExpression="NOME_TABELA">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Categoria Tabela" SortExpression="CATEGORIA_TABELA">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Data Cadastro" SortExpression="PPDTCAD">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Principal da Operação" SortExpression="PPVLROPCZ">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="1ª Liberação" SortExpression="PPVLRLIQ1">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Proposta Fin." SortExpression="PPPROPFIM">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Sit. Proposta" SortExpression="MPSIT">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Passo da Esteira" SortExpression="TDDESCR">
                        ...
                        <asp:TemplateField HeaderText="Data Lancto." SortExpression="DTLNC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Hora Lancto." SortExpression="HORALNC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód. Operador" SortExpression="O6CODORG">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Operador" SortExpression="O6DESCR">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Sem Renda" SortExpression="SEM_RENDA">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Automática" SortExpression="AUTOMATICA">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Propostas App" SortExpression="PROP_APP">
                            <ItemStyle Width="4%" HorizontalAlign="Right" />
                        </asp:TemplateField>
