...
Public Class FechaComAnaliseVeiculoPlano
    ...
    Public Shared Function BindGraphData(txtData As String, ddlVeiculo As String, ddlRelatorio As String) As List(Of Object)
        ...
        Dim objData As DataTable = ClassBD.GetExibirGrid("[scr_COMERCIAL_PLANO_GRAF1] '" & Right(txtData, 4) & Mid(txtData, 4, 2) & Left(txtData, 2) & "', 'V', '" & ddlRelatorio & "','" & ddlVeiculo & "'", "FechaComAnaliseVeiculoAno", strConn)
