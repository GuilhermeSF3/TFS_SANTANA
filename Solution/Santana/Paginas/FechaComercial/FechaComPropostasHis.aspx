<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComPropostasHis.aspx.vb" Inherits="Santana.FechaComPropostasHis" Title="Propostas Histórico" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Propostas Histórico</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Mês" SortExpression="DESCR">
                        ...
                        <asp:TemplateField HeaderText="Aprov / Receb" SortExpression="MES_ATUAL_APR">
                        ...
                        <asp:TemplateField HeaderText="Pagas / Aprovadas" SortExpression="M3A_APR">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Pagas / Receb" SortExpression="M4A_APR">
                            <ItemStyle Width="7%" HorizontalAlign="Center" />
                        </asp:TemplateField>
    ...
    <script type="text/javascript">
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "FechaComPropostasHis.aspx/BindGraphData",
                    data: jsonData,
            ...
            $(document).bind("change", "[id$=txtData],[id$=ddlRelatorio]", function () {
                lineChart.clear();
                lineChart.destroy();
            });
