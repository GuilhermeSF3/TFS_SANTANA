...
Public Class FechaComPropostasHis
    ...
    <WebMethod()>
    Public Shared Function BindGraphData(txtData As String, ddlRelatorio As String) As List(Of Object)
        ...
        Dim objData As DataTable = ClassBD.GetExibirGrid("SCR_COMERCIAL_PROPOSTA_GRAF '" & Right(txtData, 4) & Mid(txtData, 4, 2) & Left(txtData, 2) & "', 'V', '" & ddlRelatorio & "'", "FechaComPropostasHis", strConn)
        ...
        For Each oDataRow As DataRow In objData.Rows
            ...
            If Not IsDBNull(oDataRow("RECEBIDAS")) Then
                dataItem.Add(oDataRow("RECEBIDAS"))
            End If
            If Not IsDBNull(oDataRow("APROVADAS")) Then
                dataItem.Add(oDataRow("APROVADAS"))
            End If
            If Not IsDBNull(oDataRow("PAGAS")) Then
                dataItem.Add(oDataRow("PAGAS"))
            End If
