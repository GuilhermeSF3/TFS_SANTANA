...
Public Class FechaComCreProducaoProdutosOP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ' fechamento  alterado para ONTEM em 21/10/19  ******* 
    ...
    Private Sub Carrega_Produto()
        ...
        Try
            ...
            Dim Produto As Integer = ContextoWeb.UsuarioLogado.Produto    'int ex veic = 2
    ...
    Private Function GetData() As DataTable
        ...
        table1 = ClassBD.GetExibirGrid("[scr_COMERCIAL_PRODUCAOop] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "','" & ddlProduto.SelectedValue & "'", "FechaComCreProducaoProdutos", strConn)
