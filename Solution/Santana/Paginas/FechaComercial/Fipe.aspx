<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Fipe.aspx.vb" Inherits="Santana.Fipe" Title="Fipe" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Base FIPE</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Qtd. Parcelas" SortExpression="OPQTDDPARC">
                        ...
                        <asp:TemplateField HeaderText="Valor Tabela" SortExpression="ABVLRTAB">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
