...
Public Class FechaComAnaliseVeiculoAno
    ...
    Protected Sub ddlVeiculo_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    <WebMethod()>
    Public Shared Function BindGraphData(txtData As String, ddlVeiculo As String, ddlRelatorio As String) As List(Of Object)
        ...
        Dim objData As DataTable = ClassBD.GetExibirGrid("[scr_COMERCIAL_ANO_GRAF1] '" & Right(txtData, 4) & Mid(txtData, 4, 2) & Left(txtData, 2) & "', 'V', '" & ddlRelatorio & "','" & ddlVeiculo & "'", "FechaComAnaliseVeiculoAno", strConn)

        For Each oDataRow As DataRow In objData.Rows
            Dim dataItem1 As New List(Of Double)()
            labels.Add(oDataRow("DESCR"))
        Next
        ...
        For Each oDataRow As DataRow In objData.Rows
            ...
            If Not IsDBNull(oDataRow("FX1")) Then
                dataItem.Add(oDataRow("FX1"))
            End If
            If Not IsDBNull(oDataRow("FX2")) Then
                dataItem.Add(oDataRow("FX2"))
            End If
            If Not IsDBNull(oDataRow("FX3")) Then
                dataItem.Add(oDataRow("FX3"))
            End If
            If Not IsDBNull(oDataRow("FX4")) Then
                dataItem.Add(oDataRow("FX4"))
            End If
            If Not IsDBNull(oDataRow("FX5")) Then
                dataItem.Add(oDataRow("FX5"))
            End If
