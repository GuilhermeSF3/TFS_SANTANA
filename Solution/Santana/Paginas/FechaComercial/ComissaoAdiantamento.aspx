<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ComissaoAdiantamento.aspx.vb" Inherits="Santana.ComissaoAdiantamento" Title="Comissão - Adiantamento" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Comissão - Adiantamento</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ICM" SortExpression="ICM" Visible="false">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Repasse" SortExpression="PRC_REPASSE" Visible="false">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
