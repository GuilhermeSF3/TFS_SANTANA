<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComClientes.aspx.vb" Inherits="Santana.FechaComClientes" Title="Análise Maiores Clientes" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Análise Maiores Clientes</title>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="% Part." SortExpression="perc_part">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Evolução de 2013 p/ 2014" SortExpression="perc_evol">
    ...
    <script type="text/javascript">
        ...
        var lineChart;
            ...
            $(document).on("click", "[id$=btnCarregar]", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "FechaComClientes.aspx/BindGraphData",
                    data: jsonData,
                ...
                function OnSuccess_(reponse) {
                    ...
                    var aDataSetLabel6 = aData[11];
                    var aDatasets6 = aData[12];

                    var aDataSetLabel7 = aData[13];
                    var aDatasets7 = aData[14];

                    var aDataSetLabel8 = aData[15];
                    var aDatasets8 = aData[16];

                    var aDataSetLabel9 = aData[17];
                    var aDatasets9 = aData[18];

                    var aDataSetLabel10 = aData[19];
                    var aDatasets10 = aData[20];
                    ...
                    var dataGraph = {
                        ...
                        },
                        {
                            ...
                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(192,192,11,1)",
                            borderColor: "rgba(192,192,11,1)",
                        ...
                        },
                        {
                            ...
                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(7,211,7,1)",
                            borderColor: "rgba(7,211,7,1)",
                        ...
                        },
                        {
                            ...
                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(112,14,209,1)",
                            borderColor: "rgba(112,14,209,1)",
                        ...
                        {
                            label: aDataSetLabel6,
                            data: aDatasets6,


                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(14,209,209,1)",
                            borderColor: "rgba(14,209,209,1)",
                        ...
                        {
                            label: aDataSetLabel7,
                            data: aDatasets7,


                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(1,19,19,0.4)",
                            borderColor: "rgba(1,19,19,0.4)",
                        ...
                        {
                            label: aDataSetLabel8,
                            data: aDatasets8,


                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(105,124,251,0.4)",
                            borderColor: "rgba(105,124,251,0.4)",
                        ...
                        {
                            label: aDataSetLabel9,
                            data: aDatasets9,


                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(105,251,158,0.4)",
                            borderColor: "rgba(105,251,158,0.4)",
                        ...
                        {
                            label: aDataSetLabel10,
                            data: aDatasets10,


                            fill: false,
                            lineTension: 0.1,
                            backgroundColor: "rgba(252,181,190,0.4)",
                            borderColor: "rgba(252,181,190,0.4)",
            ...
            $(document).bind("change", "[id$=txtData]", function () {
                lineChart.clear();
                lineChart.destroy();
            });
