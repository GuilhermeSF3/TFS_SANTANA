<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AprovadasReducao.aspx.vb" Inherits="Santana.AprovadasReducao" Title="Propostas - Aprovadas com Redução" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Propostas - Aprovadas com Redução</title>
</asp:Content>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: inherit; margin: auto">Qtde. Total:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtdeTotal" ReadOnly="true" runat="server" MaxLenght="10" Width="100px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: inherit; margin: auto">Qtde. Aprovadas:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtdeAprovadas" ReadOnly="true" runat="server" MaxLenght="10" Width="100px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: inherit; margin: auto">Qtde. Redução:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtdeReducao" ReadOnly="true" runat="server" MaxLenght="10" Width="100px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Valor Solicitado" SortExpression="PPVLRSOL">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Liberado" SortExpression="PPVLRLIB">
                            <ItemStyle Width="8%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Produto" SortExpression="PPCODPRD">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Valor Garantia" SortExpression="CGVLRGAR">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="CPF/CNPJ" SortExpression="PPCGC">
                        ...
                        <asp:TemplateField HeaderText="Analista" SortExpression="EPUSUARIO">
