...
Public Class PagasRecebidas
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    col = 0
                    If IsDBNull(drow("PPCODORG4")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPCODORG4")
                    End If
                    ...
                    If IsDBNull(drow("PPNROPER")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPNROPER")
                    End If

                    col += 1
                    If IsDBNull(drow("PPNOMECLI")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPNOMECLI")
                    End If

                    col += 1
                    If IsDBNull(drow("PPCGC")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPCGC")
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("PPUSUARIO")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPUSUARIO")
                    End If

                    col += 1
                    If IsDBNull(drow("PPCODPRD")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPCODPRD")
                    End If

                    col += 1
                    If IsDBNull(drow("PPCODTAB")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPCODTAB")
                    End If

                    col += 1
                    If IsDBNull(drow("NOME_TABELA")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("NOME_TABELA")
                    End If

                    col += 1
                    If IsDBNull(drow("CATEGORIA_TABELA")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("CATEGORIA_TABELA")
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("PPDTCAD")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPDTCAD")
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("PPVLRLIQ1")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = CNumero.FormataNumero(drow("PPVLRLIQ1"), 2)
                    End If

                    col += 1
                    If IsDBNull(drow("PPPROPFIM")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PPPROPFIM")
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("DTLNC")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("DTLNC")
                    End If

                    col += 1
                    If IsDBNull(drow("HORALNC")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("HORALNC")
                    End If

                    col += 1
                    If IsDBNull(drow("O6CODORG")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("O6CODORG")
                    End If
                    ...
                    If IsDBNull(drow("O6DESCR")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("O6DESCR")
                    End If

                    col += 1
                    If IsDBNull(drow("SEM_RENDA")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("SEM_RENDA")
                    End If

                    col += 1
                    If IsDBNull(drow("AUTOMATICA")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("AUTOMATICA")
                    End If
                    ...
                    col += 1
                    If IsDBNull(drow("PROP_APP")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("PROP_APP")
                    End If
    ...
    Private Function GetData() As DataTable
        ...
        table = ClassBD.GetExibirGrid("[SCR_PAGAS_RECEBIDAS] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "PagasRecebidas", strConn)
    ...
    Private Sub ExportExcel(objGrid As GridView)
        ...
        Try
            ...
            If Not IsNothing(objGrid.HeaderRow) Then
                ...
                Dim filename As String = String.Format("PagasRecebidas_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                ...
                Using sw As New StringWriter()
                    ...
                    Response.Write("Pagas X Recebidas - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data)
