<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ComissaoDinamo.aspx.vb" Inherits="Santana.ComissaoDinamo" Title="Comissão - Dinamo" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Comissão - Dinamo</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="% Repasse" SortExpression="PRC_REPASSE">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Comissão - Dinamo" SortExpression="COMISSAO">
                        ...
                        <asp:TemplateField HeaderText="Comissão - Parceiro" SortExpression="COMISSAO_PARC">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>
