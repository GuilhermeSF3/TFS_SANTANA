<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="FechaComCreOpRealizadas.aspx.vb" Inherits="Santana.FechaComCreOpRealizadas" Title="Operações Realizadas" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Operações Realizadas</title>
            ...
            <div id="dvConsultas" style="height: 590px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="MODALIDADE" SortExpression="DESCR">
                            <ItemStyle Width="180px" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cód." SortExpression="COD" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="(Oper.)" SortExpression="TX_AA">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="(Oper.)" SortExpression="TX_AM">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="(Efet.)" SortExpression="TX_CET">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Receita" SortExpression="RECEITA">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="FV" SortExpression="FV">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Liberado" SortExpression="LIBERADO">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tarifas" SortExpression="TC_TARIFA">
                        ...
                        <asp:TemplateField HeaderText="TC" SortExpression="VLR_TC">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Seguro Prestamista" SortExpression="VLR_TARIFA_SEGPRESTAMISTA_OPE">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Acessórios" SortExpression="VLR_TARIFA_ACESSORIOS_OPE">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cadastro Detran" SortExpression="VLT_TARIFA_CONTDETRAN_OPE">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                        </asp:TemplateField>
