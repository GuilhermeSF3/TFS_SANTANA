...
Public Class SpreadAnalitico
    ...
    Private Function GetDataProd() As DataTable
        ...
        table = Util.ClassBD.GetExibirGrid("[scr_SPREAD_ANALITICO_Prod] '" & Right(txtData.Text, 4) & Mid(txtData.Text, 4, 2) & Left(txtData.Text, 2) & "', '" & Right(txtDataDE.Text, 4) & Mid(txtDataDE.Text, 4, 2) & Left(txtDataDE.Text, 2) & "','" & IIf(codGerente = "0", codGerente, ddlPromotora.SelectedValue) & "'", "SPREADANALITICO", strConn)
