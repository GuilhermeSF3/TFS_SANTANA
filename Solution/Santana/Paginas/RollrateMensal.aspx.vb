...
Public Class RollrateMensal
        ...
        Try
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    e.Row.Cells(2).Text = CNumero.FormataNumero(Convert.ToInt32(drow("A_QTDE")), 0)
                    e.Row.Cells(2).ForeColor = Cor
                    e.Row.Cells(3).Text = CNumero.FormataNumero(Convert.ToInt32(drow("A_SALDO")), 0)
                    e.Row.Cells(3).ForeColor = Cor

                    e.Row.Cells(5).Text = CNumero.FormataNumero(Convert.ToInt32(drow("B_QTDE")), 0)
                    e.Row.Cells(5).ForeColor = Cor
                    e.Row.Cells(6).Text = CNumero.FormataNumero(Convert.ToInt32(drow("B_SALDO")), 0)
                    e.Row.Cells(6).ForeColor = Cor

                    e.Row.Cells(8).Text = CNumero.FormataNumero(Convert.ToInt32(drow("C_QTDE")), 0)
                    e.Row.Cells(8).ForeColor = Cor
                    e.Row.Cells(9).Text = CNumero.FormataNumero(Convert.ToInt32(drow("C_SALDO")), 0)
                    e.Row.Cells(9).ForeColor = Cor

                    e.Row.Cells(11).Text = CNumero.FormataNumero(Convert.ToInt32(drow("D_QTDE")), 0)
                    e.Row.Cells(11).ForeColor = Cor
                    e.Row.Cells(12).Text = CNumero.FormataNumero(Convert.ToInt32(drow("D_SALDO")), 0)
                    e.Row.Cells(12).ForeColor = Cor

                    e.Row.Cells(14).Text = CNumero.FormataNumero(Convert.ToInt32(drow("E_QTDE")), 0)
                    e.Row.Cells(14).ForeColor = Cor
                    e.Row.Cells(15).Text = CNumero.FormataNumero(Convert.ToInt32(drow("E_SALDO")), 0)
                    e.Row.Cells(15).ForeColor = Cor

                    e.Row.Cells(17).Text = CNumero.FormataNumero(Convert.ToInt32(drow("F_QTDE")), 0)
                    e.Row.Cells(17).ForeColor = Cor
                    e.Row.Cells(18).Text = CNumero.FormataNumero(Convert.ToInt32(drow("F_SALDO")), 0)
                    e.Row.Cells(18).ForeColor = Cor

                    e.Row.Cells(20).Text = CNumero.FormataNumero(Convert.ToInt32(drow("G_QTDE")), 0)
                    e.Row.Cells(20).ForeColor = Cor
                    e.Row.Cells(21).Text = CNumero.FormataNumero(Convert.ToInt32(drow("G_SALDO")), 0)
                    e.Row.Cells(21).ForeColor = Cor

                    e.Row.Cells(23).Text = CNumero.FormataNumero(Convert.ToInt32(drow("H_QTDE")), 0)
                    e.Row.Cells(23).ForeColor = Cor
                    e.Row.Cells(24).Text = CNumero.FormataNumero(Convert.ToInt32(drow("H_SALDO")), 0)
                    e.Row.Cells(24).ForeColor = Cor

                    e.Row.Cells(26).Text = CNumero.FormataNumero(Convert.ToInt32(drow("HH_QTDE")), 0)
                    e.Row.Cells(26).ForeColor = Cor
                    e.Row.Cells(27).Text = CNumero.FormataNumero(Convert.ToInt32(drow("HH_SALDO")), 0)
                    e.Row.Cells(27).ForeColor = Cor

                    e.Row.Cells(29).Text = CNumero.FormataNumero(Convert.ToInt32(drow("TTL_QTDE")), 0)
                    e.Row.Cells(29).ForeColor = Cor
                    e.Row.Cells(30).Text = CNumero.FormataNumero(Convert.ToInt32(drow("TTL_SALDO")), 0)
    ...
    Protected Sub BindGridView1Data()
        ...
        GridView1.DataSource = Util.ClassBD.GetExibirGrid("[scr_RR_mensal] '" & Convert.ToDateTime(txtData.Text).ToString("MM/dd/yy") & "', '" & ddlAgente.SelectedValue & "','" & ddlCobradora.SelectedValue & "'", "RollrateMensal", strConn)
        GridView1.DataBind()
