                        ...
                        <ul class="nav navbar-nav" >
                            ...
                            <li> 
                                ...
                                <table style="margin-top:10px">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="navbar-text" style="margin:4px">Descrição</p>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblDescricao" runat="server" Text="" class="navbar-text" style="margin:4px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>                                 
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="NOME CLIENTE" SortExpression="NOME_CLIENTE">
                        ...
                        <asp:TemplateField HeaderText="SALDO INICIAL" SortExpression="SLD_INSCR_INICIAL">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="3%" />
