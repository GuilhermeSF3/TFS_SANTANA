...
Namespace Paginas.Credito
    ...
    Public Class PagaRecebidaAnalitica
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col = 0
                        If IsDBNull(drow("PROP_DATAREF")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PROP_DATAREF")
                        End If

                        col += 1
                        If IsDBNull(drow("NUM_PROP")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NUM_PROP")
                        End If
                        ...
                        If IsDBNull(drow("O4DESCR")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("O4DESCR")
                        End If
                        ...
                        If IsDBNull(drow("NUM_OPE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("NUM_OPE")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("COD_USU")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("COD_USU")
                        End If
                        ...
                        If IsDBNull(drow("COD_PROD")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("COD_PROD")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("PROP_DATABASE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PROP_DATABASE")
                        End If

                        col += 1
                        If IsDBNull(drow("PROP_DATACAD")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PROP_DATACAD")
                        End If

                        col += 1
                        If IsDBNull(drow("VALOR_PRINCIPAL")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_PRINCIPAL"), 2)
                        End If

                        col += 1
                        If IsDBNull(drow("VALOR_LIQ7")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_LIQ7"), 2)
                        End If
                        ...
                        If IsDBNull(drow("VALOR_FIN")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VALOR_FIN"), 2)
                        End If

                        col += 1
                        If IsDBNull(drow("PROP_FIM")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PROP_FIM")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("ESTEIRA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("ESTEIRA")
                        End If

                        col += 1
                        If IsDBNull(drow("REDUCAO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("REDUCAO")
                        End If

                        col += 1
                        If IsDBNull(drow("VLR_INI")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VLR_INI"), 2)
                        End If
                        ...
                        If IsDBNull(drow("VLR_FIN")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("VLR_FIN"), 2)
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_PAGARECEBIDA] '" & oDataDe.Data.ToString("yyyyMMdd") & "'", "PagaRecebidaAnalitica", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("PagaRecebidaAnalitica_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pagas Recebidas - Analítica - Data Referência: " & txtDataDe.Data)
