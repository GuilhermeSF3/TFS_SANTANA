<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ProducaoAnalista.aspx.vb" Inherits="Santana.Paginas.Credito.ProducaoAnalista" Title="Produção Crédito" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Produção Crédito</title>
</asp:Content>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:DropDownList ID="ddlDatas" Width="50px" runat="server" Visible="True" Enabled="true" AutoPostBack="true" CausesValidation="True" CssClass="selectpicker navbar-btn"></asp:DropDownList>
                                </div>
                            </li>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Analise" SortExpression="analise" Visible="false"  >
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>
