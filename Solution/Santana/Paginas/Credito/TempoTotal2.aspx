<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="TempoTotal2.aspx.vb" Inherits="Santana.Paginas.Credito.TempoTotal2" Title="Tempo Total de Propostas Tela 2" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Tempo Total de Propostas Tela 2</title>
</asp:Content>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:Button ID="btnMenu" runat="server" Text="Voltar Tempo Total" class="btn btn-default navbar-btn" OnClick="btnMenu_Click"></asp:Button>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnRowCommand="GridView1_RowCommand" DataKeyNames="epnrprop">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Início" SortExpression="Ini">
                            <ItemStyle Width="8%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Fim" SortExpression="Fim">
                            <ItemStyle Width="8%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Tempo Loja" SortExpression="fase_Loja">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Tempo Promotora" SortExpression="fase_Promotora">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tempo Mesa" SortExpression="Mesa">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Tempo Alçada" SortExpression="alcada">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tempo Formalização" SortExpression="Formalizacao">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Operador" SortExpression="Operador" Visible="false">
                            <ItemStyle Width="15%" HorizontalAlign="left" />
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Loja" SortExpression="Loja" Visible="false">
                            <ItemStyle Width="15%" HorizontalAlign="left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonA" runat="server" CommandName="" CommandArgument='<%# Eval("epnrprop")%>'>
