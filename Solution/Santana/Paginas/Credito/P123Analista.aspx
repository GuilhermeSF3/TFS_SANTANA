<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="P123Analista.aspx.vb" Inherits="Santana.Paginas.Credito.P123Analista" Title="P123 Analista" EnableEventValidation="false"%>
                        ...
                        <ul class="nav navbar-nav" >
                            ...
                            <li> 
                                <div style="margin:5px" >
                                    ...
                                    <div class="btn-group">                                                              
                                        <asp:Button ID="btnDataDeAnterior" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataAnterior_Click"></asp:Button>
                                        ...
                                        <asp:Button ID="btnProximaDataDe" runat="server" Text="&raquo;" CssClass="btn btn-default navbar-btn" OnClick="btnProximaData_Click"></asp:Button>                                   
                                    </div>
                                 <div>
                            </li>
                            ...
                            <li> 
                                <div style="margin:5px" >
                                    ...
                                    <div class="btn-group">                                                              
                                        <asp:Button ID="btnDataAteAnterior" runat="server" Text="&laquo;" CssClass="btn btn-default navbar-btn" OnClick="btnDataAteAnterior_Click" ></asp:Button>
                                        <span class="btn" style="padding: 0px;border-width: 0px;"> 
