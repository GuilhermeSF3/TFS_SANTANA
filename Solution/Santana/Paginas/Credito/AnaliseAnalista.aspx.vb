    ...
    Public Class AnaliseAnalista
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                If ContextoWeb.DadosTransferencia.CodAnalista <> 0 Or ContextoWeb.DadosTransferencia.CodProduto <> 0 Or ContextoWeb.DadosTransferencia.CodReanalise <> 0 Then
                    BindGridView1Data()
                    ContextoWeb.DadosTransferencia.CodAnalista = 0
                    ContextoWeb.DadosTransferencia.CodProduto = 0
                    ContextoWeb.DadosTransferencia.CodReanalise = 0
                End If
        ...
        Private Sub Carrega_Analistas()
            ...
            Try
                ...
                "SELECT USNOMEUSUC, USNOMEUSUC AS NOME FROM ACESSOCORP..TUSU (NOLOCK) WHERE USATIVO='S' AND USGRUPO1 IN ('04895','04896','04897') ORDER BY USNOMEUSUC", connection)
                ...
                ddlAnalista.DataValueField = "NOME"
                ...
                ddlAnalista.Items.Insert(1, New ListItem("MESA", "MESA"))
                ddlAnalista.Items.Insert(2, New ListItem("ALÇADAS", "ALCADA"))
        ...
        Private Sub Carrega_Produto()
            ...
            Try
                ...
                Dim connection As New SqlConnection(strConn)
                Dim command As SqlCommand = New SqlCommand( _
                "SELECT descr_tipo, descr_tipo as PRODUTO FROM Ttipo_prod (NOLOCK) where COD_PROD  in ( 'V','CG','CP')", connection)
                ...
                ddlProduto.Items.Insert(ddlProduto.Items.Count + 1, New ListItem("CP", ""))
        ...
        Private Sub Carrega_Reanalise()
            ...
            Try
                ...
                ddlReanalise.Items.Insert(0, New ListItem("Todos", ""))
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("dt_proposta")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("dt_proposta")
                        End If

                        If IsDBNull(drow("proposta")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("proposta")
                        End If
                        ...
                        If IsDBNull(drow("nome_promot")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = drow("nome_promot")
                        End If

                        If IsDBNull(drow("dt_contrato")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("dt_contrato")
                        End If

                        If IsDBNull(drow("produto")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("produto")
                        End If

                        If IsDBNull(drow("vlr_financiado")) OrElse drow("vlr_financiado") = 0 Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = CNumero.FormataNumero(drow("vlr_financiado"), 2)
                        End If
                        ...
                        e.Row.Cells(9).Text = drow("tempo")

                        If IsDBNull(drow("REANALISE")) Then
                            e.Row.Cells(10).Text = ""
                        Else
                            e.Row.Cells(10).Text = drow("REANALISE")
                        End If

                        If IsDBNull(drow("SCORE")) Then
                            e.Row.Cells(11).Text = ""
                        Else
                            e.Row.Cells(11).Text = drow("SCORE")
                        End If

                        If IsDBNull(drow("PRC_GARANTIA")) Then
                            e.Row.Cells(12).Text = ""
                        Else
                            e.Row.Cells(12).Text = drow("PRC_GARANTIA")
                        End If

                        If IsDBNull(drow("MOT_RECUSA")) Then
                            e.Row.Cells(13).Text = ""
                        Else
                            e.Row.Cells(13).Text = drow("MOT_RECUSA")
                        End If

                        If IsDBNull(drow("DT_INI")) Then
                            e.Row.Cells(14).Text = ""
                        Else
                            e.Row.Cells(14).Text = drow("DT_INI")
                        End If
                        If IsDBNull(drow("HR_INI")) Then
                            e.Row.Cells(15).Text = ""
                        Else
                            e.Row.Cells(15).Text = drow("HR_INI")
                        End If
                        If IsDBNull(drow("DT_FIM")) Then
                            e.Row.Cells(16).Text = ""
                        Else
                            e.Row.Cells(16).Text = drow("DT_FIM")
                        End If
                        If IsDBNull(drow("HR_FIM")) Then
                            e.Row.Cells(17).Text = ""
                        Else
                            e.Row.Cells(17).Text = drow("HR_FIM")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_credito_tempo] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & _
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & _
                                                                "', '" & ddlAnalista.SelectedValue & _
                                                                "', '" & ddlProduto.SelectedValue & _
                                                                "', '" & txtValorDe.Text & _
                                                                "', '" & txtValorAte.Text & _
                                                                "', '" & ddlReanalise.SelectedValue & _
                                                                "'", "ANALISEANALISTA", strConn)
        ...
        Protected Sub GridViewRiscoAnalitico_PageIndexChanging(sender As Object, e As GridViewPageEventArgs)
            ...
            If e.NewPageIndex >= 0 Then
                GridViewRiscoAnalitico.PageIndex = e.NewPageIndex
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Analise_Analista_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Relatório Tempo de Análise - Análise Analista")
