...
Namespace Paginas.Credito
    ...
    Public Class Crivo_Apr_Aut
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col += 1
                        If IsDBNull(drow("IDADE")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("IDADE")
                        End If

                        col += 1
                        If IsDBNull(drow("VENCIDO_BACEN")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("VENCIDO_BACEN")
                        End If

                        col += 1
                        If IsDBNull(drow("PERCENTUAL_FINANCIAMENTO")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("PERCENTUAL_FINANCIAMENTO")
                        End If

                        col += 1
                        If IsDBNull(drow("COMPROMETIMENTO_RENDA")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("COMPROMETIMENTO_RENDA")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("EMAIL_HOT")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("EMAIL_HOT")
                        End If

                        col += 1
                        If IsDBNull(drow("TELEFONE_HOT")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("TELEFONE_HOT")
                        End If

                        col += 1
                        If IsDBNull(drow("COMPROMENTIMENTO_BACEN")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = CNumero.FormataNumero(drow("COMPROMENTIMENTO_BACEN"), 2)
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_CRIVO_APR_AUTOMATICA] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "Crivo_Apr_Aut", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Crivo_Apr_Aut_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Crivo - Aprovação Automática - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data)
