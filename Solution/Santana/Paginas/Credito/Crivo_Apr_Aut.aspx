<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Crivo_Apr_Aut.aspx.vb" Inherits="Santana.Paginas.Credito.Crivo_Apr_Aut" Title="Crivo - Aprovação Automática" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Crivo - Aprovação Automática</title>
</asp:Content>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Vlr. Financiado" SortExpression="VALOR_FINANCIADO">
                        ...
                        <asp:TemplateField HeaderText="Vencido Bacen" SortExpression="VENCIDO_BACEN">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="% Financ." SortExpression="PERCENTUAL_FINANCIAMENTO">
                            <ItemStyle Width="7%" HorizontalAlign="LEft" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Compromet. Renda" SortExpression="COMPROMETIMENTO_RENDA">
                            <ItemStyle Width="7%" HorizontalAlign="LEft" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Email Hot" SortExpression="EMAIL_HOT">
                            <ItemStyle Width="10%" HorizontalAlign="LEft" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Telefone Hot" SortExpression="TELEFONE_HOT">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Compromet. Bacen" SortExpression="COMPROMENTIMENTO_BACEN">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
