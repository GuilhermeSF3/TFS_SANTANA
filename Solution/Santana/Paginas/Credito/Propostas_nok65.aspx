<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Propostas_nok65.aspx.vb" Inherits="Santana.Propostas_nok65" Title="Propostas - NOK 65" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Propostas - NOK 65</title>
</asp:Content>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: inherit; margin: auto">Qtde. Mesa:</p>
                                    </div>
                                    <asp:TextBox ID="txtQtdeMesa" ReadOnly="true" runat="server" MaxLenght="10" Width="100px" CssClass="form-control navbar-btn allownumericwithdecimal"></asp:TextBox>
                                </div>
                            </li>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Mesa" SortExpression="MESA">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>
