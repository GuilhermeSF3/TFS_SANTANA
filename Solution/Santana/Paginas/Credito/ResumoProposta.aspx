<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="ResumoProposta.aspx.vb" Inherits="Santana.Paginas.Credito.ResumoProposta" Title="Resumo de Proposta - Crédito" EnableEventValidation="false" ValidateRequest="false" %>
<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Resumo de Propostas - Crédito</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    AllowPaging="True" PageSize="22" OnPageIndexChanging="GridView1_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Item" SortExpression="DESCR">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qtd." SortExpression="TOTAL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Prc. (%)" SortExpression="PRC">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Prc. Total (%)" SortExpression="PRC_TOTAL">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="1%" />
