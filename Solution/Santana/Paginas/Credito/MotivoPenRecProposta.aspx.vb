...
Namespace Paginas.Credito
    ...
    Public Class MotivoPenRecProposta
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col += 1
                        If IsDBNull(drow("eptomotivo")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("eptomotivo")
                        End If

                        col += 1
                        If IsDBNull(drow("mtdescr")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("mtdescr")
                        End If
                        ...
                        col += 1
                        If IsDBNull(drow("epsitfim")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("epsitfim")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = ClassBD.GetExibirGrid("[SCR_MOTIVO_PROP] '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" & oDataAte.Data.ToString("yyyyMMdd") & "'", "MotivosProposta", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("MotivosPropostas_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Motivos Pendência/Recusa de Propostas - Crédito - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data)
