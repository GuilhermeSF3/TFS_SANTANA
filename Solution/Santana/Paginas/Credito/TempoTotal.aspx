<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="TempoTotal.aspx.vb" Inherits="Santana.Paginas.Credito.TempoTotal1" Title="Tempo Total de Propostas Tela 1" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Tempo Total de Propostas Tela 1</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    AllowPaging="False" PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging"
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" OnRowCommand="GridView1_RowCommand" DataKeyNames="Cod_fx_tempo">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" SortExpression="Cod_fx_tempo" Visible="false">
                            <ItemStyle Width="10%" HorizontalAlign="left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Faixa de Tempo" SortExpression="Faixa_Tempo">
                            <ItemStyle Width="10%" HorizontalAlign="left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Quantidade" SortExpression="Qtde">
                            <ItemStyle Width="10%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="prc_qtd">
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonA" runat="server" CommandName="TTL" CommandArgument='<%# Eval("Cod_fx_tempo") & "|" & Eval("Faixa_Tempo") %>' Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'>
                                        <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'/>
                                    </asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Aprovadas" SortExpression="aprovadas">
                            <ItemStyle Width="10%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="prc_aprovadas">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonB" runat="server" CommandName="APR" CommandArgument='<%# Eval("Cod_fx_tempo") & "|" & Eval("Faixa_Tempo") %>' Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'>
                                        <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'/>
                                    </asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Integradas" SortExpression="integradas">
                            <ItemStyle Width="10%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="prc_integradas">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonC" runat="server" CommandName="INT" CommandArgument='<%# Eval("Cod_fx_tempo") & "|" & Eval("Faixa_Tempo") %>' Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'>
                                        <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'/>
                                    </asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Negadas" SortExpression="negadas">
                            <ItemStyle Width="10%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="prc_negadas">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonD" runat="server" CommandName="NEG" CommandArgument='<%# Eval("Cod_fx_tempo") & "|" & Eval("Faixa_Tempo") %>' Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'>
                                        <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'/>
                                    </asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Pendentes" SortExpression="pendentes">
                            <ItemStyle Width="10%" HorizontalAlign="right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="%" SortExpression="prc_pendentes">
                            <ItemStyle Width="5%" HorizontalAlign="right" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="">
                            ...
                            <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="AddButtonE" runat="server" CommandName="PEN" CommandArgument='<%# Eval("Cod_fx_tempo") & "|" & Eval("Faixa_Tempo") %>' Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'>
                                        <asp:Image runat="server" ImageUrl="~/imagens/list_add1616.png" Visible='<%# Eval("Cod_fx_tempo").ToString() <> "0" %>'/>
                                    </asp:LinkButton>
