<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AnaliseAnalista.aspx.vb" Inherits="Santana.Paginas.Credito.AnaliseAnalista" Title="Análise Analista" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Tempo de Análise - Análise Analista</title>
</asp:Content>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor De:</p>
                                    </div>
                            ...
                            <li>
                                <div style="margin: 5px">
                                    <div>
                                        <p class="navbar-text" style="float: none; margin: auto">Valor Até:</p>
                                    </div>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Data Proposta" SortExpression="dt_proposta" Visible="false">
                        ...
                        <asp:TemplateField HeaderText="Promotora" SortExpression="contrato">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Nome Promotora" SortExpression="NOME_PROMOT">
                            <ItemStyle Width="7%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cod Promotora" SortExpression="dt_contrato" VISIBLE="false">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Status Proposta" SortExpression="status">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Tempo Analise" SortExpression="tempo">
                            <ItemStyle Width="3%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="% GARANTIA" SortExpression="PRC_GARANTIA">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Mot. Recusa" SortExpression="MOT_RECUSA">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="DATA INICIO" SortExpression="DT_INI">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="HORA INICIO" SortExpression="HR_INI">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="HORA FIM" SortExpression="HR_FIM">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle Width="1%" />
