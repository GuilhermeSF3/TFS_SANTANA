...
Namespace Paginas.Credito
    ...
    Public Class TempoTotal2
        Inherits SantanaPage

        Private Const hfGridView1SVID As String = "1399D405-7696-46C6-8FC6-2091DCE8A6F6"
        Private Const hfGridView1SHID As String = "D7177246-2FDD-477C-A27E-B94DEFD23EE4"
        private CodFaixaTempo As String = ""
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                CodFaixaTempo = ContextoWeb.DadosTransferencia.CodFaixaTempo.ToString()
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        col += 1
                        If IsDBNull(drow("fase_Loja")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("fase_Loja")
                        End If

                        col += 1
                        If IsDBNull(drow("fase_Promotora")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("fase_Promotora")
                        End If

                        col += 1
                        If IsDBNull(drow("Mesa")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("Mesa")
                        End If

                        col += 1
                        If IsDBNull(drow("alcada")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("alcada")
                        End If

                        col += 1
                        If IsDBNull(drow("Formalizacao")) Then
                            e.Row.Cells(col).Text = ""
                        Else
                            e.Row.Cells(col).Text = drow("Formalizacao")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            Dim strConn As String = ConfigurationManager.AppSettings("ConexaoPrincipal")
            Dim table As DataTable = ClassBD.GetExibirGrid("SCR_credito_tempo_total2 '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
                                                                                 ...
                                                                                 "', '" & txtProposta.Text & "'", "CreditoTempoTotal2", strConn)
        ...
        Protected Sub btnHelp_Click(sender As Object, e As EventArgs)
            ScriptManager.RegisterStartupScript(Page, Me.GetType(), "tmp", "Alerta('Ajuda' ,'Propostas na Faixa de tempo solicitada. Tempos por fase com dados da proposta.');", True)
        End Sub


        Protected Sub btnMenu_Click(sender As Object, e As EventArgs)
            Response.Redirect("/Paginas/Credito/TempoTotal.aspx")
        End Sub
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ...
                If Not IsNothing(GridView1.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("CreditoTempoTotal2_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Tempos Totais - Tela 2  <p>")
        ...
        Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs)
            ...
            ContextoWeb.DadosTransferencia.NumeroProposta = e.CommandArgument

            Response.Redirect("/paginas/Credito/TempoTotal3.aspx")
