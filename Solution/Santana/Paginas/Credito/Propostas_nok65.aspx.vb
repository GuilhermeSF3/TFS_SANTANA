...
Public Class Propostas_nok65
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If Not e.Row.DataItem Is Nothing Then
                    ...
                    If IsDBNull(drow("O3CODORG")) Then
                        e.Row.Cells(col).Text = ""
                    Else
                        e.Row.Cells(col).Text = drow("O3CODORG")
                    End If
    ...
    Private Function GetData() As DataTable
        ...
        table = ClassBD.GetExibirGrid("[SCR_PROPOSTAS_NOK65] '" & oDataDe.Data.ToString("yyyyMMdd") &
                                                                "', '" & oDataAte.Data.ToString("yyyyMMdd") &
                                                                "', 0, '" & ddlAgente.SelectedValue & "'", "Propostas_nok65", strConn)
    ...
    Protected Sub btnCarregar_Click(sender As Object, e As EventArgs)
        Try
            ...
            BindGridView1Data()
            txtQtdeTotal.Text = CType(GridView1.DataSource, System.Data.DataTable).Rows.Count
            ...
            Dim comando As SqlCommand = New SqlCommand(
                "SCR_PROPOSTAS_NOK65 '" & oDataDe.Data.ToString("yyyyMMdd") & "', '" &
                oDataAte.Data.ToString("yyyyMMdd") & "', 1, '" & ddlAgente.SelectedValue & "'", conexao)

            comando.Connection.Open()
            Dim ddlValues As SqlDataReader
            ddlValues = comando.ExecuteReader()
            ddlValues.Read()
            txtQtdeMesa.Text = ddlValues("TOTAL").ToString()
            ddlValues.Close()
    ...
    Private Sub ExportExcel(objGrid As GridView)
        ...
        Try
            ...
            If Not IsNothing(objGrid.HeaderRow) Then
                ...
                Dim filename As String = String.Format("Propostas_NOK65_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                ...
                Using sw As New StringWriter()
                    ...
                    Response.Write("Propostas - NOK65 - DE: " & txtDataDe.Data & " ATÉ: " & txtDataAte.Data)
