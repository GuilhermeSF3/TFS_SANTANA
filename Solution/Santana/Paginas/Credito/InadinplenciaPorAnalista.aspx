<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="InadinplenciaPorAnalista.aspx.vb" Inherits="Santana.Paginas.Credito.InadinplenciaPorAnalista" Title="Inadimplência por analista" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Inadimplência por analista</title>
</asp:Content>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="P123" SortExpression="P123">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>                                   
