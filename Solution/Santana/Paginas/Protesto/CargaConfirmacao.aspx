<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CargaConfirmacao.aspx.vb" Inherits="Santana.Paginas.Protesto.CargaConfirmacao" Title="Carga Confirmação" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Carga Confirmação</title>
</asp:Content>
