...
Namespace Paginas.Protesto
    ...
    Public Class GerarRemessa
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_PROT_REMESSA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Gera_Remessa_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
        ...
        Protected Sub ExportCsv(objGrid As GridView)
            ...
            Dim filename As String = String.Format("Remessa_{0}_{1}_{2}.csv", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
            ...
            For k As Integer = 0 To objGrid.Columns.Count - 2
                If k < objGrid.Columns.Count - 2 Then
                    sb.Append(objGrid.Columns(k).HeaderText + ";"c)
                Else
            ...
            For i As Integer = 0 To objGrid.Rows.Count - 1
                For k As Integer = 0 To objGrid.Columns.Count - 2
                    If k < objGrid.Columns.Count - 2 Then
                        sb.Append(objGrid.Rows(i).Cells(k).Text + ";"c)
                    Else
                        sb.Append(objGrid.Rows(i).Cells(k).Text)
                    End If
                Next
                sb.Append(vbCr & vbLf)
            Next
        ...
        Protected Sub btnGERAR_Click(sender As Object, e As EventArgs)
            Try
                ...
                "SCR_PROT_CALC_REMESSA '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) & "','" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & "','V'," & txtDiasDe.Text & "," & txtDiasAte.Text, connection)
