...
Namespace Paginas.Protesto
    ...
    Public Class CargaConfirmacao
            ...
            If FileUpload1.HasFile Then
                ...
                Try
                    ...
                    If File.Exists(Arquivo) = True Then
                        ...
                        command.CommandText = "TRUNCATE TABLE PROT_CARGA_CONFIRMA"
                        ...
                        Do While objReader.Peek() <> -1
                            ...
                            strCodigoCliente = formataTexto(lineArray(0))
                            strNomeCliente = formataTexto(lineArray(1))
                            strContrato = formataTexto(lineArray(2))
                            strParcela = formataTexto(lineArray(3))
                            strProtocolo = formataTexto(lineArray(4))
                            strDataRecepcao = formataTexto(lineArray(5))
                            strCartorio = formataTexto(lineArray(6))
                            strIbge = formataTexto(lineArray(7))
                            strCidade = formataTexto(lineArray(8))

                            strBatche.AppendFormat(" Insert Into PROT_CARGA_CONFIRMA Values ( {0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}, {8})",
                                                    strCodigoCliente,
                                                    strNomeCliente,
                                                    strContrato,
                                                    strParcela,
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_PROT_CONFIRMA] '" & Right(txtDataDe.Text, 4) & Mid(txtDataDe.Text, 4, 2) & Left(txtDataDe.Text, 2) &
                                                                "', '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) & "' ", "CARGACONFIRMACAO", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Carga_Confirmacao_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
