<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="GerarCapturaGV.aspx.vb" Inherits="Santana.Paginas.Protesto.GerarCapturaGV" Title="Gerar Captura GV" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gerar Captura GV</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="dvConsultas" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Data Ocorr" SortExpression="Data_Ocor">
                            <ItemStyle Width="5%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Cod. Produto" SortExpression="CODIGO_PRODUTO">
                            <ItemStyle Width="9%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Numero do Contrato" SortExpression="CONTRATO">
                            <ItemStyle Width="9%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Numero da Parcela" SortExpression="PARCELA">
                            <ItemStyle Width="9%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Código da Ocorrência" SortExpression="COD_OCORRENCIA">
                            <ItemStyle Width="9%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Seqüencial da Ocorrência" SortExpression="SEQ_OCORRENCIA">
                            <ItemStyle Width="9%" HorizontalAlign="Left" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Observação Ocorrência" SortExpression="OBS_OCORRENCIA">
    ...
    function pageLoad() {
        ...
        function ShowConfirm(controlID) {
            ...
            bootbox.confirm("Deseja GERAR a CAPTURA?", function (result) {
                if (result) {
                    if (controlID != null) {
