<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Cobranca.aspx.vb" Inherits="Santana.Paginas.BankFacil.Cobranca" Title="Cobrança BankFácil" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cobrança BankFácil</title>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <div id="dvConsultas" style="width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    OnRowCreated="GridView1_RowCreated" ShowFooter="false" DataKeyNames="CONTRATO">
