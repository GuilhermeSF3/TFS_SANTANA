...
Namespace Paginas.BankFacil
    ...
    Public Class Lastro
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_LASTRO] '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) &
                                                                "'", "SCR_LASTRO", strConn)
        ...
        Protected Sub btnExcel_Click(sender As Object, e As EventArgs)
            ...
            Try
                ExportExcel(GridViewRiscoAnalitico, txtDataAte.Text)
        ...
        Private Sub ExportExcel(objGrid As GridView, txtData As String)
        ...
        Private Sub GeraLastro(txtData As String)
            Response.Clear()
            Response.Buffer = True
            Dim filename As String = String.Format("FOP{0}01.ext", DateTime.Today.ToString("ddMMyyyy"))
            ...
            Dim comm As String
            comm = "EXEC SCR_LASTRO_TXT '" + Right(txtData, 4) & Mid(txtData, 4, 2) & Left(txtData, 2) + "'"
