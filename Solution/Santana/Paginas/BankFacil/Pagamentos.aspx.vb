...
Namespace Paginas.BankFacil
    ...
    Public Class Pagamentos
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("PANRPARC")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("PANRPARC")
                        End If
                        ...
                        If IsDBNull(drow("MVVLMVPR")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = CNumero.FormataNumero(drow("MVVLMVPR"), 2)
                        End If

                        If IsDBNull(drow("MVVLMVJR")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = CNumero.FormataNumero(drow("MVVLMVJR"), 2)
                        End If

                        If IsDBNull(drow("MVVLMVMR")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = drow("MVVLMVMR")
                        End If

                        If IsDBNull(drow("MVVLMVMLT")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = drow("MVVLMVMLT")
                        End If

                        If IsDBNull(drow("PAVLRPAGO")) Then
                            e.Row.Cells(7).Text = ""
                        Else
                            e.Row.Cells(7).Text = drow("PAVLRPAGO")
                        End If

                        If IsDBNull(drow("PAVLRDESC")) Then
                            e.Row.Cells(8).Text = ""
                        Else
                            e.Row.Cells(8).Text = drow("PAVLRDESC")
                        End If

                        If IsDBNull(drow("PADTLIQ")) Then
                            e.Row.Cells(9).Text = ""
                        Else
                            e.Row.Cells(9).Text = drow("PADTLIQ")
                        End If
        ...
        Private Function GetData() As DataTable
            ...
            table = Util.ClassBD.GetExibirGrid("[SCR_PAGTO_CREDITAS] '" & Right(txtDataAte.Text, 4) & Mid(txtDataAte.Text, 4, 2) & Left(txtDataAte.Text, 2) &
                                                                "'", "Pagtos_Creditas", strConn)
        ...
        Private Sub ExportExcel(objGrid As GridView)
            ...
            Try
                ...
                If Not IsNothing(objGrid.HeaderRow) Then
                    ...
                    Dim filename As String = String.Format("Pagtos_Creditas_{0}_{1}_{2}.xls", DateTime.Today.Day.ToString(), DateTime.Today.Month.ToString(), DateTime.Today.Year.ToString())
                    ...
                    Using sw As New StringWriter()
                        ...
                        Response.Write("Pagamentos Data Ref:" & txtDataAte.Text)
