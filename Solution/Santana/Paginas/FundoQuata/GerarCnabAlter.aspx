<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="GerarCnabAlter.aspx.vb" Inherits="Santana.Paginas.FundoQuata.GerarCnabAlter" Title="Gerar Cnab" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gerar Cnab</title>
</asp:Content>
                                    ...
                                    <div class="btn-group-sm">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button ID="btnDownload" runat="server" CssClass="btn btn-success" Text="Carregar" OnClick="BindGridView1Data" />
