...
Namespace Paginas.FundoQuata
    ...
    Public Class EstornoCnabCarga_ES
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("EFDTMOV")) Then
                            e.Row.Cells(2).Text = ""
                        Else
                            e.Row.Cells(2).Text = drow("EFDTMOV")
                        End If

                        If IsDBNull(drow("OPERACAO")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = drow("OPERACAO")
                        End If
                        ...
                        If IsDBNull(drow("VLR_TITULO")) Then
                            e.Row.Cells(5).Text = ""
                        Else
                            e.Row.Cells(5).Text = "R$ " & Convert.ToDecimal(drow("VLR_TITULO"))
                        End If

                        If IsDBNull(drow("VLR_PAGO")) Then
                            e.Row.Cells(6).Text = ""
                        Else
                            e.Row.Cells(6).Text = "R$ " & Convert.ToDecimal(drow("VLR_PAGO"))
                        End If
        ...
        Private Sub GravarLogExecucao(usuario As String, dataReferencia As String, totalValor As Decimal, totalPaseunro As Integer)
            ...
            Dim acao As String = "Extraordinario - Cnab - Carga"
