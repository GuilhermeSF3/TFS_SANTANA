<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="OrdinarioCnabGerar_O.aspx.vb" Inherits="Santana.Paginas.FundoQuata.OrdinarioCnabGerar_O" Title="Ordinario Gerar" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Ordinario Gerar</title>
</asp:Content>
