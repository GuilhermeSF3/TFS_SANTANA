...
Namespace Paginas.FundoQuata
    ...
    Public Class RenegCnabCarga_RN
            ...
            Try
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not e.Row.DataItem Is Nothing Then
                        ...
                        If IsDBNull(drow("REMESSA")) Then
                            e.Row.Cells(0).Text = ""
                        Else
                            e.Row.Cells(0).Text = drow("REMESSA")
                        End If

                        If IsDBNull(drow("OPERACAO")) Then
                            e.Row.Cells(1).Text = ""
                        Else
                            e.Row.Cells(1).Text = drow("OPERACAO")
                        End If
                        ...
                        If IsDBNull(drow("VLR_TITULO")) Then
                            e.Row.Cells(3).Text = ""
                        Else
                            e.Row.Cells(3).Text = "R$ " & Convert.ToDecimal(drow("VLR_TITULO"))
                        End If

                        If IsDBNull(drow("VLR_PAGO")) Then
                            e.Row.Cells(4).Text = ""
                        Else
                            e.Row.Cells(4).Text = "R$ " & Convert.ToDecimal(drow("VLR_PAGO"))
                        End If
        ...
        Private Sub GravarLogExecucao(usuario As String, dataReferencia As String)
            ...
            Dim observ As String = $"Carga executada com sucesso."
            Dim acao As String = "Renegociação - Cnab - Carga"
        ...
        Public Sub GridViewRiscoAnalitico_RowCreated(sender As Object, e As GridViewRowEventArgs)
            Try
        ...
        Public Sub BindGridView1DataView()
        ...
        Public Sub GridViewRiscoAnalitico_DataBound(sender As Object, e As EventArgs)
