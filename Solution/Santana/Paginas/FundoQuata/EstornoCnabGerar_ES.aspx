<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="EstornoCnabGerar_ES.aspx.vb" Inherits="Santana.Paginas.FundoQuata.EstornoCnabGerar_ES" Title="Gerar CNAB Estorno" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Gerar CNAB de Estorno</title>
</asp:Content>
