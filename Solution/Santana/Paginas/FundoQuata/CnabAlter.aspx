<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="CnabAlter.aspx.vb" Inherits="Santana.Paginas.FundoQuata.CnabAlter" Title="Cnab Alteração" EnableEventValidation="false" ValidateRequest="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Cnab Alteração</title>
</asp:Content>
