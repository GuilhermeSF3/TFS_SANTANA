    ...
    Public Class RenegCnabGerar_RN
        ...
        Private Function GetData(dataReferencia As String) As DataTable
            ...
            Using con As New SqlConnection(strConn)
                ...
                End Using
            End Using
            If resultTable.Rows.Count > 0 AndAlso resultTable.Rows(0)(0).ToString().Contains("Sem movimentação para gerar o CNAB550 - RENEG") Then

                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "alert", "alert('Sem movimentação para gerar o CNAB550 - RENEG');", True)
        ...
        Private Sub ExportarParaTXT(dt As DataTable)
            Try
                Dim nomeArquivo As String = "CB" & DateTime.Now.ToString("ddMM") & "01" & "_RN" & ".rem"
                Response.Clear()
