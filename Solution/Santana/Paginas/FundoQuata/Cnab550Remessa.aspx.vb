    ...
    Public Class ProducaoAnalista
        ...
        Private Sub Carrega_Analistas()
            ...
            Try
                ...
                " SELECT USNOMEUSUC, USNOMEUSU FROM ACESSOCORP..TUSU (NOLOCK) WHERE USATIVO='S' AND USGRUPO1 IN ('04895','04896','04897') AND ISNULL(USCODPRD,'') <> 221 ORDER BY USNOMEUSUC", connection)
        ...
        Private Sub Carrega_Datas()
            ...
            Try
                ...
                ddlDatas.Items.Insert(0, New ListItem("Data Base", "0"))
                ddlDatas.Items.Insert(1, New ListItem("Data Cadastro", "1"))
