<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="AssinaDigital.aspx.vb" Inherits="Santana.Paginas.PJ.AssinaDigital" Title="Assinatura Digital" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div style="margin: 5px">
                                    ...
                                    <asp:Button ID="Button1" class="btn btn-primary navbar-btn" runat="server" Text="Ler Arquivo"   OnClick="Button1_Click"> </asp:Button>
            ...
            <div id="dvRiscoAnalitico" runat="server" style="height: 590px; width: 100%; overflow: auto; visibility: visible">
                ...
                <asp:GridView ID="GridViewRiscoAnalitico" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="TEXTO 1" SortExpression="strDET1">
                            <ItemStyle Width="3%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="FIXO" SortExpression="strDETfixo">
                            <ItemStyle Width="2%" HorizontalAlign="Right" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="TEXTO 2" SortExpression="strDET2">
