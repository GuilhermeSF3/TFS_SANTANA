<%@ Page Language="VB" MasterPageFile="~/SantanaWeb.master" AutoEventWireup="true" CodeBehind="Carteira3M.aspx.vb" Inherits="Santana.Carteira3M" Title="Carteira 3 Meses" EnableEventValidation="false" %>

<%@ Register Assembly="Componentes" Namespace="Componentes" TagPrefix="cc1" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Carteira 3 Meses</title>
            ...
            <div id="dvConsultas" style="height: 360px; width: 100%; overflow: auto;">
                ...
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Classe Atraso" SortExpression="CLASSE" ItemStyle-BackColor="#EFEFEF">
                        ...
                        <asp:TemplateField HeaderText="Valor Risco" SortExpression="VLRM3" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Valor Risco" SortExpression="VLRM2" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Valor Risco" SortExpression="VLRM1" FooterStyle-HorizontalAlign="Right">
                            <ItemStyle Width="7%" HorizontalAlign="Right" />
                            <FooterTemplate>
