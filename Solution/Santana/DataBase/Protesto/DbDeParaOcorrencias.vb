...
Namespace DataBase.PROTESTO
    ...
    Public Class DbDeParaOcorrencias
        ...
        Public Sub InserirRegistro(ByVal COD_CART As String, _
            ...
            Dim sql As String = "INSERT INTO prot_ocorrencia_de_para(COD_CART, OCORRENCIA_CART, COD_FC, OCORRENCIA_FC) " & _
        ...
        Public Sub AtualizarRegistro(ByVal COD_CART As String, _
            ...
            Dim sql As String = "UPDATE prot_ocorrencia_de_para SET OCORRENCIA_CART=@OCORRENCIA_CART, COD_FC=@COD_FC, OCORRENCIA_FC=@OCORRENCIA_FC " & _
                                "Where COD_CART=@COD_CART "
        ...
        Public Sub ApagarRegistro(ByVal COD_CART As String)
            ...
            Dim sql As String = "DELETE FROM prot_ocorrencia_de_para Where COD_CART=@COD_CART"
        ...
        Public Function CarregarTodosRegistros() As DataTable
            ...
            Dim sql As String = "SELECT * FROM prot_ocorrencia_de_para (NOLOCK) ORDER BY COD_CART"
        ...
        Public Function CarregarRegistro(ByVal COD_CART As String) As DataTable
            ...
            Dim sql As String = "SELECT * FROM prot_ocorrencia_de_para (NOLOCK) WHERE COD_CART=@COD_CART"
