...
Public Class DbOperadorAtendeClente
    ...
    Public Sub CarregarUsuario(ByVal ddlUsuario As DropDownList)
        ...
        Dim sql As String = "select cednte_cedn as Code,(convert(varchar(10),cednte_cedn) +' '+cednte_nome ) as CODNOME  from finsgrdbs..tb_cednte (nolock) order by 2"
    ...
    Public Sub CarregarOperador(ByVal ddlOperador As DropDownList)
        ...
        Dim sql As String = "select oper_cod as cod,(convert(varchar(10),oper_cod)+' '+OPER_ABV_NOM ) as CODNOME from finsgrdbs..TB_OPER (nolock) order by OPER_ABV_NOM"
