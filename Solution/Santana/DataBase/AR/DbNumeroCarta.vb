...
Namespace DataBase.AR
    ...
    Public Class DbNumeroCarta
        ...
        Public Sub InserirRegistro(ByVal COD As Int32, _
            ...
            Dim sql As String = "INSERT INTO AR_NUM_CARTA(COD, DESCR) " & _
                                "VALUES (@COD, @DESCR)"
        ...
        Public Sub AtualizarRegistro(ByVal COD As Int32, _
            ...
            Dim sql As String = "UPDATE AR_NUM_CARTA SET DESCR=@DESCR " & _
                                "Where COD=@COD "
        ...
        Public Sub ApagarRegistro(ByVal COD As Int32)
            ...
            Dim sql As String = "DELETE FROM AR_NUM_CARTA Where COD=@COD"
        ...
        Public Function CarregarTodosRegistros() As DataTable
            ...
            Dim sql As String = "SELECT * FROM AR_NUM_CARTA (NOLOCK) ORDER BY COD"
        ...
        Public Function CarregarRegistro(ByVal COD As Int32) As DataTable
            ...
            Dim sql As String = "SELECT * FROM AR_NUM_CARTA (NOLOCK) WHERE COD=@COD"
