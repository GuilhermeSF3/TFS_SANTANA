...
Namespace DataBase.AR
    ...
    Public Class DbRetorno
        ...
        Public Sub InserirRegistro(ByVal COD As Int32, _
            ...
            Dim sql As String = "INSERT INTO AR_RETORNO(COD, DESCR) " & _
                                "VALUES (@COD, @DESCR)"
        ...
        Public Sub AtualizarRegistro(ByVal COD As Int32, _
            ...
            Dim sql As String = "UPDATE AR_RETORNO SET DESCR=@DESCR " & _
                                "Where COD=@COD "
        ...
        Public Sub ApagarRegistro(ByVal COD As Int32)
            ...
            Dim sql As String = "DELETE FROM AR_RETORNO Where COD=@COD"
        ...
        Public Function CarregarTodosRegistros() As DataTable
            ...
            Dim sql As String = "SELECT * FROM AR_RETORNO (NOLOCK) ORDER BY COD"
        ...
        Public Function CarregarRegistro(ByVal COD As Int32) As DataTable
            ...
            Dim sql As String = "SELECT * FROM AR_RETORNO (NOLOCK) WHERE COD=@COD"
