...
Public Class DbMetaPDD
    ...
    Public Sub InserirRegistro(ByVal DATAREF As DateTime,
        ...
        Dim sql As String = "INSERT INTO AUX_META_PDD(DATAREF, META) " &
                            "VALUES (@DATAREF, @META)"
    ...
    Public Sub AtualizarRegistro(ByVal DATAREF As DateTime,
        ...
        Dim sql As String = "UPDATE AUX_META_PDD SET META=@META " &
    ...
    Public Sub ApagarRegistro(ByVal DATAREF As DateTime)
        ...
        Dim sql As String = "DELETE FROM AUX_META_PDD Where DATAREF=@DATAREF"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT DATAREF, META FROM AUX_META_PDD ORDER BY DATAREF DESC"
    ...
    Public Function CarregarRegistro(ByVal DATAREF As DateTime) As DataTable
        ...
        Dim sql As String = "select * from AUX_META_PDD (NOLOCK) WHERE DATAREF=@DATAREF"
