...
Public Class DbMetaICMRepac
    ...
    Public Sub InserirRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "INSERT INTO TB_META_ICM_MC(DT_REF, COD_COBRADORA, FAIXA, ICM) " &
    ...
    Public Sub AtualizarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "UPDATE TB_META_ICM_MC SET ICM=@ICM, FAIXA=@FAIXA " &
    ...
    Public Sub ApagarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "DELETE FROM TB_META_ICM_MC Where DT_REF=@DT_REF AND COD_COBRADORA=@COD_COBRADORA"
    ...
    Public Function CarregarTodosRegistros() As DataTable
        ...
        Dim sql As String = "SELECT DT_REF, CAST(COCOD AS VARCHAR(20)) + ' - ' + CODESCR AS COD_COBRADORA, FAIXA, ICM FROM TB_META_ICM_MC (NOLOCK) " &
    ...
    Public Function CarregarRegistro(ByVal DT_REF As DateTime,
        ...
        Dim sql As String = "select * from TB_META_ICM_MC (NOLOCK) WHERE DT_REF=@DT_REF AND COD_COBRADORA=@COD_COBRADORA AND FAIXA = @FAIXA"
