...
Namespace Seguranca
    ...
    Public Class DadosTransferencia
        ...
        Public Overridable Property DataReferencia2() As String
            Get
                Return m_dataReferencia2
            End Get
            Set(value As String)
                m_dataReferencia2 = value
            End Set
        End Property
        Private m_dataReferencia2 As String
        ...
        Public Overridable Property Produto() As String
            Get
                Return m_Produto
            End Get
            Set(value As String)
        ...
        Public Overridable Property Analista() As String
            Get
                Return m_Analista
            End Get
            Set(value As String)
        ...
        Public Overridable Property Relatorio() As String
            ...
            End Set
        End Property
        Private m_relatorio As String



        Public Overridable Property CodOperador() As String
            Get
                Return m_codOperador
            End Get
            Set(value As String)
                m_codOperador = value
            End Set
        End Property
        Private m_codOperador As String


        Public Overridable Property Operador() As String
            Get
                Return m_Operador
            End Get
            Set(value As String)
        ...
        Public Overridable Property CodLoja() As String
            Get
                Return m_codLoja
            End Get
            Set(value As String)
        ...
        Public Overridable Property Loja() As String
            ...
            End Set
        End Property
        Private m_Loja As String


        Public Overridable Property NumeroProposta() As String
            Get
                Return m_numeroProposta
            End Get
            Set(value As String)
                m_numeroProposta = value
            End Set
        End Property
        Private m_numeroProposta As String

        Public Overridable Property CodFaixaTempo() As String
            Get
                Return m_codFaixaTempo
            End Get
            Set(value As String)
                m_codFaixaTempo = value
            End Set
        End Property
        Private m_codFaixaTempo As String

        Public Overridable Property FaixaTempo() As String
            Get
                Return m_FaixaTempo
            End Get
            Set(value As String)
            ...
            End Set
        End Property
        Private m_FaixaTempo As String
    ...
    Public Class UsuarioLogado
        ...
        Public Overridable Property codGerente() As String
            Get
                Return m_codGerente
            End Get
            Set(value As String)
            ...
            End Set
        End Property
        Private m_codGerente As String
